...
var SamplesGenerator = class _SamplesGenerator {
  ...
  constructor(dataFactory) {
    ...
    _defineProperty2(this, "dataFactory", null);
    _defineProperty2(this, "customSampleCount", null);
    _defineProperty2(this, "allowDuplicates", false);
...
var AutoColumnSize = class _AutoColumnSize extends BasePlugin {
  ...
  constructor(hotInstance) {
    ...
    _defineProperty3(this, "ghostTable", new ghostTable_default(this.hot));
    _defineProperty3(this, "samplesGenerator", new samplesGenerator_default((row, column) => {
    ...
    _defineProperty3(this, "firstCalculation", true);
    _defineProperty3(this, "inProgress", false);
    _defineProperty3(this, "measuredColumns", 0);
    _defineProperty3(this, "columnWidthsMap", new PhysicalIndexToValueMap());
...
var Autofill = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec2(this, _onMouseMove);
    _classPrivateMethodInitSpec2(this, _onMouseUp);
    _classPrivateMethodInitSpec2(this, _onBeforeCellMouseOver);
    _classPrivateMethodInitSpec2(this, _onAfterCellCornerMouseDown);
    _classPrivateMethodInitSpec2(this, _onCellCornerDblClick);
    _defineProperty4(this, "addingStarted", false);
    _defineProperty4(this, "mouseDownOnCellCorner", false);
    _defineProperty4(this, "mouseDragOutside", false);
    _defineProperty4(this, "handleDraggedCells", 0);
    _defineProperty4(this, "directions", []);
    _defineProperty4(this, "autoInsertRow", false);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY2;
  }
  ...
  static get SETTING_KEYS() {
    return [PLUGIN_KEY2, ...SETTING_KEYS];
  }
  /**
  ...
  enablePlugin() {
    ...
    this.mapSettings();
    this.registerEvents();
    this.addHook("afterOnCellCornerMouseDown", (event) => _classPrivateMethodGet2(this, _onAfterCellCornerMouseDown, _onAfterCellCornerMouseDown2).call(this, event));
    this.addHook("afterOnCellCornerDblClick", (event) => _classPrivateMethodGet2(this, _onCellCornerDblClick, _onCellCornerDblClick2).call(this, event));
    this.addHook("beforeOnCellMouseOver", (_, coords) => _classPrivateMethodGet2(this, _onBeforeCellMouseOver, _onBeforeCellMouseOver2).call(this, coords));
    super.enablePlugin();
  }
  /**
  ...
  registerEvents() {
    ...
    this.eventManager.addEventListener(documentElement, "mouseup", () => _classPrivateMethodGet2(this, _onMouseUp, _onMouseUp2).call(this));
    this.eventManager.addEventListener(documentElement, "mousemove", (event) => _classPrivateMethodGet2(this, _onMouseMove, _onMouseMove2).call(this, event));
  }
  /**
...
var AutoRowSize = class _AutoRowSize extends BasePlugin {
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _classPrivateMethodInitSpec3(this, _onBeforeChange3);
    _classPrivateMethodInitSpec3(this, _onAfterLoadData3);
    _classPrivateMethodInitSpec3(this, _onBeforeRowResize);
    _classPrivateMethodInitSpec3(this, _onBeforeViewRender3);
    _defineProperty5(this, "headerHeight", null);
    _defineProperty5(this, "ghostTable", new ghostTable_default(this.hot));
    _defineProperty5(this, "samplesGenerator", new samplesGenerator_default((row, column) => {
      if (row >= 0 && column >= 0) {
        const cellMeta = this.hot.getCellMeta(row, column);
        if (cellMeta.hidden) {
          return false;
    ...
    _defineProperty5(this, "firstCalculation", true);
    _defineProperty5(this, "inProgress", false);
    _defineProperty5(this, "measuredRows", 0);
    _defineProperty5(this, "rowHeightsMap", new PhysicalIndexToValueMap());
    this.hot.rowIndexMapper.registerMap(ROW_WIDTHS_MAP_NAME, this.rowHeightsMap);
    this.addHook("beforeRowResize", (size, row, isDblClick) => _classPrivateMethodGet3(this, _onBeforeRowResize, _onBeforeRowResize2).call(this, size, row, isDblClick));
  }
  /**
   * Checks if the plugin is enabled in the handsontable settings. This method is executed in {@link Hooks#beforeInit}
   ...
   */
  isEnabled() {
    const settings = this.hot.getSettings()[PLUGIN_KEY3];
  ...
  enablePlugin() {
    ...
    this.addHook("afterLoadData", function() {
      ...
      return _classPrivateMethodGet3(_this, _onAfterLoadData3, _onAfterLoadData22).call(_this, ...args);
    });
    this.addHook("beforeChangeRender", (changes) => _classPrivateMethodGet3(this, _onBeforeChange3, _onBeforeChange22).call(this, changes));
    this.addHook("beforeColumnResize", () => this.recalculateAllRowsHeight());
    this.addHook("beforeViewRender", (force) => _classPrivateMethodGet3(this, _onBeforeViewRender3, _onBeforeViewRender22).call(this, force));
   ...
   */
  setSamplingOptions() {
    const setting = this.hot.getSettings()[PLUGIN_KEY3];
    const samplingRatio = setting && hasOwnProperty(setting, "samplingRatio") ? setting.samplingRatio : void 0;
    const allowSampleDuplicates = setting && hasOwnProperty(setting, "allowSampleDuplicates") ? setting.allowSampleDuplicates : void 0;
    if (samplingRatio && !isNaN(samplingRatio)) {
      this.samplesGenerator.setSampleCount(parseInt(samplingRatio, 10));
...
var PLUGIN_KEY4 = "bindRowsWithHeaders";
...
var BindRowsWithHeaders = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec4(this, _onModifyRowHeader);
    _defineProperty6(this, "headerIndexes", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY4;
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY4];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    let bindType = this.hot.getSettings()[PLUGIN_KEY4];
    ...
    this.addHook("modifyRowHeader", (row) => _classPrivateMethodGet4(this, _onModifyRowHeader, _onModifyRowHeader2).call(this, row));
    super.enablePlugin();
  }
  /**
   * Disables the plugin functionality for this Handsontable instance.
...
var CollapsibleColumns = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec5(this, _onAfterLoadData4);
    _classPrivateMethodInitSpec5(this, _onInit);
    _classPrivateMethodInitSpec5(this, _onBeforeOnCellMouseDown);
    _classPrivateMethodInitSpec5(this, _onAfterGetColHeader);
    _defineProperty7(this, "nestedHeadersPlugin", null);
    _defineProperty7(this, "headerStateManager", null);
    _classPrivateFieldInitSpec2(this, _collapsedColumnsMap, {
      writable: true,
      value: null
    });
  }
  ...
  static get SETTING_KEYS() {
    return [PLUGIN_KEY5, ...SETTING_KEYS2];
  }
  /**
   * Checks if the plugin is enabled in the handsontable settings. This method is executed in {@link Hooks#beforeInit}
  ...
  enablePlugin() {
    ...
    this.addHook("init", () => _classPrivateMethodGet5(this, _onInit, _onInit2).call(this));
    this.addHook("afterLoadData", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet5(_this, _onAfterLoadData4, _onAfterLoadData23).call(_this, ...args);
    });
    this.addHook("afterGetColHeader", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet5(_this, _onAfterGetColHeader, _onAfterGetColHeader2).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseDown", (event, coords, TD) => _classPrivateMethodGet5(this, _onBeforeOnCellMouseDown, _onBeforeOnCellMouseDown2).call(this, event, coords, TD));
  ...
  toggleCollapsibleSection(coords, action) {
    ...
    this.hot.batchExecution(() => {
      arrayEach(affectedColumnsIndexes, (visualColumn) => {
        _classPrivateFieldGet2(this, _collapsedColumnsMap).setValueAtIndex(this.hot.toPhysicalColumn(visualColumn), actionTranslator.hideColumn);
      });
    }, true);
   ...
   */
  getCollapsedColumns() {
    return _classPrivateFieldGet2(this, _collapsedColumnsMap).getHiddenIndexes();
  }
  /**
   * Destroys the plugin instance.
   */
...
var ColumnStatesManager = class {
  constructor(hot, mapName) {
    _defineProperty8(this, "hot", void 0);
    _defineProperty8(this, "sortingStates", new LinkedPhysicalIndexToValueMap());
    _defineProperty8(this, "sortEmptyCells", SORT_EMPTY_CELLS_DEFAULT);
    _defineProperty8(this, "indicator", SHOW_SORT_INDICATOR_DEFAULT);
    _defineProperty8(this, "headerAction", HEADER_ACTION_DEFAULT);
    _defineProperty8(this, "compareFunctionFactory", void 0);
    _defineProperty8(this, "mapName", void 0);
    this.hot = hot;
...
var PLUGIN_KEY6 = "columnSorting";
var PLUGIN_PRIORITY6 = 50;
var APPEND_COLUMN_CONFIG_STRATEGY = "append";
var REPLACE_COLUMN_CONFIG_STRATEGY = "replace";
var SHORTCUTS_GROUP2 = PLUGIN_KEY6;
registerRootComparator(PLUGIN_KEY6, rootComparator);
...
var ColumnSorting = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec6(this, _onBeforeOnCellMouseDown3);
    _classPrivateMethodInitSpec6(this, _onAfterLoadData5);
    _classPrivateMethodInitSpec6(this, _onAfterGetColHeader3);
    _classPrivateMethodInitSpec6(this, _loadOrSortBySettings);
    _defineProperty9(this, "columnStatesManager", null);
    _defineProperty9(this, "columnMetaCache", null);
    _defineProperty9(this, "pluginKey", PLUGIN_KEY6);
    _defineProperty9(this, "indexesSequenceCache", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY6;
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterGetColHeader", (column, TH) => _classPrivateMethodGet6(this, _onAfterGetColHeader3, _onAfterGetColHeader22).call(this, column, TH));
    this.addHook("beforeOnCellMouseDown", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet6(_this, _onBeforeOnCellMouseDown3, _onBeforeOnCellMouseDown22).call(_this, ...args);
    });
    this.addHook("afterOnCellMouseDown", (event, target) => this.onAfterOnCellMouseDown(event, target));
    this.addHook("afterInit", () => _classPrivateMethodGet6(this, _loadOrSortBySettings, _loadOrSortBySettings2).call(this));
    this.addHook("afterLoadData", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet6(_this, _onAfterLoadData5, _onAfterLoadData24).call(_this, ...args);
    });
    if (this.hot.view) {
      _classPrivateMethodGet6(this, _loadOrSortBySettings, _loadOrSortBySettings2).call(this);
    }
    this.registerShortcuts();
    super.enablePlugin();
  }
...
var Endpoints = class {
  constructor(plugin, settings) {
    _defineProperty10(this, "plugin", void 0);
    _defineProperty10(this, "hot", void 0);
    _defineProperty10(this, "endpoints", []);
    _defineProperty10(this, "settings", void 0);
    _defineProperty10(this, "settingsType", "array");
    _defineProperty10(this, "currentEndpoint", null);
    _defineProperty10(this, "cellsToSetCache", []);
    this.plugin = plugin;
...
var ColumnSummary = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec7(this, _onAfterRowMove);
    _classPrivateMethodInitSpec7(this, _onAfterChange);
    _classPrivateMethodInitSpec7(this, _onAfterInit3);
    _defineProperty11(this, "endpoints", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY7;
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY7];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    this.settings = this.hot.getSettings()[PLUGIN_KEY7];
    this.endpoints = new endpoints_default(this, this.settings);
    this.addHook("afterInit", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet7(_this, _onAfterInit3, _onAfterInit22).call(_this, ...args);
    });
    this.addHook("afterChange", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet7(_this, _onAfterChange, _onAfterChange2).call(_this, ...args);
    });
    ...
    this.addHook("afterRowMove", function() {
      ...
      return _classPrivateMethodGet7(_this, _onAfterRowMove, _onAfterRowMove2).call(_this, ...args);
    });
    super.enablePlugin();
  }
  /**
...
var CommentEditor = class _CommentEditor {
  ...
  constructor(rootDocument, isRtl) {
    _defineProperty12(this, "rootDocument", void 0);
    _defineProperty12(this, "isRtl", false);
    _defineProperty12(this, "container", null);
    _defineProperty12(this, "editor", void 0);
    _defineProperty12(this, "editorStyle", void 0);
    _defineProperty12(this, "hidden", true);
...
var DisplaySwitch = class {
  constructor(displayDelay) {
    _defineProperty13(this, "wasLastActionShow", true);
    _defineProperty13(this, "showDebounced", null);
    _defineProperty13(this, "hidingTimer", null);
...
var PLUGIN_KEY8 = "comments";
var PLUGIN_PRIORITY8 = 60;
var META_COMMENT = "comment";
var META_COMMENT_VALUE = "value";
var META_STYLE = "style";
var META_READONLY = "readOnly";
var SHORTCUTS_GROUP3 = PLUGIN_KEY8;
var SHORTCUTS_CONTEXT_NAME = `plugin:${PLUGIN_KEY8}`;
...
var Comments = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec8(this, _onAfterScroll);
    _classPrivateMethodInitSpec8(this, _onAfterDocumentKeyDown);
    _classPrivateMethodInitSpec8(this, _onEditorMouseUp);
    _classPrivateMethodInitSpec8(this, _onEditorMouseDown);
    _classPrivateMethodInitSpec8(this, _onEditorFocus);
    _classPrivateMethodInitSpec8(this, _onEditorBlur);
    _classPrivateMethodInitSpec8(this, _onAfterRenderer);
    _classPrivateMethodInitSpec8(this, _onMouseUp3);
    _classPrivateMethodInitSpec8(this, _onMouseOver);
    _classPrivateMethodInitSpec8(this, _onMouseDown);
    _defineProperty14(this, "range", {});
    _classPrivateFieldInitSpec3(this, _editor, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec3(this, _displaySwitch, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec3(this, _preventEditorAutoSwitch, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec3(this, _preventEditorHiding, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec3(this, _tempEditorDimensions, {
      writable: true,
      value: {}
    });
    _classPrivateFieldInitSpec3(this, _cellBelowCursor, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec3(this, _commentValueBeforeSave, {
      writable: true,
      value: ""
    });
  }
  ...
  enablePlugin() {
    ...
    if (!_classPrivateFieldGet3(this, _editor)) {
      _classPrivateFieldSet3(this, _editor, new commentEditor_default(this.hot.rootDocument, this.hot.isRtl()));
    }
    if (!_classPrivateFieldGet3(this, _displaySwitch)) {
      _classPrivateFieldSet3(this, _displaySwitch, new displaySwitch_default(this.getDisplayDelaySetting()));
    }
    this.addHook("afterContextMenuDefaultOptions", (options) => this.addToContextMenu(options));
    this.addHook("afterRenderer", (TD, row, col, prop, value, cellProperties) => _classPrivateMethodGet8(this, _onAfterRenderer, _onAfterRenderer2).call(this, TD, cellProperties));
    this.addHook("afterScroll", () => _classPrivateMethodGet8(this, _onAfterScroll, _onAfterScroll2).call(this));
    this.addHook("afterBeginEditing", () => this.hide());
    this.addHook("afterDocumentKeyDown", (event) => _classPrivateMethodGet8(this, _onAfterDocumentKeyDown, _onAfterDocumentKeyDown2).call(this, event));
    _classPrivateFieldGet3(this, _displaySwitch).addLocalHook("hide", () => this.hide());
    _classPrivateFieldGet3(this, _displaySwitch).addLocalHook("show", (row, col) => this.showAtCell(row, col));
    this.registerShortcuts();
   ...
   */
  updatePlugin() {
    _classPrivateFieldGet3(this, _displaySwitch).updateDelay(this.getDisplayDelaySetting());
    super.updatePlugin();
  }
  /**
   * Disables the plugin functionality for this Handsontable instance.
  ...
  registerShortcuts() {
    ...
    gridContext.addShortcut({
      ...
      runOnlyIf: () => {
        var _this$hot$getSelected;
        return ((_this$hot$getSelected = this.hot.getSelectedRangeLast()) === null || _this$hot$getSelected === void 0 ? void 0 : _this$hot$getSelected.highlight.isCell()) && !_classPrivateFieldGet3(this, _editor).isVisible();
      },
    ...
    pluginContext.addShortcut({
      keys: [["Escape"]],
      callback: () => {
        _classPrivateFieldGet3(this, _editor).setValue(_classPrivateFieldGet3(this, _commentValueBeforeSave));
        this.hide();
        manager.setActiveContextName("grid");
      },
      runOnlyIf: () => {
        var _this$hot$getSelected2;
        return ((_this$hot$getSelected2 = this.hot.getSelectedRangeLast()) === null || _this$hot$getSelected2 === void 0 ? void 0 : _this$hot$getSelected2.highlight.isCell()) && _classPrivateFieldGet3(this, _editor).isVisible();
      },
      group: SHORTCUTS_GROUP3
    });
    pluginContext.addShortcut({
      ...
      runOnlyIf: () => {
        ...
        return ((_this$hot$getSelected3 = this.hot.getSelectedRangeLast()) === null || _this$hot$getSelected3 === void 0 ? void 0 : _this$hot$getSelected3.highlight.isCell()) && _classPrivateFieldGet3(this, _editor).isVisible();
      },
      group: SHORTCUTS_GROUP3
    });
  }
  ...
  registerListeners() {
    ...
    this.eventManager.addEventListener(rootDocument, "mouseover", (event) => _classPrivateMethodGet8(this, _onMouseOver, _onMouseOver2).call(this, event));
    this.eventManager.addEventListener(rootDocument, "mousedown", (event) => _classPrivateMethodGet8(this, _onMouseDown, _onMouseDown2).call(this, event));
    this.eventManager.addEventListener(rootDocument, "mouseup", () => _classPrivateMethodGet8(this, _onMouseUp3, _onMouseUp22).call(this));
    this.eventManager.addEventListener(editorElement, "focus", () => _classPrivateMethodGet8(this, _onEditorFocus, _onEditorFocus2).call(this));
    this.eventManager.addEventListener(editorElement, "blur", () => _classPrivateMethodGet8(this, _onEditorBlur, _onEditorBlur2).call(this));
    this.eventManager.addEventListener(editorElement, "mousedown", (event) => _classPrivateMethodGet8(this, _onEditorMouseDown, _onEditorMouseDown2).call(this, event));
    this.eventManager.addEventListener(editorElement, "mouseup", (event) => _classPrivateMethodGet8(this, _onEditorMouseUp, _onEditorMouseUp2).call(this, event));
  }
  /**
  ...
  setComment(value) {
    ...
    const editorValue = _classPrivateFieldGet3(this, _editor).getValue();
    let comment = "";
  ...
  show() {
    ...
    _classPrivateFieldGet3(this, _displaySwitch).cancelHiding();
    _classPrivateFieldGet3(this, _editor).setValue((_ref = meta[META_COMMENT] ? meta[META_COMMENT][META_COMMENT_VALUE] : null) !== null && _ref !== void 0 ? _ref : "");
    _classPrivateFieldGet3(this, _editor).show();
   ...
   */
  hide() {
    _classPrivateFieldGet3(this, _editor).hide();
  }
  /**
  ...
  refreshEditor() {
    ...
    if (!force && (!this.range.from || !_classPrivateFieldGet3(this, _editor).isVisible())) {
      return;
    }
    const {
      rowIndexMapper,
    ...
    _classPrivateFieldGet3(this, _editor).setPosition(0, 0);
    ...
    if (commentStyle) {
      _classPrivateFieldGet3(this, _editor).setSize(commentStyle.width, commentStyle.height);
    } else {
      _classPrivateFieldGet3(this, _editor).resetSize();
    }
    ...
    const {
      width: editorWidth,
      height: editorHeight
    } = _classPrivateFieldGet3(this, _editor).getSize();
    const {
      innerWidth,
      innerHeight
    } = this.hot.rootWindow;
    ...
    _classPrivateFieldGet3(this, _editor).setPosition(x, y);
    _classPrivateFieldGet3(this, _editor).setReadOnlyState(this.getCommentMeta(visualRow, visualColumn, META_READONLY));
  }
  /**
   * Focuses the comments editor element.
   */
  focusEditor() {
    _classPrivateFieldGet3(this, _editor).focus();
  }
  /**
  ...
  getDisplayDelaySetting() {
    const commentSetting = this.hot.getSettings()[PLUGIN_KEY8];
  ...
  getEditorInputElement() {
    return _classPrivateFieldGet3(this, _editor).getInputElement();
  }
  /**
   * Destroys the plugin instance.
   */
  destroy() {
    if (_classPrivateFieldGet3(this, _editor)) {
      _classPrivateFieldGet3(this, _editor).destroy();
    }
    if (_classPrivateFieldGet3(this, _displaySwitch)) {
      _classPrivateFieldGet3(this, _displaySwitch).destroy();
    }
    super.destroy();
  }
};
function _onMouseDown2(event) {
  ...
  if (!_classPrivateFieldGet3(this, _preventEditorAutoSwitch) && !this.targetIsCommentTextArea(event)) {
...
function _onMouseOver2(event) {
  ...
  if (_classPrivateFieldGet3(this, _preventEditorAutoSwitch) || _classPrivateFieldGet3(this, _editor).isFocused() || hasClass(event.target, "wtBorder") || _classPrivateFieldGet3(this, _cellBelowCursor) === event.target || !_classPrivateFieldGet3(this, _editor)) {
    return;
  }
  ...
  if (this.targetIsCellWithComment(event)) {
    ...
    _classPrivateFieldGet3(this, _displaySwitch).show(range);
  } else if (isChildOf(event.target, rootDocument) && !this.targetIsCommentTextArea(event)) {
    _classPrivateFieldGet3(this, _displaySwitch).hide();
  }
}
...
function _onEditorMouseUp2(event) {
  ...
  if (currentWidth !== _classPrivateFieldGet3(this, _tempEditorDimensions).width + 1 || currentHeight !== _classPrivateFieldGet3(this, _tempEditorDimensions).height + 2) {
...
function _onAfterDocumentKeyDown2(event) {
  if (_classPrivateFieldGet3(this, _editor).isVisible()) {
    stopImmediatePropagation(event);
  }
}
function _onAfterScroll2() {
  if (!_classPrivateFieldGet3(this, _preventEditorHiding)) {
    this.hide();
  }
}
...
var CopyableRangesFactory = class {
  ...
  constructor(_ref) {
    ...
    _classPrivateMethodInitSpec9(this, _trimRowsRange);
    _classPrivateMethodInitSpec9(this, _trimColumnsRange);
    _classPrivateFieldInitSpec4(this, _selectedRange, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec4(this, _countRows, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec4(this, _countColumns, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec4(this, _rowsLimit, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec4(this, _columnsLimit, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec4(this, _countColumnHeaders, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldSet4(this, _countRows, countRows);
    _classPrivateFieldSet4(this, _countColumns, countColumns);
    _classPrivateFieldSet4(this, _rowsLimit, rowsLimit);
    _classPrivateFieldSet4(this, _columnsLimit, columnsLimit);
    _classPrivateFieldSet4(this, _countColumnHeaders, countColumnHeaders);
  }
  ...
  setSelectedRange(selectedRange) {
    _classPrivateFieldSet4(this, _selectedRange, selectedRange);
  }
  /**
   ...
   */
  getCellsRange() {
    if (_classPrivateFieldGet4(this, _countRows).call(this) === 0 || _classPrivateFieldGet4(this, _countColumns).call(this) === 0) {
      return null;
    }
    const {
      row: startRow,
      col: startCol
    } = _classPrivateFieldGet4(this, _selectedRange).getTopStartCorner();
    const {
      row: endRow,
      col: endCol
    } = _classPrivateFieldGet4(this, _selectedRange).getBottomEndCorner();
    const finalEndRow = _classPrivateMethodGet9(this, _trimRowsRange, _trimRowsRange2).call(this, startRow, endRow);
    const finalEndCol = _classPrivateMethodGet9(this, _trimColumnsRange, _trimColumnsRange2).call(this, startCol, endCol);
  ...
  getMostBottomColumnHeadersRange() {
    if (_classPrivateFieldGet4(this, _countColumns).call(this) === 0 || _classPrivateFieldGet4(this, _countColumnHeaders).call(this) === 0) {
      return null;
    }
    const {
      col: startCol
  ...
  getAllColumnHeadersRange() {
    ...
    return {
      isRangeTrimmed,
      startRow: -_classPrivateFieldGet4(this, _countColumnHeaders).call(this),
      startCol,
      endRow: -1,
      endCol: finalEndCol
    };
...
function _trimColumnsRange2(startColumn, endColumn) {
  return Math.min(endColumn, Math.max(startColumn + _classPrivateFieldGet4(this, _columnsLimit).call(this) - 1, startColumn));
}
function _trimRowsRange2(startRow, endRow) {
  return Math.min(endRow, Math.max(startRow + _classPrivateFieldGet4(this, _rowsLimit).call(this) - 1, startRow));
}
...
var PLUGIN_KEY9 = "copyPaste";
var PLUGIN_PRIORITY9 = 80;
...
var CopyPaste = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec10(this, _onSafariAfterSelection);
    _classPrivateMethodInitSpec10(this, _onSafariMouseLeave);
    _classPrivateMethodInitSpec10(this, _onSafariMouseEnter);
    _classPrivateMethodInitSpec10(this, _onAfterSelectionEnd);
    _classPrivateMethodInitSpec10(this, _onAfterContextMenuDefaultOptions);
    _classPrivateMethodInitSpec10(this, _removeContentEditableFromHighlightedCell);
    _classPrivateMethodInitSpec10(this, _addContentEditableToHighlightedCell);
    _classPrivateMethodInitSpec10(this, _countCopiedHeaders);
    _classPrivateMethodInitSpec10(this, _ensureClipboardEventsGetTriggered);
    _defineProperty15(this, "columnsLimit", Infinity);
    _defineProperty15(this, "rowsLimit", Infinity);
    _defineProperty15(this, "pasteMode", "overwrite");
    _defineProperty15(this, "uiContainer", this.hot.rootDocument.body);
    _classPrivateFieldInitSpec5(this, _enableCopyColumnHeaders, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec5(this, _enableCopyColumnGroupHeaders, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec5(this, _enableCopyColumnHeadersOnly, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec5(this, _copyMode, {
      writable: true,
      value: "cells-only"
    });
    _classPrivateFieldInitSpec5(this, _isTriggeredByCopy, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec5(this, _isTriggeredByCut, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec5(this, _copyableRangesFactory, {
      writable: true,
    ...
    _defineProperty15(this, "copyableRanges", []);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY9;
  }
  static get SETTING_KEYS() {
    return [PLUGIN_KEY9, ...SETTING_KEYS3];
  }
  static get PLUGIN_PRIORITY() {
  ...
  enablePlugin() {
    ...
    if (typeof settings === "object") {
      ...
      _classPrivateFieldSet5(this, _enableCopyColumnHeaders, !!settings.copyColumnHeaders);
      _classPrivateFieldSet5(this, _enableCopyColumnGroupHeaders, !!settings.copyColumnGroupHeaders);
      _classPrivateFieldSet5(this, _enableCopyColumnHeadersOnly, !!settings.copyColumnHeadersOnly);
    ...
    this.addHook("afterContextMenuDefaultOptions", (options) => _classPrivateMethodGet10(this, _onAfterContextMenuDefaultOptions, _onAfterContextMenuDefaultOptions2).call(this, options));
    this.addHook("afterSelectionEnd", () => _classPrivateMethodGet10(this, _onAfterSelectionEnd, _onAfterSelectionEnd2).call(this));
    ...
    if (isSafari()) {
      this.eventManager.addEventListener(this.hot.rootDocument.body, "mouseenter", function() {
        ...
        return _classPrivateMethodGet10(_this, _onSafariMouseEnter, _onSafariMouseEnter2).call(_this, ...args);
      });
      this.eventManager.addEventListener(this.hot.rootDocument.body, "mouseleave", function() {
        for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
          args[_key2] = arguments[_key2];
        }
        return _classPrivateMethodGet10(_this, _onSafariMouseLeave, _onSafariMouseLeave2).call(_this, ...args);
      });
      this.addHook("afterSelection", () => _classPrivateMethodGet10(this, _onSafariAfterSelection, _onSafariAfterSelection2).call(this));
    }
    super.enablePlugin();
  }
  /**
  ...
  copy() {
    ...
    _classPrivateFieldSet5(this, _copyMode, copyMode);
    _classPrivateFieldSet5(this, _isTriggeredByCopy, true);
    _classPrivateMethodGet10(this, _ensureClipboardEventsGetTriggered, _ensureClipboardEventsGetTriggered2).call(this, "copy");
  }
  /**
   ...
   */
  cut() {
    _classPrivateFieldSet5(this, _isTriggeredByCut, true);
    _classPrivateMethodGet10(this, _ensureClipboardEventsGetTriggered, _ensureClipboardEventsGetTriggered2).call(this, "cut");
  }
  /**
  ...
  setCopyableText() {
    ...
    _classPrivateFieldGet5(this, _copyableRangesFactory).setSelectedRange(selectionRange);
    const groupedRanges = /* @__PURE__ */ new Map([["headers", null], ["cells", null]]);
    if (_classPrivateFieldGet5(this, _copyMode) === "column-headers-only") {
      groupedRanges.set("headers", _classPrivateFieldGet5(this, _copyableRangesFactory).getMostBottomColumnHeadersRange());
    } else {
      if (_classPrivateFieldGet5(this, _copyMode) === "with-column-headers") {
        groupedRanges.set("headers", _classPrivateFieldGet5(this, _copyableRangesFactory).getMostBottomColumnHeadersRange());
      } else if (_classPrivateFieldGet5(this, _copyMode) === "with-column-group-headers") {
        groupedRanges.set("headers", _classPrivateFieldGet5(this, _copyableRangesFactory).getAllColumnHeadersRange());
      }
      groupedRanges.set("cells", _classPrivateFieldGet5(this, _copyableRangesFactory).getCellsRange());
    }
   ...
   */
  onCopy(event) {
    if (!this.hot.isListening() && !_classPrivateFieldGet5(this, _isTriggeredByCopy) || this.isEditorOpened()) {
      return;
    }
    this.setCopyableText();
    _classPrivateFieldSet5(this, _isTriggeredByCopy, false);
    const data = this.getRangedData(this.copyableRanges);
    const copiedHeadersCount = _classPrivateMethodGet10(this, _countCopiedHeaders, _countCopiedHeaders2).call(this, this.copyableRanges);
    ...
    _classPrivateFieldSet5(this, _copyMode, "cells-only");
   ...
   */
  onCut(event) {
    if (!this.hot.isListening() && !_classPrivateFieldGet5(this, _isTriggeredByCut) || this.isEditorOpened()) {
      return;
    }
    this.setCopyableText();
    _classPrivateFieldSet5(this, _isTriggeredByCut, false);
...
function _onAfterContextMenuDefaultOptions2(options) {
  ...
  if (_classPrivateFieldGet5(this, _enableCopyColumnHeaders)) {
    options.items.push(copyWithColumnHeadersItem(this));
  }
  if (_classPrivateFieldGet5(this, _enableCopyColumnGroupHeaders)) {
    options.items.push(copyWithColumnGroupHeadersItem(this));
  }
  if (_classPrivateFieldGet5(this, _enableCopyColumnHeadersOnly)) {
...
function _onSafariMouseEnter2() {
  _classPrivateMethodGet10(this, _removeContentEditableFromHighlightedCell, _removeContentEditableFromHighlightedCell2).call(this);
}
function _onSafariMouseLeave2() {
  _classPrivateMethodGet10(this, _addContentEditableToHighlightedCell, _addContentEditableToHighlightedCell2).call(this);
}
...
var PLUGIN_KEY10 = "customBorders";
var PLUGIN_PRIORITY10 = 90;
...
var CustomBorders = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec11(this, _onAfterInit4);
    _classPrivateMethodInitSpec11(this, _onAfterContextMenuDefaultOptions3);
    _defineProperty16(this, "savedBorders", []);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY10;
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterContextMenuDefaultOptions", (options) => _classPrivateMethodGet11(this, _onAfterContextMenuDefaultOptions3, _onAfterContextMenuDefaultOptions22).call(this, options));
    this.addHook("init", () => _classPrivateMethodGet11(this, _onAfterInit4, _onAfterInit23).call(this));
    super.enablePlugin();
  }
  /**
   * Disables the plugin functionality for this Handsontable instance.
  ...
  changeBorderSettings() {
    const customBorders = this.hot.getSettings()[PLUGIN_KEY10];
...
function _onAfterContextMenuDefaultOptions22(defaultOptions) {
  if (!this.hot.getSettings()[PLUGIN_KEY10]) {
    return;
  }
...
var PLUGIN_KEY11 = "dragToScroll";
var PLUGIN_PRIORITY11 = 100;
var _setupListening = /* @__PURE__ */ new WeakSet();
var DragToScroll = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec12(this, _setupListening);
    _defineProperty17(this, "boundaries", null);
    _defineProperty17(this, "callback", null);
    _defineProperty17(this, "listening", false);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY11;
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterOnCellMouseDown", (event) => _classPrivateMethodGet12(this, _setupListening, _setupListening2).call(this, event));
    this.addHook("afterOnCellCornerMouseDown", (event) => _classPrivateMethodGet12(this, _setupListening, _setupListening2).call(this, event));
    this.registerEvents();
    super.enablePlugin();
  }
  /**
...
var PLUGIN_KEY12 = "dropdownMenu";
var PLUGIN_PRIORITY12 = 230;
var BUTTON_CLASS_NAME = "changeType";
var SHORTCUTS_GROUP4 = PLUGIN_KEY12;
...
var DropdownMenu = class _DropdownMenu extends BasePlugin {
  ...
  static get DEFAULT_ITEMS() {
    return [KEY4, KEY5, KEY, KEY7, KEY, KEY3, KEY, KEY6, KEY, KEY2];
  }
  /**
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _classPrivateMethodInitSpec13(this, _onMenuAfterClose);
    _classPrivateMethodInitSpec13(this, _onSubMenuAfterOpen);
    _classPrivateMethodInitSpec13(this, _onMenuAfterOpen);
    _classPrivateMethodInitSpec13(this, _onMenuBeforeOpen);
    _classPrivateMethodInitSpec13(this, _onAfterGetColHeader4);
    _classPrivateMethodInitSpec13(this, _onTableClick);
    _classPrivateMethodInitSpec13(this, _addCustomShortcuts);
    _defineProperty18(this, "commandExecutor", new CommandExecutor(this.hot));
    _defineProperty18(this, "itemsFactory", null);
    _defineProperty18(this, "menu", null);
    this.hot.addHook("afterGetColHeader", (col, TH) => _classPrivateMethodGet13(this, _onAfterGetColHeader4, _onAfterGetColHeader23).call(this, col, TH));
  }
  /**
   * Checks if the plugin is enabled in the handsontable settings. This method is executed in {@link Hooks#beforeInit}
  ...
  enablePlugin() {
    ...
    const settings = this.hot.getSettings()[PLUGIN_KEY12];
    ...
    this.callOnPluginsReady(() => {
      ...
      this.menu.addLocalHook("beforeOpen", () => _classPrivateMethodGet13(this, _onMenuBeforeOpen, _onMenuBeforeOpen2).call(this));
      this.menu.addLocalHook("afterOpen", () => _classPrivateMethodGet13(this, _onMenuAfterOpen, _onMenuAfterOpen2).call(this));
      this.menu.addLocalHook("afterSubmenuOpen", (subMenuInstance) => _classPrivateMethodGet13(this, _onSubMenuAfterOpen, _onSubMenuAfterOpen2).call(this, subMenuInstance));
      this.menu.addLocalHook("afterClose", () => _classPrivateMethodGet13(this, _onMenuAfterClose, _onMenuAfterClose2).call(this));
   ...
   */
  registerEvents() {
    this.eventManager.addEventListener(this.hot.rootElement, "click", (event) => _classPrivateMethodGet13(this, _onTableClick, _onTableClick2).call(this, event));
  }
  /**
...
function _onMenuAfterOpen2() {
  ...
  _classPrivateMethodGet13(this, _addCustomShortcuts, _addCustomShortcuts2).call(this, this.menu);
}
function _onSubMenuAfterOpen2(subMenuInstance) {
  _classPrivateMethodGet13(this, _addCustomShortcuts, _addCustomShortcuts2).call(this, subMenuInstance);
}
...
var DataProvider = class {
  constructor(hotInstance) {
    ...
    _defineProperty19(this, "options", {});
    this.hot = hotInstance;
  }
  /**
...
var BaseType = class _BaseType {
  ...
  constructor(dataProvider, options) {
    _defineProperty20(this, "dataProvider", void 0);
...
var PLUGIN_KEY13 = "exportFile";
var PLUGIN_PRIORITY13 = 240;
...
var BaseComponent = class {
  constructor(hotInstance, _ref) {
    ...
    _defineProperty21(this, "id", void 0);
    _defineProperty21(this, "elements", []);
    _defineProperty21(this, "hidden", false);
    _defineProperty21(this, "stateId", "");
    _defineProperty21(this, "state", void 0);
    this.hot = hotInstance;
    this.id = id;
...
var BaseUI = class _BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _defineProperty22(this, "eventManager", new eventManager_default(this));
    _defineProperty22(this, "options", void 0);
    _defineProperty22(this, "_element", void 0);
    _defineProperty22(this, "buildState", void 0);
    this.hot = hotInstance;
...
var InputUI = class _InputUI extends BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec14(this, _onKeyup);
    _classPrivateFieldInitSpec6(this, _input, {
      writable: true,
      value: void 0
    });
    this.registerHooks();
   ...
   */
  registerHooks() {
    this.addLocalHook("keyup", (event) => _classPrivateMethodGet14(this, _onKeyup, _onKeyup2).call(this, event));
  }
  /**
   * Build DOM structure.
   */
  build() {
    ...
    _classPrivateFieldSet6(this, _input, this._element.firstChild);
  ...
  update() {
    ...
    _classPrivateFieldGet6(this, _input).type = this.options.type;
    _classPrivateFieldGet6(this, _input).placeholder = this.translateIfPossible(this.options.placeholder);
    _classPrivateFieldGet6(this, _input).value = this.translateIfPossible(this.options.value);
  }
  /**
   * Focus element.
   */
  focus() {
    if (this.isBuilt()) {
      _classPrivateFieldGet6(this, _input).focus();
    }
  }
};
...
var SelectUI = class _SelectUI extends BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec15(this, _onClick);
    _classPrivateMethodInitSpec15(this, _onMenuClosed);
    _classPrivateMethodInitSpec15(this, _onMenuSelect);
    _classPrivateFieldInitSpec7(this, _menu, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec7(this, _items, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec7(this, _caption, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec7(this, _captionElement, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec7(this, _dropdown, {
      writable: true,
      value: void 0
    });
    this.registerHooks();
   ...
   */
  getMenu() {
    return _classPrivateFieldGet7(this, _menu);
  }
  /**
   * Register all necessary hooks.
   */
  registerHooks() {
    this.addLocalHook("click", () => _classPrivateMethodGet15(this, _onClick, _onClick2).call(this));
  }
  /**
   ...
   */
  setItems(items) {
    _classPrivateFieldSet7(this, _items, this.translateNames(items));
    if (_classPrivateFieldGet7(this, _menu)) {
      _classPrivateFieldGet7(this, _menu).setMenuItems(_classPrivateFieldGet7(this, _items));
    }
  }
  /**
  ...
  build() {
    super.build();
    _classPrivateFieldSet7(this, _menu, new Menu(this.hot, {
    ...
    _classPrivateFieldSet7(this, _caption, caption);
    _classPrivateFieldSet7(this, _captionElement, caption.element);
    _classPrivateFieldSet7(this, _dropdown, dropdown);
    if (this.hot.getSettings().ariaTags) {
    ...
    _classPrivateFieldGet7(this, _menu).addLocalHook("select", (command) => _classPrivateMethodGet15(this, _onMenuSelect, _onMenuSelect2).call(this, command));
    _classPrivateFieldGet7(this, _menu).addLocalHook("afterClose", () => _classPrivateMethodGet15(this, _onMenuClosed, _onMenuClosed2).call(this));
    this.update();
  }
  /**
   * Update DOM structure.
  ...
  update() {
    ...
    if (this.options.value) {
      ...
      conditionName = _classPrivateFieldGet7(this, _menu).hot.getTranslatedPhrase(FILTERS_CONDITIONS_NONE);
    }
    _classPrivateFieldGet7(this, _captionElement).textContent = conditionName;
    super.update();
  }
  /**
  ...
  openOptions() {
    ...
    if (_classPrivateFieldGet7(this, _menu)) {
      _classPrivateFieldGet7(this, _menu).open();
      _classPrivateFieldGet7(this, _menu).setPosition({
        left: this.hot.isLtr() ? rect.left - 5 : rect.left - 31,
        top: rect.top - 1,
        width: rect.width,
        height: rect.height
      });
      _classPrivateFieldGet7(this, _menu).getNavigator().toFirstItem();
      _classPrivateFieldGet7(this, _menu).getKeyboardShortcutsCtrl().addCustomShortcuts([{
        keys: [["Tab"], ["Shift", "Tab"]],
        callback: (event) => {
          this.closeOptions();
  ...
  closeOptions() {
    if (_classPrivateFieldGet7(this, _menu)) {
      _classPrivateFieldGet7(this, _menu).close();
    }
  }
  /**
   * Focus element.
  ...
  destroy() {
    if (_classPrivateFieldGet7(this, _menu)) {
      _classPrivateFieldGet7(this, _menu).destroy();
      _classPrivateFieldSet7(this, _menu, null);
    }
    if (_classPrivateFieldGet7(this, _caption)) {
      _classPrivateFieldGet7(this, _caption).destroy();
    }
    if (_classPrivateFieldGet7(this, _dropdown)) {
      _classPrivateFieldGet7(this, _dropdown).destroy();
    }
    super.destroy();
  }
};
...
var ConditionComponent = class extends BaseComponent {
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec16(this, _onInputKeyDown);
    _classPrivateMethodInitSpec16(this, _onConditionSelect);
    _defineProperty23(this, "name", "");
    _defineProperty23(this, "addSeparator", false);
   ...
   */
  registerHooks() {
    this.getSelectElement().addLocalHook("select", (command) => _classPrivateMethodGet16(this, _onConditionSelect, _onConditionSelect2).call(this, command)).addLocalHook("afterClose", () => this.runLocalHooks("afterClose")).addLocalHook("tabKeydown", (event) => this.runLocalHooks("selectTabKeydown", event));
    arrayEach(this.getInputElements(), (input) => {
      input.addLocalHook("keydown", (event) => _classPrivateMethodGet16(this, _onInputKeyDown, _onInputKeyDown2).call(this, event));
    });
  }
  /**
...
var RadioInputUI = class _RadioInputUI extends BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateFieldInitSpec8(this, _input2, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec8(this, _label, {
      writable: true,
      value: void 0
    });
  }
  ...
  build() {
    ...
    _classPrivateFieldSet8(this, _label, label);
    _classPrivateFieldSet8(this, _input2, this._element.firstChild);
    _classPrivateFieldGet8(this, _input2).checked = this.options.checked;
  ...
  update() {
    ...
    _classPrivateFieldGet8(this, _label).textContent = this.translateIfPossible(this.options.label.textContent);
  }
  /**
   ...
   */
  isChecked() {
    return _classPrivateFieldGet8(this, _input2).checked;
  }
  /**
  ...
  setChecked() {
    ...
    if (this.isBuilt()) {
      _classPrivateFieldGet8(this, _input2).checked = value;
    }
  }
  /**
   * Focus element.
  ...
  focus() {
    if (this.isBuilt()) {
      _classPrivateFieldGet8(this, _input2).focus();
    }
  }
};
...
var OperatorsComponent = class extends BaseComponent {
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec17(this, _onRadioInputChange);
    _defineProperty24(this, "name", "");
    this.name = options.name;
  ...
  buildOperatorsElement() {
    ...
    arrayEach(operationKeys, (operation) => {
      ...
      radioInput.addLocalHook("change", (event) => _classPrivateMethodGet17(this, _onRadioInputChange, _onRadioInputChange2).call(this, event));
...
var LinkUI = class _LinkUI extends BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateFieldInitSpec9(this, _link, {
      writable: true,
      value: void 0
    });
  }
  ...
  build() {
    super.build();
    _classPrivateFieldSet9(this, _link, this._element.firstChild);
  }
  /**
   * Update element.
   */
  update() {
    ...
    _classPrivateFieldGet9(this, _link).textContent = this.translateIfPossible(this.options.textContent);
  }
  /**
   * Focus element.
   */
  focus() {
    if (this.isBuilt()) {
      _classPrivateFieldGet9(this, _link).focus();
    }
  }
  /**
   ...
   */
  activate() {
    _classPrivateFieldGet9(this, _link).click();
  }
};
...
function _classPrivateFieldInitSpec10(obj, privateMap, value) {
  _checkPrivateRedeclaration20(obj, privateMap);
  privateMap.set(obj, value);
}
...
var SHORTCUTS_GROUP5 = "multipleSelect.itemBox";
...
var MultipleSelectUI = class _MultipleSelectUI extends BaseUI {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec18(this, _onClearAllClick);
    _classPrivateMethodInitSpec18(this, _onSelectAllClick);
    _classPrivateMethodInitSpec18(this, _onInputKeyDown3);
    _classPrivateMethodInitSpec18(this, _onInput);
    _classPrivateFieldInitSpec10(this, _items2, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec10(this, _itemsBox, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec10(this, _locale, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec10(this, _searchInput, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec10(this, _selectAllUI, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec10(this, _clearAllUI, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldSet10(this, _searchInput, new InputUI(this.hot, {
      placeholder: FILTERS_BUTTONS_PLACEHOLDER_SEARCH,
      className: "htUIMultipleSelectSearch"
    }));
    _classPrivateFieldSet10(this, _selectAllUI, new LinkUI(this.hot, {
      textContent: FILTERS_BUTTONS_SELECT_ALL,
      className: "htUISelectAll"
    }));
    _classPrivateFieldSet10(this, _clearAllUI, new LinkUI(this.hot, {
   ...
   */
  getItemsBox() {
    return _classPrivateFieldGet10(this, _itemsBox);
  }
  /**
   * Register all necessary hooks.
   */
  registerHooks() {
    _classPrivateFieldGet10(this, _searchInput).addLocalHook("keydown", (event) => _classPrivateMethodGet18(this, _onInputKeyDown3, _onInputKeyDown22).call(this, event));
    _classPrivateFieldGet10(this, _searchInput).addLocalHook("input", (event) => _classPrivateMethodGet18(this, _onInput, _onInput2).call(this, event));
    _classPrivateFieldGet10(this, _selectAllUI).addLocalHook("click", (event) => _classPrivateMethodGet18(this, _onSelectAllClick, _onSelectAllClick2).call(this, event));
    _classPrivateFieldGet10(this, _clearAllUI).addLocalHook("click", (event) => _classPrivateMethodGet18(this, _onClearAllClick, _onClearAllClick2).call(this, event));
  }
  /**
   ...
   */
  setItems(items) {
    _classPrivateFieldSet10(this, _items2, items);
    if (_classPrivateFieldGet10(this, _itemsBox)) {
      _classPrivateFieldGet10(this, _itemsBox).loadData(_classPrivateFieldGet10(this, _items2));
    }
  }
  /**
   ...
   */
  setLocale(locale) {
    _classPrivateFieldSet10(this, _locale, locale);
  }
  /**
   ...
   */
  getLocale() {
    return _classPrivateFieldGet10(this, _locale);
  }
  /**
   ...
   */
  getItems() {
    return [..._classPrivateFieldGet10(this, _items2)];
  }
  /**
   * Get element value.
   *
   ...
   */
  getValue() {
    return itemsToValue(_classPrivateFieldGet10(this, _items2));
  }
  /**
  ...
  getSearchInputElement() {
    return _classPrivateFieldGet10(this, _searchInput);
  }
  /**
   ...
   */
  getSelectAllElement() {
    return _classPrivateFieldGet10(this, _selectAllUI);
  }
  /**
   ...
   */
  getClearAllElement() {
    return _classPrivateFieldGet10(this, _clearAllUI);
  }
  /**
   ...
   */
  isSelectedAllValues() {
    return _classPrivateFieldGet10(this, _items2).length === this.getValue().length;
  }
  /**
   * Build DOM structure.
   */
  build() {
    ...
    const selectionControl = new BaseUI(this.hot, {
      ...
      children: [_classPrivateFieldGet10(this, _selectAllUI), _classPrivateFieldGet10(this, _clearAllUI)]
    });
    this._element.appendChild(_classPrivateFieldGet10(this, _searchInput).element);
    ...
    const hotInitializer = (wrapper) => {
      ...
      if (_classPrivateFieldGet10(this, _itemsBox)) {
        _classPrivateFieldGet10(this, _itemsBox).destroy();
      }
      addClass(wrapper, "htUIMultipleSelectHot");
      _classPrivateFieldSet10(this, _itemsBox, new this.hot.constructor(wrapper, {
        data: _classPrivateFieldGet10(this, _items2),
        columns: [{
          data: "checked",
          type: "checkbox",
          label: {
        ...
        beforeOnCellMouseUp: () => {
          _classPrivateFieldGet10(this, _itemsBox).listen();
        },
        maxCols: 1,
        autoWrapCol: true,
        height: 110,
        // Workaround for #151.
        colWidths: () => _classPrivateFieldGet10(this, _itemsBox).container.scrollWidth - getScrollbarWidth(rootDocument),
        copyPaste: false,
      ...
      _classPrivateFieldGet10(this, _itemsBox).init();
      const shortcutManager = _classPrivateFieldGet10(this, _itemsBox).getShortcutManager();
      ...
      gridContext.addShortcut({
        keys: [["Tab"], ["Shift", "Tab"]],
        callback: (event) => {
          _classPrivateFieldGet10(this, _itemsBox).deselectCell();
          this.runLocalHooks("keydown", event, this);
   ...
   */
  reset() {
    _classPrivateFieldGet10(this, _searchInput).reset();
    _classPrivateFieldGet10(this, _selectAllUI).reset();
    _classPrivateFieldGet10(this, _clearAllUI).reset();
  }
  /**
   * Update DOM structure.
   */
  update() {
    ...
    _classPrivateFieldGet10(this, _itemsBox).loadData(valueToItems(_classPrivateFieldGet10(this, _items2), this.options.value));
    super.update();
  }
  /**
   * Destroy instance.
  ...
  destroy() {
    ...
    _classPrivateFieldGet10(this, _searchInput).destroy();
    _classPrivateFieldGet10(this, _clearAllUI).destroy();
    _classPrivateFieldGet10(this, _selectAllUI).destroy();
    _classPrivateFieldSet10(this, _searchInput, null);
    _classPrivateFieldSet10(this, _clearAllUI, null);
    _classPrivateFieldSet10(this, _selectAllUI, null);
    _classPrivateFieldSet10(this, _itemsBox, null);
    _classPrivateFieldSet10(this, _items2, null);
    super.destroy();
  }
};
function _onInput2(event) {
  ...
  let filteredItems;
  if (value === "") {
    filteredItems = [..._classPrivateFieldGet10(this, _items2)];
  } else {
    filteredItems = arrayFilter(_classPrivateFieldGet10(this, _items2), (item) => `${item.value}`.toLocaleLowerCase(this.getLocale()).indexOf(value) >= 0);
  }
  _classPrivateFieldGet10(this, _itemsBox).loadData(filteredItems);
}
function _onInputKeyDown22(event) {
  ...
  if (isKeyCode("ARROW_DOWN")) {
    ...
    stopImmediatePropagation(event);
    _classPrivateFieldGet10(this, _itemsBox).listen();
    _classPrivateFieldGet10(this, _itemsBox).selectCell(0, 0);
  }
}
function _onSelectAllClick2(event) {
  const changes = [];
  event.preventDefault();
  arrayEach(_classPrivateFieldGet10(this, _itemsBox).getSourceData(), (row, rowIndex) => {
    row.checked = true;
    changes.push(dataRowToChangesArray(row, rowIndex)[0]);
  });
  _classPrivateFieldGet10(this, _itemsBox).setSourceDataAtCell(changes);
}
...
function _classPrivateMethodInitSpec19(obj, privateSet) {
  _checkPrivateRedeclaration21(obj, privateSet);
  privateSet.add(obj);
}
...
var ValueComponent = class extends BaseComponent {
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec19(this, _onInputKeyDown4);
    _defineProperty25(this, "name", "");
    this.name = options.name;
   ...
   */
  registerHooks() {
    this.getMultipleSelectElement().addLocalHook("keydown", (event) => _classPrivateMethodGet19(this, _onInputKeyDown4, _onInputKeyDown23).call(this, event)).addLocalHook("listTabKeydown", (event) => this.runLocalHooks("listTabKeydown", event));
  }
  /**
   * Gets the list of elements from which the component is built.
   *
...
var ActionBarComponent = class _ActionBarComponent extends BaseComponent {
  ...
  constructor(hotInstance, options) {
    ...
    _classPrivateMethodInitSpec20(this, _onButtonClick);
    _defineProperty26(this, "name", "");
    this.name = options.name;
    this.elements.push(new InputUI(this.hot, {
      type: "button",
  ...
  registerHooks() {
    arrayEach(this.elements, (element) => {
      element.addLocalHook("click", (event, button) => _classPrivateMethodGet20(this, _onButtonClick, _onButtonClick2).call(this, event, button));
    });
  }
  /**
   * Get menu object descriptor.
...
var ConditionCollection = class {
  constructor(hot) {
    ...
    _defineProperty27(this, "isMapRegistrable", void 0);
    _defineProperty27(this, "filteringStates", new LinkedPhysicalIndexToValueMap());
    this.hot = hot;
...
var DataFilter = class {
  constructor(conditionCollection) {
    ...
    _defineProperty28(this, "conditionCollection", void 0);
    _defineProperty28(this, "columnDataFactory", void 0);
...
function _classPrivateMethodInitSpec21(obj, privateSet) {
  _checkPrivateRedeclaration23(obj, privateSet);
  privateSet.add(obj);
}
...
var ConditionUpdateObserver = class {
  constructor(hot, conditionCollection) {
    ...
    _classPrivateMethodInitSpec21(this, _onConditionAfterClean);
    _classPrivateMethodInitSpec21(this, _onConditionBeforeClean);
    _classPrivateMethodInitSpec21(this, _onConditionBeforeModify);
    _defineProperty29(this, "hot", void 0);
    _defineProperty29(this, "conditionCollection", void 0);
    _defineProperty29(this, "columnDataFactory", void 0);
    _defineProperty29(this, "changes", []);
    _defineProperty29(this, "grouping", false);
    _defineProperty29(this, "latestEditedColumnPosition", -1);
    _defineProperty29(this, "latestOrderStack", []);
    this.hot = hot;
    this.conditionCollection = conditionCollection;
    this.columnDataFactory = columnDataFactory;
    this.conditionCollection.addLocalHook("beforeRemove", (column) => _classPrivateMethodGet21(this, _onConditionBeforeModify, _onConditionBeforeModify2).call(this, column));
    ...
    this.conditionCollection.addLocalHook("beforeClean", () => _classPrivateMethodGet21(this, _onConditionBeforeClean, _onConditionBeforeClean2).call(this));
    this.conditionCollection.addLocalHook("afterClean", () => _classPrivateMethodGet21(this, _onConditionAfterClean, _onConditionAfterClean2).call(this));
  }
  /**
...
var PLUGIN_KEY14 = "filters";
var PLUGIN_PRIORITY14 = 250;
...
var Filters = class extends BasePlugin {
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _classPrivateMethodInitSpec22(this, _updateComponents);
    _classPrivateMethodInitSpec22(this, _onAfterGetColHeader5);
    _classPrivateMethodInitSpec22(this, _onSelectUIClosed);
    _classPrivateMethodInitSpec22(this, _onComponentChange);
    _classPrivateMethodInitSpec22(this, _onActionBarSubmit);
    _classPrivateMethodInitSpec22(this, _onAfterDropdownMenuDefaultOptions);
    _classPrivateMethodInitSpec22(this, _onAfterDropdownMenuHide);
    _classPrivateMethodInitSpec22(this, _onAfterDropdownMenuShow);
    _classPrivateMethodInitSpec22(this, _onAfterChange3);
    _defineProperty30(this, "dropdownMenuPlugin", null);
    _defineProperty30(this, "conditionCollection", null);
    _defineProperty30(this, "conditionUpdateObserver", null);
    _defineProperty30(this, "components", /* @__PURE__ */ new Map([["filter_by_condition", null], ["filter_operators", null], ["filter_by_condition2", null], ["filter_by_value", null], ["filter_action_bar", null]]));
    _defineProperty30(this, "filtersRowsMap", null);
    _classPrivateFieldInitSpec11(this, _menuFocusNavigator, {
      writable: true,
      value: void 0
    });
    this.hot.addHook("afterGetColHeader", (col, TH) => _classPrivateMethodGet22(this, _onAfterGetColHeader5, _onAfterGetColHeader24).call(this, col, TH));
  }
  /**
   * Checks if the plugin is enabled in the handsontable settings. This method is executed in {@link Hooks#beforeInit}
   ...
   */
  isEnabled() {
    return this.hot.getSettings()[PLUGIN_KEY14] ? true : false;
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    const addConfirmationHooks = (component) => {
      component.addLocalHook("accept", () => _classPrivateMethodGet22(this, _onActionBarSubmit, _onActionBarSubmit2).call(this, "accept"));
      component.addLocalHook("cancel", () => _classPrivateMethodGet22(this, _onActionBarSubmit, _onActionBarSubmit2).call(this, "cancel"));
      component.addLocalHook("change", (command) => _classPrivateMethodGet22(this, _onComponentChange, _onComponentChange2).call(this, component, command));
      return component;
    };
    ...
    if (!this.components.get("filter_by_condition")) {
      ...
      conditionComponent.addLocalHook("afterClose", () => _classPrivateMethodGet22(this, _onSelectUIClosed, _onSelectUIClosed2).call(this));
    ...
    if (!this.conditionUpdateObserver) {
      ...
      this.conditionUpdateObserver.addLocalHook("update", (conditionState) => _classPrivateMethodGet22(this, _updateComponents, _updateComponents2).call(this, conditionState));
    }
    this.components.forEach((component) => component.show());
    this.addHook("afterDropdownMenuDefaultOptions", (defaultOptions) => _classPrivateMethodGet22(this, _onAfterDropdownMenuDefaultOptions, _onAfterDropdownMenuDefaultOptions2).call(this, defaultOptions));
    this.addHook("afterDropdownMenuShow", () => _classPrivateMethodGet22(this, _onAfterDropdownMenuShow, _onAfterDropdownMenuShow2).call(this));
    this.addHook("afterDropdownMenuHide", () => _classPrivateMethodGet22(this, _onAfterDropdownMenuHide, _onAfterDropdownMenuHide2).call(this));
    this.addHook("afterChange", (changes) => _classPrivateMethodGet22(this, _onAfterChange3, _onAfterChange22).call(this, changes));
    if (this.hot.getSettings().dropdownMenu && this.dropdownMenuPlugin) {
      this.dropdownMenuPlugin.disablePlugin();
      this.dropdownMenuPlugin.enablePlugin();
    }
    if (!_classPrivateFieldGet11(this, _menuFocusNavigator) && this.dropdownMenuPlugin.enabled) {
      ...
      const focusableItems = [
        ...
        // to the menu navigation using arrow keys.
        {
          focus: () => {
            const menuNavigator = mainMenu.getNavigator();
            const lastSelectedMenuItem = _classPrivateFieldGet11(this, _menuFocusNavigator).getLastMenuPage();
            mainMenu.focus();
      ...
      _classPrivateFieldSet11(this, _menuFocusNavigator, createMenuFocusController(mainMenu, focusableItems));
      const forwardToFocusNavigation = (event) => {
        _classPrivateFieldGet11(this, _menuFocusNavigator).listen();
        event.preventDefault();
        if (isKey(event.keyCode, "TAB")) {
          if (event.shiftKey) {
            _classPrivateFieldGet11(this, _menuFocusNavigator).toPreviousItem();
          } else {
            _classPrivateFieldGet11(this, _menuFocusNavigator).toNextItem();
          }
        }
      };
...
function getEngineSettingsOverrides(hotSettings) {
  ...
  return {
    ...
    language: (_hotSettings$PLUGIN_K = hotSettings[PLUGIN_KEY15]) === null || _hotSettings$PLUGIN_K === void 0 || (_hotSettings$PLUGIN_K = _hotSettings$PLUGIN_K.language) === null || _hotSettings$PLUGIN_K === void 0 ? void 0 : _hotSettings$PLUGIN_K.langCode
  };
}
...
function getEngineSettingsWithDefaultsAndOverrides(hotSettings) {
  ...
  const pluginSettings = hotSettings[PLUGIN_KEY15];
...
function getEngineRelationshipRegistry() {
  ...
  const pluginStaticRegistry = staticRegister(PLUGIN_KEY15);
...
function _classPrivateFieldInitSpec12(obj, privateMap, value) {
  _checkPrivateRedeclaration25(obj, privateMap);
  privateMap.set(obj, value);
}
...
var AxisSyncer = class {
  constructor(axis, indexMapper, indexSyncer) {
    _classPrivateFieldInitSpec12(this, _axis, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec12(this, _indexMapper, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec12(this, _indexSyncer, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec12(this, _indexesSequence, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec12(this, _movedIndexes, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec12(this, _finalIndex, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec12(this, _removedIndexes, {
      writable: true,
      value: []
    });
    _classPrivateFieldSet12(this, _axis, axis);
    _classPrivateFieldSet12(this, _indexMapper, indexMapper);
    _classPrivateFieldSet12(this, _indexSyncer, indexSyncer);
  }
  /**
  ...
  setRemovedHfIndexes(removedIndexes) {
    _classPrivateFieldSet12(this, _removedIndexes, removedIndexes.map((physicalIndex) => {
      const visualIndex = _classPrivateFieldGet12(this, _indexMapper).getVisualFromPhysicalIndex(physicalIndex);
      return this.getHfIndexFromVisualIndex(visualIndex);
    }));
    return _classPrivateFieldGet12(this, _removedIndexes);
  }
  /**
  ...
  getHfIndexFromVisualIndex(visualIndex) {
    const indexesSequence = _classPrivateFieldGet12(this, _indexMapper).getIndexesSequence();
    const notTrimmedIndexes = _classPrivateFieldGet12(this, _indexMapper).getNotTrimmedIndexes();
  ...
  syncMoves(moves) {
    ...
    const SYNC_MOVE_METHOD_NAME = `move${toUpperCaseFirst(_classPrivateFieldGet12(this, _axis))}s`;
    _classPrivateFieldGet12(this, _indexSyncer).getEngine().batch(() => {
      moves.forEach((move) => {
        ...
        if (moveToTheSamePosition && anotherMoveWithoutEffect) {
          _classPrivateFieldGet12(this, _indexSyncer).getEngine()[SYNC_MOVE_METHOD_NAME](_classPrivateFieldGet12(this, _indexSyncer).getSheetId(), move.from, NUMBER_OF_MOVED_INDEXES, move.to);
        }
      });
    });
  }
  ...
  storeMovesInformation(movedVisualIndexes, visualFinalIndex, movePossible) {
    ...
    _classPrivateFieldSet12(this, _movedIndexes, movedVisualIndexes.map((index) => this.getHfIndexFromVisualIndex(index)));
    _classPrivateFieldSet12(this, _finalIndex, this.getHfIndexFromVisualIndex(visualFinalIndex));
  }
  /**
  ...
  getMoveLine(movedHfIndexes, finalHfIndex) {
    const numberOfElements = _classPrivateFieldGet12(this, _indexMapper).getNumberOfIndexes();
  ...
  calculateAndSyncMoves(movePossible, orderChanged) {
    if (_classPrivateFieldGet12(this, _indexSyncer).isPerformingUndoRedo()) {
      return;
    }
    if (movePossible === false || orderChanged === false) {
      return;
    }
    const calculatedMoves = this.adjustedCalculatedMoves(this.getInitiallyCalculatedMoves(_classPrivateFieldGet12(this, _movedIndexes), _classPrivateFieldGet12(this, _finalIndex)));
    if (_classPrivateFieldGet12(this, _indexSyncer).getSheetId() === null) {
      _classPrivateFieldGet12(this, _indexSyncer).getPostponeAction(() => this.syncMoves(calculatedMoves));
    } else {
  ...
  getIndexesChangeSyncMethod() {
    const SYNC_ORDER_CHANGE_METHOD_NAME = `set${toUpperCaseFirst(_classPrivateFieldGet12(this, _axis))}Order`;
    return (source) => {
      if (_classPrivateFieldGet12(this, _indexSyncer).isPerformingUndoRedo()) {
        return;
      }
      const newSequence = _classPrivateFieldGet12(this, _indexMapper).getIndexesSequence();
      if (source === "update") {
        const relativeTransformation = _classPrivateFieldGet12(this, _indexesSequence).map((index) => newSequence.indexOf(index));
        const sheetDimensions = _classPrivateFieldGet12(this, _indexSyncer).getEngine().getSheetDimensions(_classPrivateFieldGet12(this, _indexSyncer).getSheetId());
        let sizeForAxis;
        if (_classPrivateFieldGet12(this, _axis) === "row") {
        ...
        _classPrivateFieldGet12(this, _indexSyncer).getEngine()[SYNC_ORDER_CHANGE_METHOD_NAME](_classPrivateFieldGet12(this, _indexSyncer).getSheetId(), relativeTransformation);
      }
      _classPrivateFieldSet12(this, _indexesSequence, newSequence);
    };
  }
  /**
   ...
   */
  init() {
    _classPrivateFieldSet12(this, _indexesSequence, _classPrivateFieldGet12(this, _indexMapper).getIndexesSequence());
  }
};
...
function _classPrivateFieldInitSpec13(obj, privateMap, value) {
  _checkPrivateRedeclaration26(obj, privateMap);
  privateMap.set(obj, value);
}
...
var IndexSyncer = class {
  constructor(rowIndexMapper, columnIndexMapper, postponeAction) {
    _classPrivateFieldInitSpec13(this, _rowIndexSyncer, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec13(this, _columnIndexSyncer, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec13(this, _postponeAction, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec13(this, _isPerformingUndo, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec13(this, _isPerformingRedo, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec13(this, _engine, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec13(this, _sheetId, {
      writable: true,
      value: null
    });
    _classPrivateFieldSet13(this, _rowIndexSyncer, new axisSyncer_default("row", rowIndexMapper, this));
    _classPrivateFieldSet13(this, _columnIndexSyncer, new axisSyncer_default("column", columnIndexMapper, this));
    _classPrivateFieldSet13(this, _postponeAction, postponeAction);
  }
  /**
  ...
  getForAxis(indexType) {
    if (indexType === "row") {
      return _classPrivateFieldGet13(this, _rowIndexSyncer);
    }
    return _classPrivateFieldGet13(this, _columnIndexSyncer);
  }
  /**
  ...
  setPerformUndo(flagValue) {
    _classPrivateFieldSet13(this, _isPerformingUndo, flagValue);
  }
  /**
  ...
  setPerformRedo(flagValue) {
    _classPrivateFieldSet13(this, _isPerformingRedo, flagValue);
  }
  /**
  ...
  isPerformingUndoRedo() {
    return _classPrivateFieldGet13(this, _isPerformingUndo) || _classPrivateFieldGet13(this, _isPerformingRedo);
  }
  /**
   ...
   */
  getSheetId() {
    return _classPrivateFieldGet13(this, _sheetId);
  }
  /**
   ...
   */
  getEngine() {
    return _classPrivateFieldGet13(this, _engine);
  }
  /**
   ...
   */
  getPostponeAction() {
    return _classPrivateFieldGet13(this, _postponeAction);
  }
  /**
  ...
  setupSyncEndpoint(engine, sheetId) {
    _classPrivateFieldSet13(this, _engine, engine);
    _classPrivateFieldSet13(this, _sheetId, sheetId);
    _classPrivateFieldGet13(this, _rowIndexSyncer).init();
    _classPrivateFieldGet13(this, _columnIndexSyncer).init();
  }
};
...
function _classPrivateFieldInitSpec14(obj, privateMap, value) {
  _checkPrivateRedeclaration27(obj, privateMap);
  privateMap.set(obj, value);
}
...
var PLUGIN_KEY15 = "formulas";
var SETTING_KEYS4 = ["maxRows", "maxColumns", "language"];
var PLUGIN_PRIORITY15 = 260;
...
var Formulas = class extends BasePlugin {
  constructor() {
    ...
    super(...arguments);
    _this = this;
    _classPrivateMethodInitSpec23(this, _onEngineSheetRemoved);
    _classPrivateMethodInitSpec23(this, _onEngineSheetRenamed);
    _classPrivateMethodInitSpec23(this, _onEngineSheetAdded);
    _classPrivateMethodInitSpec23(this, _onEngineNamedExpressionsRemoved);
    _classPrivateMethodInitSpec23(this, _onEngineNamedExpressionsAdded);
    _classPrivateMethodInitSpec23(this, _onEngineValuesUpdated);
    _classPrivateMethodInitSpec23(this, _onAfterDetachChild);
    _classPrivateMethodInitSpec23(this, _onAfterRemoveCol);
    _classPrivateMethodInitSpec23(this, _onAfterRemoveRow);
    _classPrivateMethodInitSpec23(this, _onAfterCreateCol);
    _classPrivateMethodInitSpec23(this, _onAfterCreateRow);
    _classPrivateMethodInitSpec23(this, _onBeforeRemoveCol);
    _classPrivateMethodInitSpec23(this, _onBeforeRemoveRow);
    _classPrivateMethodInitSpec23(this, _onBeforeCreateCol);
    _classPrivateMethodInitSpec23(this, _onBeforeCreateRow);
    _classPrivateMethodInitSpec23(this, _onAfterSetSourceDataAtCell);
    _classPrivateMethodInitSpec23(this, _onAfterSetDataAtCell);
    _classPrivateMethodInitSpec23(this, _onModifySourceData);
    _classPrivateMethodInitSpec23(this, _onModifyData);
    _classPrivateMethodInitSpec23(this, _onAfterLoadData6);
    _classPrivateMethodInitSpec23(this, _onAfterCellMetaReset);
    _classPrivateMethodInitSpec23(this, _onBeforeLoadData);
    _classPrivateMethodInitSpec23(this, _onBeforeAutofill);
    _classPrivateMethodInitSpec23(this, _onBeforeValidate);
    _classPrivateFieldInitSpec14(this, _internalOperationPending, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec14(this, _hotWasInitializedWithEmptyData, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec14(this, _engineListeners, {
      writable: true,
      value: [["valuesUpdated", function() {
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        return _classPrivateMethodGet23(_this, _onEngineValuesUpdated, _onEngineValuesUpdated2).call(_this, ...args);
      }], ["namedExpressionAdded", function() {
        for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
          args[_key2] = arguments[_key2];
        }
        return _classPrivateMethodGet23(_this, _onEngineNamedExpressionsAdded, _onEngineNamedExpressionsAdded2).call(_this, ...args);
      }], ["namedExpressionRemoved", function() {
        for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
          args[_key3] = arguments[_key3];
        }
        return _classPrivateMethodGet23(_this, _onEngineNamedExpressionsRemoved, _onEngineNamedExpressionsRemoved2).call(_this, ...args);
      }], ["sheetAdded", function() {
        for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
          args[_key4] = arguments[_key4];
        }
        return _classPrivateMethodGet23(_this, _onEngineSheetAdded, _onEngineSheetAdded2).call(_this, ...args);
      }], ["sheetRenamed", function() {
        for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
          args[_key5] = arguments[_key5];
        }
        return _classPrivateMethodGet23(_this, _onEngineSheetRenamed, _onEngineSheetRenamed2).call(_this, ...args);
      }], ["sheetRemoved", function() {
        for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
          args[_key6] = arguments[_key6];
        }
        return _classPrivateMethodGet23(_this, _onEngineSheetRemoved, _onEngineSheetRemoved2).call(_this, ...args);
      }]]
    });
    _defineProperty31(this, "staticRegister", staticRegister("formulas"));
    _defineProperty31(this, "engine", null);
    _defineProperty31(this, "sheetName", null);
    _defineProperty31(this, "indexSyncer", null);
    _defineProperty31(this, "rowAxisSyncer", null);
    _defineProperty31(this, "columnAxisSyncer", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY15;
  }
  ...
  static get SETTING_KEYS() {
    return [PLUGIN_KEY15, ...SETTING_KEYS4];
  }
  /**
   ...
   */
  isEnabled() {
    return this.hot.getSettings()[PLUGIN_KEY15] ? true : false;
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    this.addHook("beforeLoadData", function() {
      ...
      return _classPrivateMethodGet23(_this2, _onBeforeLoadData, _onBeforeLoadData2).call(_this2, ...args);
    });
    this.addHook("afterLoadData", function() {
      for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
        args[_key8] = arguments[_key8];
      }
      return _classPrivateMethodGet23(_this2, _onAfterLoadData6, _onAfterLoadData25).call(_this2, ...args);
    });
    ...
    this.addHook("modifyData", function() {
      ...
      return _classPrivateMethodGet23(_this2, _onModifyData, _onModifyData2).call(_this2, ...args);
    });
    this.addHook("modifySourceData", function() {
      for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        args[_key12] = arguments[_key12];
      }
      return _classPrivateMethodGet23(_this2, _onModifySourceData, _onModifySourceData2).call(_this2, ...args);
    });
    this.addHook("beforeValidate", function() {
      for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
        args[_key13] = arguments[_key13];
      }
      return _classPrivateMethodGet23(_this2, _onBeforeValidate, _onBeforeValidate2).call(_this2, ...args);
    });
    this.addHook("afterSetSourceDataAtCell", function() {
      for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {
        args[_key14] = arguments[_key14];
      }
      return _classPrivateMethodGet23(_this2, _onAfterSetSourceDataAtCell, _onAfterSetSourceDataAtCell2).call(_this2, ...args);
    });
    this.addHook("afterSetDataAtCell", function() {
      for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {
        args[_key15] = arguments[_key15];
      }
      return _classPrivateMethodGet23(_this2, _onAfterSetDataAtCell, _onAfterSetDataAtCell2).call(_this2, ...args);
    });
    ...
    this.addHook("beforeCreateRow", function() {
      ...
      return _classPrivateMethodGet23(_this2, _onBeforeCreateRow, _onBeforeCreateRow2).call(_this2, ...args);
    });
    this.addHook("beforeCreateCol", function() {
      for (var _len18 = arguments.length, args = new Array(_len18), _key18 = 0; _key18 < _len18; _key18++) {
        args[_key18] = arguments[_key18];
      }
      return _classPrivateMethodGet23(_this2, _onBeforeCreateCol, _onBeforeCreateCol2).call(_this2, ...args);
    });
    this.addHook("afterCreateRow", function() {
      for (var _len19 = arguments.length, args = new Array(_len19), _key19 = 0; _key19 < _len19; _key19++) {
        args[_key19] = arguments[_key19];
      }
      return _classPrivateMethodGet23(_this2, _onAfterCreateRow, _onAfterCreateRow2).call(_this2, ...args);
    });
    this.addHook("afterCreateCol", function() {
      for (var _len20 = arguments.length, args = new Array(_len20), _key20 = 0; _key20 < _len20; _key20++) {
        args[_key20] = arguments[_key20];
      }
      return _classPrivateMethodGet23(_this2, _onAfterCreateCol, _onAfterCreateCol2).call(_this2, ...args);
    });
    this.addHook("beforeRemoveRow", function() {
      for (var _len21 = arguments.length, args = new Array(_len21), _key21 = 0; _key21 < _len21; _key21++) {
        args[_key21] = arguments[_key21];
      }
      return _classPrivateMethodGet23(_this2, _onBeforeRemoveRow, _onBeforeRemoveRow2).call(_this2, ...args);
    });
    this.addHook("beforeRemoveCol", function() {
      for (var _len22 = arguments.length, args = new Array(_len22), _key22 = 0; _key22 < _len22; _key22++) {
        args[_key22] = arguments[_key22];
      }
      return _classPrivateMethodGet23(_this2, _onBeforeRemoveCol, _onBeforeRemoveCol2).call(_this2, ...args);
    });
    this.addHook("afterRemoveRow", function() {
      for (var _len23 = arguments.length, args = new Array(_len23), _key23 = 0; _key23 < _len23; _key23++) {
        args[_key23] = arguments[_key23];
      }
      return _classPrivateMethodGet23(_this2, _onAfterRemoveRow, _onAfterRemoveRow2).call(_this2, ...args);
    });
    this.addHook("afterRemoveCol", function() {
      for (var _len24 = arguments.length, args = new Array(_len24), _key24 = 0; _key24 < _len24; _key24++) {
        args[_key24] = arguments[_key24];
      }
      return _classPrivateMethodGet23(_this2, _onAfterRemoveCol, _onAfterRemoveCol2).call(_this2, ...args);
    });
    ...
    this.addHook("afterCellMetaReset", function() {
      ...
      return _classPrivateMethodGet23(_this2, _onAfterCellMetaReset, _onAfterCellMetaReset2).call(_this2, ...args);
    });
    ...
    this.addHook("afterDetachChild", function() {
      ...
      return _classPrivateMethodGet23(_this2, _onAfterDetachChild, _onAfterDetachChild2).call(_this2, ...args);
    });
    this.addHook("beforeAutofill", function() {
      for (var _len27 = arguments.length, args = new Array(_len27), _key27 = 0; _key27 < _len27; _key27++) {
        args[_key27] = arguments[_key27];
      }
      return _classPrivateMethodGet23(_this2, _onBeforeAutofill, _onBeforeAutofill2).call(_this2, ...args);
    });
    _classPrivateFieldGet14(this, _engineListeners).forEach((_ref) => {
   ...
   */
  disablePlugin() {
    _classPrivateFieldGet14(this, _engineListeners).forEach((_ref2) => {
  ...
  updatePlugin(newSettings) {
    ...
    const pluginSettings = this.hot.getSettings()[PLUGIN_KEY15];
    ...
    if (!newSettings.data && this.sheetName === null) {
      const sheetName = this.hot.getSettings()[PLUGIN_KEY15].sheetName;
   ...
   */
  destroy() {
    _classPrivateFieldGet14(this, _engineListeners).forEach((_ref3) => {
      var _this$engine;
    ...
    _classPrivateFieldSet14(this, _engineListeners, null);
    unregisterEngine(this.engine, this.hot);
    this.engine = null;
    super.destroy();
  }
  ...
  switchSheet(sheetName) {
    ...
    if (serialized.length > 0) {
      this.hot.loadData(serialized, `${toUpperCaseFirst(PLUGIN_KEY15)}.switchSheet`);
    }
  }
  /**
...
function _onBeforeLoadData2(sourceData, initialLoad) {
  ...
  if (source.includes(toUpperCaseFirst(PLUGIN_KEY15))) {
    return;
  }
  _classPrivateFieldSet14(this, _hotWasInitializedWithEmptyData, isUndefined(this.hot.getSettings().data));
}
function _onAfterCellMetaReset2() {
  ...
  if (valueChanged === true) {
    _classPrivateFieldSet14(this, _internalOperationPending, true);
    this.engine.setSheetContent(this.sheetId, sourceDataArray);
    _classPrivateFieldSet14(this, _internalOperationPending, false);
  }
}
function _onAfterLoadData25(sourceData, initialLoad) {
  ...
  this.sheetName = setupSheet(this.engine, this.hot.getSettings()[PLUGIN_KEY15].sheetName);
  if (!_classPrivateFieldGet14(this, _hotWasInitializedWithEmptyData)) {
    const sourceDataArray = this.hot.getSourceDataArray();
...
function _onModifyData2(physicalRow, visualColumn, valueHolder, ioMode) {
  if (ioMode !== "get" || _classPrivateFieldGet14(this, _internalOperationPending) || this.sheetName === null || !this.engine.doesSheetExist(this.sheetName)) {
    return;
  }
...
var PLUGIN_KEY16 = "hiddenColumns";
var PLUGIN_PRIORITY16 = 310;
...
var HiddenColumns = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec24(this, _onMapInit);
    _classPrivateMethodInitSpec24(this, _onAfterContextMenuDefaultOptions4);
    _classPrivateMethodInitSpec24(this, _onAfterGetColHeader6);
    _classPrivateMethodInitSpec24(this, _onModifyCopyableRange);
    _classPrivateMethodInitSpec24(this, _onAfterGetCellMeta);
    _classPrivateMethodInitSpec24(this, _onModifyColWidth);
    _classPrivateFieldInitSpec15(this, _settings, {
      writable: true,
      value: {}
    });
    _classPrivateFieldInitSpec15(this, _hiddenColumnsMap, {
      writable: true,
      value: null
    });
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY16];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    const pluginSettings = this.hot.getSettings()[PLUGIN_KEY16];
    if (isObject(pluginSettings)) {
      _classPrivateFieldSet15(this, _settings, pluginSettings);
      if (isUndefined(pluginSettings.copyPasteEnabled)) {
        pluginSettings.copyPasteEnabled = true;
      }
    }
    _classPrivateFieldSet15(this, _hiddenColumnsMap, new HidingMap());
    _classPrivateFieldGet15(this, _hiddenColumnsMap).addLocalHook("init", () => _classPrivateMethodGet24(this, _onMapInit, _onMapInit2).call(this));
    this.hot.columnIndexMapper.registerMap(this.pluginName, _classPrivateFieldGet15(this, _hiddenColumnsMap));
    this.addHook("afterContextMenuDefaultOptions", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet24(_this, _onAfterContextMenuDefaultOptions4, _onAfterContextMenuDefaultOptions23).call(_this, ...args);
    });
    this.addHook("afterGetCellMeta", (row, col, cellProperties) => _classPrivateMethodGet24(this, _onAfterGetCellMeta, _onAfterGetCellMeta2).call(this, row, col, cellProperties));
    this.addHook("modifyColWidth", (width, col) => _classPrivateMethodGet24(this, _onModifyColWidth, _onModifyColWidth2).call(this, width, col));
    this.addHook("afterGetColHeader", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet24(_this, _onAfterGetColHeader6, _onAfterGetColHeader25).call(_this, ...args);
    });
    this.addHook("modifyCopyableRange", (ranges) => _classPrivateMethodGet24(this, _onModifyCopyableRange, _onModifyCopyableRange2).call(this, ranges));
    super.enablePlugin();
  }
  /**
   * Updates the plugin's state.
  ...
  disablePlugin() {
    this.hot.columnIndexMapper.unregisterMap(this.pluginName);
    _classPrivateFieldSet15(this, _settings, {});
    super.disablePlugin();
    this.resetCellsMeta();
  }
  /**
  ...
  showColumns(columns) {
    ...
    const hidingMapValues = _classPrivateFieldGet15(this, _hiddenColumnsMap).getValues().slice();
    ...
    if (isValidConfig && isAnyColumnShowed) {
      _classPrivateFieldGet15(this, _hiddenColumnsMap).setValues(hidingMapValues);
    }
    this.hot.view.adjustElementsSize();
    ...
    if (isConfigValid) {
      this.hot.batchExecution(() => {
        arrayEach(columns, (visualColumn) => {
          _classPrivateFieldGet15(this, _hiddenColumnsMap).setValueAtIndex(this.hot.toPhysicalColumn(visualColumn), true);
        });
      }, true);
    }
   ...
   */
  getHiddenColumns() {
    return arrayMap(_classPrivateFieldGet15(this, _hiddenColumnsMap).getHiddenIndexes(), (physicalColumnIndex) => {
   ...
   */
  isHidden(column) {
    return _classPrivateFieldGet15(this, _hiddenColumnsMap).getValueAtIndex(this.hot.toPhysicalColumn(column)) || false;
  }
  /**
   ...
   */
  destroy() {
    _classPrivateFieldSet15(this, _settings, null);
    _classPrivateFieldSet15(this, _hiddenColumnsMap, null);
    super.destroy();
  }
};
function _onModifyColWidth2(width, column) {
  ...
  if (_classPrivateFieldGet15(this, _settings).indicators && (this.isHidden(column + 1) || this.isHidden(column - 1))) {
...
function _onAfterGetCellMeta2(row, column, cellProperties) {
  if (_classPrivateFieldGet15(this, _settings).copyPasteEnabled === false && this.isHidden(column)) {
...
function _onModifyCopyableRange2(ranges) {
  if (_classPrivateFieldGet15(this, _settings).copyPasteEnabled) {
    return ranges;
  }
  const newRanges = [];
...
function _onAfterGetColHeader25(column, TH) {
  if (!_classPrivateFieldGet15(this, _settings).indicators || column < 0) {
    return;
  }
  const classList = [];
...
function _onMapInit2() {
  if (Array.isArray(_classPrivateFieldGet15(this, _settings).columns)) {
    this.hideColumns(_classPrivateFieldGet15(this, _settings).columns);
  }
}
...
function _classPrivateMethodInitSpec25(obj, privateSet) {
  _checkPrivateRedeclaration29(obj, privateSet);
  privateSet.add(obj);
}
...
var PLUGIN_KEY17 = "hiddenRows";
var PLUGIN_PRIORITY17 = 320;
...
var HiddenRows = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec25(this, _onMapInit3);
    _classPrivateMethodInitSpec25(this, _onAfterContextMenuDefaultOptions5);
    _classPrivateMethodInitSpec25(this, _onAfterGetRowHeader);
    _classPrivateMethodInitSpec25(this, _onModifyCopyableRange3);
    _classPrivateMethodInitSpec25(this, _onAfterGetCellMeta3);
    _classPrivateMethodInitSpec25(this, _onModifyRowHeight);
    _classPrivateFieldInitSpec16(this, _settings2, {
      writable: true,
      value: {}
    });
    _classPrivateFieldInitSpec16(this, _hiddenRowsMap, {
      writable: true,
      value: null
    });
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY17];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    if (isObject(pluginSettings)) {
      _classPrivateFieldSet16(this, _settings2, pluginSettings);
      if (isUndefined(pluginSettings.copyPasteEnabled)) {
        pluginSettings.copyPasteEnabled = true;
      }
    }
    _classPrivateFieldSet16(this, _hiddenRowsMap, new HidingMap());
    _classPrivateFieldGet16(this, _hiddenRowsMap).addLocalHook("init", () => _classPrivateMethodGet25(this, _onMapInit3, _onMapInit22).call(this));
    this.hot.rowIndexMapper.registerMap(this.pluginName, _classPrivateFieldGet16(this, _hiddenRowsMap));
    this.addHook("afterContextMenuDefaultOptions", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet25(_this, _onAfterContextMenuDefaultOptions5, _onAfterContextMenuDefaultOptions24).call(_this, ...args);
    });
    this.addHook("afterGetCellMeta", (row, col, cellProperties) => _classPrivateMethodGet25(this, _onAfterGetCellMeta3, _onAfterGetCellMeta22).call(this, row, col, cellProperties));
    this.addHook("modifyRowHeight", (height, row) => _classPrivateMethodGet25(this, _onModifyRowHeight, _onModifyRowHeight2).call(this, height, row));
    this.addHook("afterGetRowHeader", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet25(_this, _onAfterGetRowHeader, _onAfterGetRowHeader2).call(_this, ...args);
    });
    this.addHook("modifyCopyableRange", (ranges) => _classPrivateMethodGet25(this, _onModifyCopyableRange3, _onModifyCopyableRange22).call(this, ranges));
    super.enablePlugin();
  }
  /**
   * Updates the plugin's state.
  ...
  disablePlugin() {
    this.hot.rowIndexMapper.unregisterMap(this.pluginName);
    _classPrivateFieldSet16(this, _settings2, {});
    super.disablePlugin();
    this.resetCellsMeta();
  }
  /**
  ...
  showRows(rows) {
    ...
    let destinationHideConfig = currentHideConfig;
    const hidingMapValues = _classPrivateFieldGet16(this, _hiddenRowsMap).getValues().slice();
    ...
    if (isValidConfig && isAnyRowShowed) {
      _classPrivateFieldGet16(this, _hiddenRowsMap).setValues(hidingMapValues);
    }
    ...
    if (isConfigValid) {
      this.hot.batchExecution(() => {
        arrayEach(rows, (visualRow) => {
          _classPrivateFieldGet16(this, _hiddenRowsMap).setValueAtIndex(this.hot.toPhysicalRow(visualRow), true);
        });
      }, true);
    }
   ...
   */
  getHiddenRows() {
    return arrayMap(_classPrivateFieldGet16(this, _hiddenRowsMap).getHiddenIndexes(), (physicalRowIndex) => {
   ...
   */
  isHidden(row) {
    return _classPrivateFieldGet16(this, _hiddenRowsMap).getValueAtIndex(this.hot.toPhysicalRow(row)) || false;
  }
  /**
   ...
   */
  destroy() {
    _classPrivateFieldSet16(this, _settings2, null);
    _classPrivateFieldSet16(this, _hiddenRowsMap, null);
    super.destroy();
  }
};
...
function _onAfterGetCellMeta22(row, column, cellProperties) {
  if (_classPrivateFieldGet16(this, _settings2).copyPasteEnabled === false && this.isHidden(row)) {
...
function _onModifyCopyableRange22(ranges) {
  if (_classPrivateFieldGet16(this, _settings2).copyPasteEnabled) {
    return ranges;
  }
  const newRanges = [];
  const pushRange = (startRow, endRow, startCol, endCol) => {
...
function _onAfterGetRowHeader2(row, TH) {
  if (!_classPrivateFieldGet16(this, _settings2).indicators || row < 0) {
    return;
  }
  const classList = [];
...
function _onMapInit22() {
  if (Array.isArray(_classPrivateFieldGet16(this, _settings2).rows)) {
    this.hideRows(_classPrivateFieldGet16(this, _settings2).rows);
  }
}
...
function _classPrivateMethodInitSpec26(obj, privateSet) {
  _checkPrivateRedeclaration30(obj, privateSet);
  privateSet.add(obj);
}
...
var PLUGIN_KEY18 = "manualColumnFreeze";
var PLUGIN_PRIORITY18 = 110;
...
var ManualColumnFreeze = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec26(this, _onBeforeColumnMove);
    _classPrivateMethodInitSpec26(this, _addContextMenuEntry);
    _classPrivateFieldInitSpec17(this, _afterFirstUse, {
      writable: true,
      value: false
    });
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterContextMenuDefaultOptions", (options) => _classPrivateMethodGet26(this, _addContextMenuEntry, _addContextMenuEntry2).call(this, options));
    this.addHook("beforeColumnMove", (columns, finalIndex) => _classPrivateMethodGet26(this, _onBeforeColumnMove, _onBeforeColumnMove2).call(this, columns, finalIndex));
    super.enablePlugin();
  }
  /**
   * Disables the plugin functionality for this Handsontable instance.
   */
  disablePlugin() {
    _classPrivateFieldSet17(this, _afterFirstUse, false);
    super.disablePlugin();
  }
  /**
   * Updates the plugin's state.
  ...
  freezeColumn(column) {
    ...
    if (!_classPrivateFieldGet17(this, _afterFirstUse)) {
      _classPrivateFieldSet17(this, _afterFirstUse, true);
    }
...
var BaseUI2 = class {
  constructor(hotInstance) {
    _defineProperty32(this, "hot", void 0);
    _defineProperty32(this, "_element", null);
    _defineProperty32(this, "state", STATE_INITIALIZED);
    _defineProperty32(this, "inlineProperty", void 0);
    this.hot = hotInstance;
...
var PLUGIN_KEY19 = "manualColumnMove";
var PLUGIN_PRIORITY19 = 120;
...
var ManualColumnMove = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec27(this, _onAfterLoadData7);
    _classPrivateMethodInitSpec27(this, _onAfterScrollVertically);
    _classPrivateMethodInitSpec27(this, _onMouseUp4);
    _classPrivateMethodInitSpec27(this, _onBeforeOnCellMouseOver);
    _classPrivateMethodInitSpec27(this, _onMouseMove3);
    _classPrivateMethodInitSpec27(this, _onBeforeOnCellMouseDown4);
    _classPrivateFieldInitSpec18(this, _backlight, {
      writable: true,
      value: new backlight_default(this.hot)
    });
    _classPrivateFieldInitSpec18(this, _guideline, {
      writable: true,
      value: new guideline_default(this.hot)
    });
    _classPrivateFieldInitSpec18(this, _columnsToMove, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec18(this, _countCols, {
      writable: true,
      value: 0
    });
    _classPrivateFieldInitSpec18(this, _pressed, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec18(this, _target, {
      writable: true,
      value: {}
    });
    _classPrivateFieldInitSpec18(this, _cachedDropIndex, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec18(this, _hoveredColumn, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec18(this, _rootElementOffset, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec18(this, _hasRowHeaders, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec18(this, _fixedColumnsStart, {
      writable: true,
      value: void 0
    });
  }
  ...
  enablePlugin() {
    ...
    this.addHook("beforeOnCellMouseDown", function() {
      ...
      return _classPrivateMethodGet27(_this, _onBeforeOnCellMouseDown4, _onBeforeOnCellMouseDown23).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseOver", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet27(_this, _onBeforeOnCellMouseOver, _onBeforeOnCellMouseOver2).call(_this, ...args);
    });
    this.addHook("afterScrollVertically", () => _classPrivateMethodGet27(this, _onAfterScrollVertically, _onAfterScrollVertically2).call(this));
    this.addHook("afterLoadData", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _classPrivateMethodGet27(_this, _onAfterLoadData7, _onAfterLoadData26).call(_this, ...args);
    });
    this.buildPluginUI();
    this.registerEvents();
  ...
  disablePlugin() {
    ...
    this.unregisterEvents();
    _classPrivateFieldGet18(this, _backlight).destroy();
    _classPrivateFieldGet18(this, _guideline).destroy();
    super.disablePlugin();
  }
  /**
  ...
  moveColumns(columns, finalIndex) {
    const dropIndex = _classPrivateFieldGet18(this, _cachedDropIndex);
    ...
    _classPrivateFieldSet18(this, _cachedDropIndex, void 0);
  ...
  dragColumns(columns, dropIndex) {
    ...
    _classPrivateFieldSet18(this, _cachedDropIndex, dropIndex);
  ...
  refreshPositions() {
    ...
    if (this.isFixedColumnsStart(_classPrivateFieldGet18(this, _hoveredColumn)) && firstVisible > 0) {
    ...
    let tdOffsetStart = this.hot.view.THEAD.offsetLeft + this.getColumnsWidth(0, _classPrivateFieldGet18(this, _hoveredColumn) - 1);
    const hiderWidth = wtTable.hider.offsetWidth;
    const tbodyOffsetLeft = wtTable.TBODY.offsetLeft;
    const backlightElemMarginStart = _classPrivateFieldGet18(this, _backlight).getOffset().start;
    const backlightElemWidth = _classPrivateFieldGet18(this, _backlight).getSize().width;
    let rowHeaderWidth = 0;
    let mouseOffsetStart = 0;
    if (this.hot.isRtl()) {
      const rootWindow = this.hot.rootWindow;
      const containerWidth = outerWidth(this.hot.rootElement);
      const gridMostRightPos = rootWindow.innerWidth - _classPrivateFieldGet18(this, _rootElementOffset) - containerWidth;
      mouseOffsetStart = rootWindow.innerWidth - _classPrivateFieldGet18(this, _target).eventPageX - gridMostRightPos - (scrollableElement.scrollX === void 0 ? scrollStart : 0);
    } else {
      mouseOffsetStart = _classPrivateFieldGet18(this, _target).eventPageX - (_classPrivateFieldGet18(this, _rootElementOffset) - (scrollableElement.scrollX === void 0 ? scrollStart : 0));
    }
    if (_classPrivateFieldGet18(this, _hasRowHeaders)) {
      rowHeaderWidth = this.hot.view._wt.wtOverlays.inlineStartOverlay.clone.wtTable.getColumnHeader(-1).offsetWidth;
    }
    if (this.isFixedColumnsStart(_classPrivateFieldGet18(this, _hoveredColumn))) {
      tdOffsetStart += scrollStart;
    }
    tdOffsetStart += rowHeaderWidth;
    if (_classPrivateFieldGet18(this, _hoveredColumn) < 0) {
      if (_classPrivateFieldGet18(this, _fixedColumnsStart) > 0) {
        _classPrivateFieldGet18(this, _target).col = 0;
      } else {
        _classPrivateFieldGet18(this, _target).col = firstVisible > 0 ? firstVisible - 1 : firstVisible;
      }
    } else if (_classPrivateFieldGet18(this, _target).TD.offsetWidth / 2 + tdOffsetStart <= mouseOffsetStart) {
      const newCoordsCol = _classPrivateFieldGet18(this, _hoveredColumn) >= _classPrivateFieldGet18(this, _countCols) ? _classPrivateFieldGet18(this, _countCols) - 1 : _classPrivateFieldGet18(this, _hoveredColumn);
      _classPrivateFieldGet18(this, _target).col = newCoordsCol + 1;
      tdOffsetStart += _classPrivateFieldGet18(this, _target).TD.offsetWidth;
    } else {
      _classPrivateFieldGet18(this, _target).col = _classPrivateFieldGet18(this, _hoveredColumn);
    }
    ...
    if (tdOffsetStart >= hiderWidth - 1) {
      ...
      guidelineStart = 1;
    } else if (scrollableElement.scrollX !== void 0 && _classPrivateFieldGet18(this, _hoveredColumn) < _classPrivateFieldGet18(this, _fixedColumnsStart)) {
      guidelineStart -= _classPrivateFieldGet18(this, _rootElementOffset) <= scrollableElement.scrollX ? _classPrivateFieldGet18(this, _rootElementOffset) : 0;
    }
    _classPrivateFieldGet18(this, _backlight).setPosition(null, backlightStart);
    _classPrivateFieldGet18(this, _guideline).setPosition(null, guidelineStart);
  }
  /**
  ...
  registerEvents() {
    ...
    this.eventManager.addEventListener(documentElement, "mousemove", (event) => _classPrivateMethodGet27(this, _onMouseMove3, _onMouseMove22).call(this, event));
    this.eventManager.addEventListener(documentElement, "mouseup", () => _classPrivateMethodGet27(this, _onMouseUp4, _onMouseUp23).call(this));
  }
  /**
   * Unbinds the events used by the plugin.
   *
   ...
   */
  buildPluginUI() {
    _classPrivateFieldGet18(this, _backlight).build();
    _classPrivateFieldGet18(this, _guideline).build();
  }
  /**
   * Destroys the plugin instance.
   */
...
function _onBeforeOnCellMouseDown23(event, coords, TD, controller) {
  ...
  if (!selection || !isHeaderSelection || _classPrivateFieldGet18(this, _pressed) || event.button !== 0 || isSortingElement) {
    _classPrivateFieldSet18(this, _pressed, false);
    _classPrivateFieldGet18(this, _columnsToMove).length = 0;
    removeClass(this.hot.rootElement, [CSS_ON_MOVING, CSS_SHOW_UI]);
    return;
  }
  const guidelineIsNotReady = _classPrivateFieldGet18(this, _guideline).isBuilt() && !_classPrivateFieldGet18(this, _guideline).isAppended();
  const backlightIsNotReady = _classPrivateFieldGet18(this, _backlight).isBuilt() && !_classPrivateFieldGet18(this, _backlight).isAppended();
  if (guidelineIsNotReady && backlightIsNotReady) {
    _classPrivateFieldGet18(this, _guideline).appendTo(wtTable.hider);
    _classPrivateFieldGet18(this, _backlight).appendTo(wtTable.hider);
  }
  const {
    from,
    to
  ...
  if (coords.row < 0 && coords.col >= start && coords.col <= end) {
    controller.column = true;
    _classPrivateFieldSet18(this, _pressed, true);
    const eventOffsetX = TD.firstChild ? offsetRelativeTo(event, TD.firstChild).x : event.offsetX;
    _classPrivateFieldGet18(this, _target).eventPageX = event.pageX;
    _classPrivateFieldSet18(this, _hoveredColumn, coords.col);
    _classPrivateFieldGet18(this, _target).TD = TD;
    _classPrivateFieldGet18(this, _target).col = coords.col;
    _classPrivateFieldSet18(this, _columnsToMove, this.prepareColumnsToMoving(start, end));
    _classPrivateFieldSet18(this, _hasRowHeaders, !!this.hot.getSettings().rowHeaders);
    _classPrivateFieldSet18(this, _countCols, this.hot.countCols());
    _classPrivateFieldSet18(this, _fixedColumnsStart, this.hot.getSettings().fixedColumnsStart);
    _classPrivateFieldSet18(this, _rootElementOffset, offset(this.hot.rootElement).left);
    const countColumnsFrom = _classPrivateFieldGet18(this, _hasRowHeaders) ? -1 : 0;
    const topPos = wtTable.holder.scrollTop + wtTable.getColumnHeaderHeight(0) + 1;
    const fixedColumnsStart = coords.col < _classPrivateFieldGet18(this, _fixedColumnsStart);
    ...
    _classPrivateFieldGet18(this, _backlight).setPosition(topPos, inlinePos);
    _classPrivateFieldGet18(this, _backlight).setSize(this.getColumnsWidth(start, end), wtTable.hider.offsetHeight - topPos);
    _classPrivateFieldGet18(this, _backlight).setOffset(null, -inlineOffset);
...
function _onMouseMove22(event) {
  if (!_classPrivateFieldGet18(this, _pressed)) {
    return;
  }
  _classPrivateFieldGet18(this, _target).eventPageX = event.pageX;
...
function _onBeforeOnCellMouseOver2(event, coords, TD, controller) {
  ...
  if (!selectedRange || !_classPrivateFieldGet18(this, _pressed)) {
    return;
  }
  if (_classPrivateFieldGet18(this, _columnsToMove).indexOf(coords.col) > -1) {
...
function _onMouseUp23() {
  const target = _classPrivateFieldGet18(this, _target).col;
  const columnsLen = _classPrivateFieldGet18(this, _columnsToMove).length;
  _classPrivateFieldSet18(this, _hoveredColumn, void 0);
  _classPrivateFieldSet18(this, _pressed, false);
  ...
  const firstMovedVisualColumn = _classPrivateFieldGet18(this, _columnsToMove)[0];
  const firstMovedPhysicalColumn = this.hot.toPhysicalColumn(firstMovedVisualColumn);
  const movePerformed = this.dragColumns(_classPrivateFieldGet18(this, _columnsToMove), target);
  _classPrivateFieldGet18(this, _columnsToMove).length = 0;
...
function _onAfterScrollVertically2() {
  ...
  _classPrivateFieldGet18(this, _backlight).setPosition(posTop);
  _classPrivateFieldGet18(this, _backlight).setSize(null, wtTable.hider.offsetHeight - posTop);
}
...
var PLUGIN_KEY20 = "manualColumnResize";
var PLUGIN_PRIORITY20 = 130;
...
var ManualColumnResize = class extends BasePlugin {
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _classPrivateMethodInitSpec28(this, _onBeforeColumnResize3);
    _classPrivateMethodInitSpec28(this, _onBeforeStretchingColumnWidth);
    _classPrivateMethodInitSpec28(this, _onModifyColWidth3);
    _classPrivateMethodInitSpec28(this, _onContextMenu);
    _classPrivateMethodInitSpec28(this, _onMouseUp5);
    _classPrivateMethodInitSpec28(this, _onMouseMove4);
    _classPrivateMethodInitSpec28(this, _onMouseDown3);
    _classPrivateMethodInitSpec28(this, _onMouseOver3);
    _classPrivateMethodInitSpec28(this, _onMapInit4);
    _classPrivateFieldInitSpec19(this, _currentTH, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _currentCol, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _selectedCols, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec19(this, _currentWidth, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _newSize, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _startY, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _startWidth, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _startOffset, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _handle, {
      writable: true,
      value: this.hot.rootDocument.createElement("DIV")
    });
    _classPrivateFieldInitSpec19(this, _guide, {
      writable: true,
      value: this.hot.rootDocument.createElement("DIV")
    });
    _classPrivateFieldInitSpec19(this, _pressed2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _isTriggeredByRMB, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec19(this, _dblclick, {
      writable: true,
      value: 0
    });
    _classPrivateFieldInitSpec19(this, _autoresizeTimeout, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec19(this, _columnWidthsMap, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec19(this, _config, {
      writable: true,
      value: void 0
    });
    addClass(_classPrivateFieldGet19(this, _handle), "manualColumnResizer");
    addClass(_classPrivateFieldGet19(this, _guide), "manualColumnResizerGuide");
  }
  /**
   * @private
   * @returns {string}
  ...
  enablePlugin() {
    ...
    _classPrivateFieldSet19(this, _columnWidthsMap, new PhysicalIndexToValueMap());
    _classPrivateFieldGet19(this, _columnWidthsMap).addLocalHook("init", () => _classPrivateMethodGet28(this, _onMapInit4, _onMapInit23).call(this));
    this.hot.columnIndexMapper.registerMap(this.pluginName, _classPrivateFieldGet19(this, _columnWidthsMap));
    this.addHook("modifyColWidth", (width, col) => _classPrivateMethodGet28(this, _onModifyColWidth3, _onModifyColWidth22).call(this, width, col));
    this.addHook("beforeStretchingColumnWidth", (stretchedWidth, column) => _classPrivateMethodGet28(this, _onBeforeStretchingColumnWidth, _onBeforeStretchingColumnWidth2).call(this, stretchedWidth, column));
    this.addHook("beforeColumnResize", (newSize, column, isDoubleClick) => _classPrivateMethodGet28(this, _onBeforeColumnResize3, _onBeforeColumnResize22).call(this, newSize, column, isDoubleClick));
    this.bindEvents();
    super.enablePlugin();
  }
  /**
   ...
   */
  disablePlugin() {
    _classPrivateFieldSet19(this, _config, _classPrivateFieldGet19(this, _columnWidthsMap).getValues());
    this.hot.columnIndexMapper.unregisterMap(this.pluginName);
    super.disablePlugin();
  }
  /**
  ...
  saveManualColumnWidths() {
    this.hot.runHooks("persistentStateSave", PERSISTENT_STATE_KEY, _classPrivateFieldGet19(this, _columnWidthsMap).getValues());
  }
  /**
  ...
  setManualSize(column, width) {
    ...
    const physicalColumn = this.hot.toPhysicalColumn(column);
    _classPrivateFieldGet19(this, _columnWidthsMap).setValueAtIndex(physicalColumn, newWidth);
    return newWidth;
  }
  /**
  ...
  clearManualSize(column) {
    const physicalColumn = this.hot.toPhysicalColumn(column);
    _classPrivateFieldGet19(this, _columnWidthsMap).setValueAtIndex(physicalColumn, null);
  }
  /**
  ...
  setupHandlePosition(TH) {
    ...
    _classPrivateFieldSet19(this, _currentTH, TH);
    const {
      _wt: wt
    } = this.hot.view;
    const cellCoords = wt.wtTable.getCoords(_classPrivateFieldGet19(this, _currentTH));
    const col = cellCoords.col;
    if (col < 0) {
      return;
    }
    const headerHeight = outerHeight(_classPrivateFieldGet19(this, _currentTH));
    const box = _classPrivateFieldGet19(this, _currentTH).getBoundingClientRect();
    const fixedColumn = col < wt.getSetting("fixedColumnsStart");
    let relativeHeaderPosition;
    if (fixedColumn) {
      relativeHeaderPosition = wt.wtOverlays.topInlineStartCornerOverlay.getRelativeCellPosition(_classPrivateFieldGet19(this, _currentTH), cellCoords.row, cellCoords.col);
    }
    if (!relativeHeaderPosition) {
      relativeHeaderPosition = wt.wtOverlays.topOverlay.getRelativeCellPosition(_classPrivateFieldGet19(this, _currentTH), cellCoords.row, cellCoords.col);
    }
    _classPrivateFieldSet19(this, _currentCol, this.hot.columnIndexMapper.getVisualFromRenderableIndex(col));
    _classPrivateFieldSet19(this, _selectedCols, []);
    ...
    if (this.hot.selection.isSelected() && isFullColumnSelected) {
      ...
      arrayEach(selectionRanges, (selectionRange) => {
        ...
        rangeEach(fromColumn, toColumn, (columnIndex) => {
          if (!_classPrivateFieldGet19(this, _selectedCols).includes(columnIndex)) {
            _classPrivateFieldGet19(this, _selectedCols).push(columnIndex);
          }
        });
      });
    }
    if (!_classPrivateFieldGet19(this, _selectedCols).includes(_classPrivateFieldGet19(this, _currentCol))) {
      _classPrivateFieldSet19(this, _selectedCols, [_classPrivateFieldGet19(this, _currentCol)]);
    }
    _classPrivateFieldSet19(this, _startOffset, relativeHeaderPosition.start - 6);
    _classPrivateFieldSet19(this, _startWidth, parseInt(box.width, 10));
    _classPrivateFieldGet19(this, _handle).style.top = `${relativeHeaderPosition.top}px`;
    _classPrivateFieldGet19(this, _handle).style[this.inlineDir] = `${_classPrivateFieldGet19(this, _startOffset) + _classPrivateFieldGet19(this, _startWidth)}px`;
    _classPrivateFieldGet19(this, _handle).style.height = `${headerHeight}px`;
    this.hot.rootElement.appendChild(_classPrivateFieldGet19(this, _handle));
  }
  /**
  ...
  refreshHandlePosition() {
    _classPrivateFieldGet19(this, _handle).style[this.inlineDir] = `${_classPrivateFieldGet19(this, _startOffset) + _classPrivateFieldGet19(this, _currentWidth)}px`;
  }
  /**
   ...
   */
  setupGuidePosition() {
    const handleHeight = parseInt(outerHeight(_classPrivateFieldGet19(this, _handle)), 10);
    const handleBottomPosition = parseInt(_classPrivateFieldGet19(this, _handle).style.top, 10) + handleHeight;
    const maximumVisibleElementHeight = parseInt(this.hot.view.maximumVisibleElementHeight(0), 10);
    addClass(_classPrivateFieldGet19(this, _handle), "active");
    addClass(_classPrivateFieldGet19(this, _guide), "active");
    _classPrivateFieldGet19(this, _guide).style.top = `${handleBottomPosition}px`;
    this.refreshGuidePosition();
    _classPrivateFieldGet19(this, _guide).style.height = `${maximumVisibleElementHeight - handleHeight}px`;
    this.hot.rootElement.appendChild(_classPrivateFieldGet19(this, _guide));
  }
  /**
  ...
  refreshGuidePosition() {
    _classPrivateFieldGet19(this, _guide).style[this.inlineDir] = _classPrivateFieldGet19(this, _handle).style[this.inlineDir];
  }
  /**
   ...
   */
  hideHandleAndGuide() {
    removeClass(_classPrivateFieldGet19(this, _handle), "active");
    removeClass(_classPrivateFieldGet19(this, _guide), "active");
  }
  /**
  ...
  afterMouseDownTimeout() {
    ...
    const resize = (column, forceRender) => {
      const hookNewSize = this.hot.runHooks("beforeColumnResize", _classPrivateFieldGet19(this, _newSize), column, true);
      if (hookNewSize !== void 0) {
        _classPrivateFieldSet19(this, _newSize, hookNewSize);
      }
      if (this.hot.getSettings().stretchH === "all") {
        this.clearManualSize(column);
      } else {
        this.setManualSize(column, _classPrivateFieldGet19(this, _newSize));
      }
      this.saveManualColumnWidths();
      this.hot.runHooks("afterColumnResize", _classPrivateFieldGet19(this, _newSize), column, true);
      if (forceRender) {
        render();
      }
    };
    if (_classPrivateFieldGet19(this, _dblclick) >= 2) {
      const selectedColsLength = _classPrivateFieldGet19(this, _selectedCols).length;
      if (selectedColsLength > 1) {
        arrayEach(_classPrivateFieldGet19(this, _selectedCols), (selectedCol) => {
          resize(selectedCol);
        });
        render();
      } else {
    ...
    _classPrivateFieldSet19(this, _dblclick, 0);
    _classPrivateFieldSet19(this, _autoresizeTimeout, null);
  }
  /**
  ...
  bindEvents() {
    ...
    this.eventManager.addEventListener(rootElement, "mouseover", (e) => _classPrivateMethodGet28(this, _onMouseOver3, _onMouseOver22).call(this, e));
    this.eventManager.addEventListener(rootElement, "mousedown", (e) => _classPrivateMethodGet28(this, _onMouseDown3, _onMouseDown22).call(this, e));
    this.eventManager.addEventListener(rootWindow, "mousemove", (e) => _classPrivateMethodGet28(this, _onMouseMove4, _onMouseMove23).call(this, e));
    this.eventManager.addEventListener(rootWindow, "mouseup", () => _classPrivateMethodGet28(this, _onMouseUp5, _onMouseUp24).call(this));
    this.eventManager.addEventListener(_classPrivateFieldGet19(this, _handle), "contextmenu", () => _classPrivateMethodGet28(this, _onContextMenu, _onContextMenu2).call(this));
  }
  /**
   * Destroys the plugin instance.
   */
...
function _onMapInit23() {
  const initialSetting = this.hot.getSettings()[PLUGIN_KEY20];
  const loadedManualColumnWidths = this.loadManualColumnWidths();
  if (typeof loadedManualColumnWidths !== "undefined") {
    this.hot.batchExecution(() => {
      loadedManualColumnWidths.forEach((width, physicalIndex) => {
        _classPrivateFieldGet19(this, _columnWidthsMap).setValueAtIndex(physicalIndex, width);
      });
    }, true);
    ...
    _classPrivateFieldSet19(this, _config, initialSetting);
  } else if (initialSetting === true && Array.isArray(_classPrivateFieldGet19(this, _config))) {
    this.hot.batchExecution(() => {
      _classPrivateFieldGet19(this, _config).forEach((width, physicalIndex) => {
        _classPrivateFieldGet19(this, _columnWidthsMap).setValueAtIndex(physicalIndex, width);
      });
    }, true);
  }
...
function _onMouseOver22(event) {
  ...
  if (_classPrivateFieldGet19(this, _isTriggeredByRMB) === true) {
    return;
  }
  if (this.checkIfColumnHeader(event.target)) {
    ...
    if (th && (colspan === null || colspan === "1")) {
      if (!_classPrivateFieldGet19(this, _pressed2)) {
...
function _onMouseDown22(event) {
  if (hasClass(event.target, "manualColumnResizer")) {
    this.setupHandlePosition(_classPrivateFieldGet19(this, _currentTH));
    this.setupGuidePosition();
    _classPrivateFieldSet19(this, _pressed2, true);
    if (_classPrivateFieldGet19(this, _autoresizeTimeout) === null) {
      _classPrivateFieldSet19(this, _autoresizeTimeout, setTimeout(() => this.afterMouseDownTimeout(), 500));
      this.hot._registerTimeout(_classPrivateFieldGet19(this, _autoresizeTimeout));
    }
    _classPrivateFieldSet19(this, _dblclick, _classPrivateFieldGet19(this, _dblclick) + 1);
    this.startX = event.pageX;
    _classPrivateFieldSet19(this, _newSize, _classPrivateFieldGet19(this, _startWidth));
  }
}
function _onMouseMove23(event) {
  if (_classPrivateFieldGet19(this, _pressed2)) {
    const change = (event.pageX - this.startX) * this.hot.getDirectionFactor();
    _classPrivateFieldSet19(this, _currentWidth, _classPrivateFieldGet19(this, _startWidth) + change);
    arrayEach(_classPrivateFieldGet19(this, _selectedCols), (selectedCol) => {
      _classPrivateFieldSet19(this, _newSize, this.setManualSize(selectedCol, _classPrivateFieldGet19(this, _currentWidth)));
    });
...
function _onMouseUp24() {
  ...
  const resize = (column, forceRender) => {
    this.hot.runHooks("beforeColumnResize", _classPrivateFieldGet19(this, _newSize), column, false);
    if (forceRender) {
      render();
    }
    this.saveManualColumnWidths();
    this.hot.runHooks("afterColumnResize", _classPrivateFieldGet19(this, _newSize), column, false);
  };
  if (_classPrivateFieldGet19(this, _pressed2)) {
    this.hideHandleAndGuide();
    _classPrivateFieldSet19(this, _pressed2, false);
    if (_classPrivateFieldGet19(this, _newSize) !== _classPrivateFieldGet19(this, _startWidth)) {
      const selectedColsLength = _classPrivateFieldGet19(this, _selectedCols).length;
      if (selectedColsLength > 1) {
        arrayEach(_classPrivateFieldGet19(this, _selectedCols), (selectedCol) => {
          resize(selectedCol);
...
function _onContextMenu2() {
  this.hideHandleAndGuide();
  this.hot.rootElement.removeChild(_classPrivateFieldGet19(this, _handle));
  this.hot.rootElement.removeChild(_classPrivateFieldGet19(this, _guide));
  _classPrivateFieldSet19(this, _pressed2, false);
  _classPrivateFieldSet19(this, _isTriggeredByRMB, true);
  this.hot._registerImmediate(() => {
    _classPrivateFieldSet19(this, _isTriggeredByRMB, false);
  });
}
function _onModifyColWidth22(width, column) {
  ...
  if (this.enabled) {
    const physicalColumn = this.hot.toPhysicalColumn(column);
    const columnWidth = _classPrivateFieldGet19(this, _columnWidthsMap).getValueAtIndex(physicalColumn);
    if (this.hot.getSettings()[PLUGIN_KEY20] && columnWidth) {
...
function _onBeforeStretchingColumnWidth2(stretchedWidth, column) {
  let width = _classPrivateFieldGet19(this, _columnWidthsMap).getValueAtIndex(column);
  if (width === null) {
...
var BaseUI3 = class {
  constructor(hotInstance) {
    ...
    _defineProperty33(this, "_element", null);
    _defineProperty33(this, "state", STATE_INITIALIZED2);
    this.hot = hotInstance;
  }
  /**
   * Add created UI elements to table.
...
var PLUGIN_KEY21 = "manualRowMove";
var PLUGIN_PRIORITY21 = 140;
...
var ManualRowMove = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec29(this, _onAfterLoadData8);
    _classPrivateMethodInitSpec29(this, _onAfterScrollHorizontally);
    _classPrivateMethodInitSpec29(this, _onMouseUp6);
    _classPrivateMethodInitSpec29(this, _onBeforeOnCellMouseOver3);
    _classPrivateMethodInitSpec29(this, _onMouseMove5);
    _classPrivateMethodInitSpec29(this, _onBeforeOnCellMouseDown5);
    _classPrivateFieldInitSpec20(this, _backlight2, {
      writable: true,
      value: new backlight_default2(this.hot)
    });
    _classPrivateFieldInitSpec20(this, _guideline2, {
      writable: true,
      value: new guideline_default2(this.hot)
    });
    _classPrivateFieldInitSpec20(this, _rowsToMove, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec20(this, _pressed3, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec20(this, _target2, {
      writable: true,
      value: {}
    });
    _classPrivateFieldInitSpec20(this, _cachedDropIndex2, {
      writable: true,
      value: void 0
    });
  }
  ...
  enablePlugin() {
    ...
    this.addHook("beforeOnCellMouseDown", function() {
      ...
      return _classPrivateMethodGet29(_this, _onBeforeOnCellMouseDown5, _onBeforeOnCellMouseDown24).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseOver", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet29(_this, _onBeforeOnCellMouseOver3, _onBeforeOnCellMouseOver22).call(_this, ...args);
    });
    this.addHook("afterScrollHorizontally", () => _classPrivateMethodGet29(this, _onAfterScrollHorizontally, _onAfterScrollHorizontally2).call(this));
    this.addHook("afterLoadData", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _classPrivateMethodGet29(_this, _onAfterLoadData8, _onAfterLoadData27).call(_this, ...args);
    });
    this.buildPluginUI();
    this.registerEvents();
  ...
  disablePlugin() {
    ...
    this.unregisterEvents();
    _classPrivateFieldGet20(this, _backlight2).destroy();
    _classPrivateFieldGet20(this, _guideline2).destroy();
    super.disablePlugin();
  }
  /**
   * Moves a single row.
  ...
  moveRows(rows, finalIndex) {
    const dropIndex = _classPrivateFieldGet20(this, _cachedDropIndex2);
    ...
    _classPrivateFieldSet20(this, _cachedDropIndex2, void 0);
    if (beforeMoveHook === false) {
      return;
    }
    if (movePossible) {
  ...
  dragRows(rows, dropIndex) {
    ...
    _classPrivateFieldSet20(this, _cachedDropIndex2, dropIndex);
   ...
   */
  refreshPositions() {
    const coords = _classPrivateFieldGet20(this, _target2).coords;
    ...
    const wtTable = this.hot.view._wt.wtTable;
    const TD = _classPrivateFieldGet20(this, _target2).TD;
    ...
    const pixelsRelToTableStart = _classPrivateFieldGet20(this, _target2).eventPageY - pixelsAbove + tableScroll;
    const hiderHeight = wtTable.hider.offsetHeight;
    const tbodyOffsetTop = wtTable.TBODY.offsetTop;
    const backlightElemMarginTop = _classPrivateFieldGet20(this, _backlight2).getOffset().top;
    const backlightElemHeight = _classPrivateFieldGet20(this, _backlight2).getSize().height;
    ...
    if (coords.row < 0) {
      _classPrivateFieldGet20(this, _target2).row = firstVisible > 0 ? firstVisible - 1 : firstVisible;
    } else if (isBelowTable) {
      _classPrivateFieldGet20(this, _target2).row = coords.row + 1;
      tdStartPixel += coords.row === 0 ? tdHeight - 1 : tdHeight;
    } else {
      _classPrivateFieldGet20(this, _target2).row = coords.row;
    }
    ...
    _classPrivateFieldGet20(this, _backlight2).setPosition(backlightTop);
    _classPrivateFieldGet20(this, _guideline2).setPosition(guidelineTop);
  }
  /**
   * Binds the events used by the plugin.
   *
  ...
  registerEvents() {
    ...
    this.eventManager.addEventListener(documentElement, "mousemove", (event) => _classPrivateMethodGet29(this, _onMouseMove5, _onMouseMove24).call(this, event));
    this.eventManager.addEventListener(documentElement, "mouseup", () => _classPrivateMethodGet29(this, _onMouseUp6, _onMouseUp25).call(this));
  }
  /**
   * Unbinds the events used by the plugin.
   *
   ...
   */
  buildPluginUI() {
    _classPrivateFieldGet20(this, _backlight2).build();
    _classPrivateFieldGet20(this, _guideline2).build();
  }
  /**
   * Destroys the plugin instance.
   */
...
function _onBeforeOnCellMouseDown24(event, coords, TD, controller) {
  ...
  const selection = this.hot.getSelectedRangeLast();
  if (!selection || !isHeaderSelection || _classPrivateFieldGet20(this, _pressed3) || event.button !== 0) {
    _classPrivateFieldSet20(this, _pressed3, false);
    _classPrivateFieldGet20(this, _rowsToMove).length = 0;
    removeClass(this.hot.rootElement, [CSS_ON_MOVING2, CSS_SHOW_UI2]);
    return;
  }
  const guidelineIsNotReady = _classPrivateFieldGet20(this, _guideline2).isBuilt() && !_classPrivateFieldGet20(this, _guideline2).isAppended();
  const backlightIsNotReady = _classPrivateFieldGet20(this, _backlight2).isBuilt() && !_classPrivateFieldGet20(this, _backlight2).isAppended();
  if (guidelineIsNotReady && backlightIsNotReady) {
    _classPrivateFieldGet20(this, _guideline2).appendTo(wtTable.hider);
    _classPrivateFieldGet20(this, _backlight2).appendTo(wtTable.hider);
  }
  const {
    from,
    to
  ...
  if (coords.col < 0 && coords.row >= start && coords.row <= end) {
    controller.row = true;
    _classPrivateFieldSet20(this, _pressed3, true);
    _classPrivateFieldGet20(this, _target2).eventPageY = event.pageY;
    _classPrivateFieldGet20(this, _target2).coords = coords;
    _classPrivateFieldGet20(this, _target2).TD = TD;
    _classPrivateFieldSet20(this, _rowsToMove, this.prepareRowsToMoving());
    ...
    _classPrivateFieldGet20(this, _backlight2).setPosition(null, leftPos);
    _classPrivateFieldGet20(this, _backlight2).setSize(wtTable.hider.offsetWidth - leftPos, this.getRowsHeight(start, end));
    _classPrivateFieldGet20(this, _backlight2).setOffset(-topOffset, null);
...
function _onMouseMove24(event) {
  if (!_classPrivateFieldGet20(this, _pressed3)) {
    return;
  }
  _classPrivateFieldGet20(this, _target2).eventPageY = event.pageY;
  this.refreshPositions();
...
function _onBeforeOnCellMouseOver22(event, coords, TD, controller) {
  const selectedRange = this.hot.getSelectedRangeLast();
  if (!selectedRange || !_classPrivateFieldGet20(this, _pressed3)) {
    return;
  }
  if (_classPrivateFieldGet20(this, _rowsToMove).indexOf(coords.row) > -1) {
...
function _onMouseUp25() {
  const target = _classPrivateFieldGet20(this, _target2).row;
  const rowsLen = _classPrivateFieldGet20(this, _rowsToMove).length;
  _classPrivateFieldSet20(this, _pressed3, false);
  ...
  const firstMovedVisualRow = _classPrivateFieldGet20(this, _rowsToMove)[0];
  const firstMovedPhysicalRow = this.hot.toPhysicalRow(firstMovedVisualRow);
  const movePerformed = this.dragRows(_classPrivateFieldGet20(this, _rowsToMove), target);
  _classPrivateFieldGet20(this, _rowsToMove).length = 0;
  if (movePerformed === true) {
    this.persistentStateSave();
    this.hot.render();
...
function _onAfterScrollHorizontally2() {
  ...
  _classPrivateFieldGet20(this, _backlight2).setPosition(null, posLeft);
  _classPrivateFieldGet20(this, _backlight2).setSize(wtTable.hider.offsetWidth - posLeft);
}
...
var PLUGIN_KEY22 = "manualRowResize";
var PLUGIN_PRIORITY22 = 30;
...
var ManualRowResize = class extends BasePlugin {
  ...
  constructor(hotInstance) {
    super(hotInstance);
    _classPrivateMethodInitSpec30(this, _onMapInit5);
    _classPrivateMethodInitSpec30(this, _onModifyRowHeight3);
    _classPrivateMethodInitSpec30(this, _onContextMenu3);
    _classPrivateMethodInitSpec30(this, _onMouseUp7);
    _classPrivateMethodInitSpec30(this, _onMouseMove6);
    _classPrivateMethodInitSpec30(this, _onMouseDown4);
    _classPrivateMethodInitSpec30(this, _onMouseOver4);
    _classPrivateFieldInitSpec21(this, _currentTH2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _currentRow, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _selectedRows, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec21(this, _currentHeight, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _newSize2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _startY2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _startHeight, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _startOffset2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _handle2, {
      writable: true,
      value: this.hot.rootDocument.createElement("DIV")
    });
    _classPrivateFieldInitSpec21(this, _guide2, {
      writable: true,
      value: this.hot.rootDocument.createElement("DIV")
    });
    _classPrivateFieldInitSpec21(this, _pressed4, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec21(this, _isTriggeredByRMB2, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec21(this, _dblclick2, {
      writable: true,
      value: 0
    });
    _classPrivateFieldInitSpec21(this, _autoresizeTimeout2, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec21(this, _rowHeightsMap, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec21(this, _config2, {
      writable: true,
      value: void 0
    });
    addClass(_classPrivateFieldGet21(this, _handle2), "manualRowResizer");
    addClass(_classPrivateFieldGet21(this, _guide2), "manualRowResizerGuide");
  }
  /**
   * @private
   * @returns {string}
  ...
  enablePlugin() {
    ...
    _classPrivateFieldSet21(this, _rowHeightsMap, new PhysicalIndexToValueMap());
    _classPrivateFieldGet21(this, _rowHeightsMap).addLocalHook("init", () => _classPrivateMethodGet30(this, _onMapInit5, _onMapInit24).call(this));
    this.hot.rowIndexMapper.registerMap(this.pluginName, _classPrivateFieldGet21(this, _rowHeightsMap));
    this.addHook("modifyRowHeight", (height, row) => _classPrivateMethodGet30(this, _onModifyRowHeight3, _onModifyRowHeight22).call(this, height, row));
    this.bindEvents();
    super.enablePlugin();
  }
  /**
   ...
   */
  disablePlugin() {
    _classPrivateFieldSet21(this, _config2, _classPrivateFieldGet21(this, _rowHeightsMap).getValues());
    this.hot.rowIndexMapper.unregisterMap(this.pluginName);
    super.disablePlugin();
  }
  /**
  ...
  saveManualRowHeights() {
    this.hot.runHooks("persistentStateSave", PERSISTENT_STATE_KEY2, _classPrivateFieldGet21(this, _rowHeightsMap).getValues());
  }
  /**
  ...
  setManualSize(row, height) {
    ...
    _classPrivateFieldGet21(this, _rowHeightsMap).setValueAtIndex(physicalRow, newHeight);
    return newHeight;
  }
  /**
   ...
   */
  setupHandlePosition(TH) {
    _classPrivateFieldSet21(this, _currentTH2, TH);
    const {
      view
    } = this.hot;
    const {
    ...
    const cellCoords = wt.wtTable.getCoords(_classPrivateFieldGet21(this, _currentTH2));
    const row = cellCoords.row;
    if (row < 0) {
      return;
    }
    const headerWidth = outerWidth(_classPrivateFieldGet21(this, _currentTH2));
    const box = _classPrivateFieldGet21(this, _currentTH2).getBoundingClientRect();
    ...
    let relativeHeaderPosition;
    if (fixedRowTop) {
      relativeHeaderPosition = wt.wtOverlays.topInlineStartCornerOverlay.getRelativeCellPosition(_classPrivateFieldGet21(this, _currentTH2), cellCoords.row, cellCoords.col);
    } else if (fixedRowBottom) {
      relativeHeaderPosition = wt.wtOverlays.bottomInlineStartCornerOverlay.getRelativeCellPosition(_classPrivateFieldGet21(this, _currentTH2), cellCoords.row, cellCoords.col);
    }
    if (!relativeHeaderPosition) {
      relativeHeaderPosition = wt.wtOverlays.inlineStartOverlay.getRelativeCellPosition(_classPrivateFieldGet21(this, _currentTH2), cellCoords.row, cellCoords.col);
    }
    _classPrivateFieldSet21(this, _currentRow, this.hot.rowIndexMapper.getVisualFromRenderableIndex(row));
    _classPrivateFieldSet21(this, _selectedRows, []);
    ...
    if (this.hot.selection.isSelected() && isFullRowSelected) {
      ...
      arrayEach(selectionRanges, (selectionRange) => {
        ...
        rangeEach(fromRow, toRow, (rowIndex) => {
          if (!_classPrivateFieldGet21(this, _selectedRows).includes(rowIndex)) {
            _classPrivateFieldGet21(this, _selectedRows).push(rowIndex);
          }
        });
      });
    }
    if (!_classPrivateFieldGet21(this, _selectedRows).includes(_classPrivateFieldGet21(this, _currentRow))) {
      _classPrivateFieldSet21(this, _selectedRows, [_classPrivateFieldGet21(this, _currentRow)]);
    }
    _classPrivateFieldSet21(this, _startOffset2, relativeHeaderPosition.top - 6);
    _classPrivateFieldSet21(this, _startHeight, parseInt(box.height, 10));
    _classPrivateFieldGet21(this, _handle2).style.top = `${_classPrivateFieldGet21(this, _startOffset2) + _classPrivateFieldGet21(this, _startHeight)}px`;
    _classPrivateFieldGet21(this, _handle2).style[this.inlineDir] = `${relativeHeaderPosition.start}px`;
    _classPrivateFieldGet21(this, _handle2).style.width = `${headerWidth}px`;
    this.hot.rootElement.appendChild(_classPrivateFieldGet21(this, _handle2));
  }
  /**
   * Refresh the resize handle position.
   *
   ...
   */
  refreshHandlePosition() {
    _classPrivateFieldGet21(this, _handle2).style.top = `${_classPrivateFieldGet21(this, _startOffset2) + _classPrivateFieldGet21(this, _currentHeight)}px`;
  }
  /**
   * Sets the resize guide position.
   *
   ...
   */
  setupGuidePosition() {
    const handleWidth = parseInt(outerWidth(_classPrivateFieldGet21(this, _handle2)), 10);
    const handleEndPosition = parseInt(_classPrivateFieldGet21(this, _handle2).style[this.inlineDir], 10) + handleWidth;
    const maximumVisibleElementWidth = parseInt(this.hot.view.maximumVisibleElementWidth(0), 10);
    addClass(_classPrivateFieldGet21(this, _handle2), "active");
    addClass(_classPrivateFieldGet21(this, _guide2), "active");
    _classPrivateFieldGet21(this, _guide2).style.top = _classPrivateFieldGet21(this, _handle2).style.top;
    _classPrivateFieldGet21(this, _guide2).style[this.inlineDir] = `${handleEndPosition}px`;
    _classPrivateFieldGet21(this, _guide2).style.width = `${maximumVisibleElementWidth - handleWidth}px`;
    this.hot.rootElement.appendChild(_classPrivateFieldGet21(this, _guide2));
  }
  /**
   * Refresh the resize guide position.
   *
   ...
   */
  hideHandleAndGuide() {
    removeClass(_classPrivateFieldGet21(this, _handle2), "active");
    removeClass(_classPrivateFieldGet21(this, _guide2), "active");
  }
  /**
  ...
  getActualRowHeight(row) {
    ...
    if (walkontableHeight !== void 0 && _classPrivateFieldGet21(this, _newSize2) < walkontableHeight) {
      return walkontableHeight;
    }
    return _classPrivateFieldGet21(this, _newSize2);
  }
  /**
   * Auto-size row after doubleclick - callback.
   *
  ...
  afterMouseDownTimeout() {
    ...
    const resize = (row, forceRender) => {
      ...
      if (hookNewSize !== void 0) {
        _classPrivateFieldSet21(this, _newSize2, hookNewSize);
      }
      this.setManualSize(row, _classPrivateFieldGet21(this, _newSize2));
      this.hot.runHooks("afterRowResize", this.getActualRowHeight(row), row, true);
      if (forceRender) {
        render();
      }
    };
    if (_classPrivateFieldGet21(this, _dblclick2) >= 2) {
      const selectedRowsLength = _classPrivateFieldGet21(this, _selectedRows).length;
      if (selectedRowsLength > 1) {
        arrayEach(_classPrivateFieldGet21(this, _selectedRows), (selectedRow) => {
          resize(selectedRow);
        });
        render();
      } else {
    ...
    _classPrivateFieldSet21(this, _dblclick2, 0);
    _classPrivateFieldSet21(this, _autoresizeTimeout2, null);
  }
  /**
   * Binds the mouse events.
   *
  ...
  bindEvents() {
    ...
    this.eventManager.addEventListener(rootElement, "mouseover", (e) => _classPrivateMethodGet30(this, _onMouseOver4, _onMouseOver23).call(this, e));
    this.eventManager.addEventListener(rootElement, "mousedown", (e) => _classPrivateMethodGet30(this, _onMouseDown4, _onMouseDown23).call(this, e));
    this.eventManager.addEventListener(rootWindow, "mousemove", (e) => _classPrivateMethodGet30(this, _onMouseMove6, _onMouseMove25).call(this, e));
    this.eventManager.addEventListener(rootWindow, "mouseup", () => _classPrivateMethodGet30(this, _onMouseUp7, _onMouseUp26).call(this));
    this.eventManager.addEventListener(_classPrivateFieldGet21(this, _handle2), "contextmenu", () => _classPrivateMethodGet30(this, _onContextMenu3, _onContextMenu22).call(this));
  }
  /**
   * Destroys the plugin instance.
   */
...
function _onMouseOver23(event) {
  ...
  if (_classPrivateFieldGet21(this, _isTriggeredByRMB2) === true) {
    return;
  }
  if (this.checkIfRowHeader(event.target)) {
    const th = this.getClosestTHParent(event.target);
    if (th) {
      if (!_classPrivateFieldGet21(this, _pressed4)) {
        this.setupHandlePosition(th);
      }
    }
  }
...
function _onMouseDown23(event) {
  if (hasClass(event.target, "manualRowResizer")) {
    this.setupHandlePosition(_classPrivateFieldGet21(this, _currentTH2));
    this.setupGuidePosition();
    _classPrivateFieldSet21(this, _pressed4, true);
    if (_classPrivateFieldGet21(this, _autoresizeTimeout2) === null) {
      _classPrivateFieldSet21(this, _autoresizeTimeout2, setTimeout(() => this.afterMouseDownTimeout(), 500));
      this.hot._registerTimeout(_classPrivateFieldGet21(this, _autoresizeTimeout2));
    }
    _classPrivateFieldSet21(this, _dblclick2, _classPrivateFieldGet21(this, _dblclick2) + 1);
    _classPrivateFieldSet21(this, _startY2, event.pageY);
    _classPrivateFieldSet21(this, _newSize2, _classPrivateFieldGet21(this, _startHeight));
  }
}
function _onMouseMove25(event) {
  if (_classPrivateFieldGet21(this, _pressed4)) {
    _classPrivateFieldSet21(this, _currentHeight, _classPrivateFieldGet21(this, _startHeight) + (event.pageY - _classPrivateFieldGet21(this, _startY2)));
    arrayEach(_classPrivateFieldGet21(this, _selectedRows), (selectedRow) => {
      _classPrivateFieldSet21(this, _newSize2, this.setManualSize(selectedRow, _classPrivateFieldGet21(this, _currentHeight)));
    });
    this.refreshHandlePosition();
    this.refreshGuidePosition();
  }
...
function _onMouseUp26() {
  ...
  if (_classPrivateFieldGet21(this, _pressed4)) {
    this.hideHandleAndGuide();
    _classPrivateFieldSet21(this, _pressed4, false);
    if (_classPrivateFieldGet21(this, _newSize2) !== _classPrivateFieldGet21(this, _startHeight)) {
      const selectedRowsLength = _classPrivateFieldGet21(this, _selectedRows).length;
      if (selectedRowsLength > 1) {
        arrayEach(_classPrivateFieldGet21(this, _selectedRows), (selectedRow) => {
...
function _onContextMenu22() {
  this.hideHandleAndGuide();
  this.hot.rootElement.removeChild(_classPrivateFieldGet21(this, _handle2));
  this.hot.rootElement.removeChild(_classPrivateFieldGet21(this, _guide2));
  _classPrivateFieldSet21(this, _pressed4, false);
  _classPrivateFieldSet21(this, _isTriggeredByRMB2, true);
  this.hot._registerImmediate(() => {
    _classPrivateFieldSet21(this, _isTriggeredByRMB2, false);
  });
}
function _onModifyRowHeight22(height, row) {
  ...
  if (this.enabled) {
    const physicalRow = this.hot.toPhysicalRow(row);
    const rowHeight = _classPrivateFieldGet21(this, _rowHeightsMap).getValueAtIndex(physicalRow);
    if (this.hot.getSettings()[PLUGIN_KEY22] && rowHeight) {
      newHeight = rowHeight;
    }
  }
  return newHeight;
  ...
  this.hot.batchExecution(() => {
    if (typeof loadedManualRowHeights !== "undefined") {
      loadedManualRowHeights.forEach((height, index) => {
        _classPrivateFieldGet21(this, _rowHeightsMap).setValueAtIndex(index, height);
      });
    } else if (Array.isArray(initialSetting)) {
      initialSetting.forEach((height, index) => {
        _classPrivateFieldGet21(this, _rowHeightsMap).setValueAtIndex(index, height);
      });
      _classPrivateFieldSet21(this, _config2, initialSetting);
    } else if (initialSetting === true && Array.isArray(_classPrivateFieldGet21(this, _config2))) {
      _classPrivateFieldGet21(this, _config2).forEach((height, index) => {
        _classPrivateFieldGet21(this, _rowHeightsMap).setValueAtIndex(index, height);
      });
    }
  }, true);
...
var MergedCellCoords = class {
  constructor(row, column, rowspan, colspan, cellCoordsFactory, cellRangeFactory) {
    _defineProperty34(this, "row", void 0);
    _defineProperty34(this, "col", void 0);
    _defineProperty34(this, "rowspan", void 0);
    _defineProperty34(this, "colspan", void 0);
    _defineProperty34(this, "removed", false);
    _defineProperty34(this, "cellCoordsFactory", void 0);
    _defineProperty34(this, "cellRangeFactory", void 0);
    this.row = row;
    this.col = column;
...
var MergedCellsCollection = class _MergedCellsCollection {
  constructor(mergeCellsPlugin) {
    _defineProperty35(this, "plugin", void 0);
    _defineProperty35(this, "mergedCells", []);
...
var AutofillCalculations = class {
  constructor(plugin) {
    _defineProperty36(this, "plugin", void 0);
    _defineProperty36(this, "mergedCellsCollection", void 0);
    _defineProperty36(this, "currentFillData", null);
    this.plugin = plugin;
...
var SelectionCalculations = class {
  constructor(plugin) {
    _defineProperty37(this, "plugin", void 0);
    _defineProperty37(this, "hot", void 0);
    _defineProperty37(this, "fullySelectedMergedCellClassName", "fullySelectedMergedCell");
    this.plugin = plugin;
    this.hot = plugin.hot;
  }
  /**
...
var PLUGIN_KEY23 = "mergeCells";
var PLUGIN_PRIORITY23 = 150;
var SHORTCUTS_GROUP7 = PLUGIN_KEY23;
...
var MergeCells = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec31(this, _onBeforeRemoveCellClassNames);
    _classPrivateMethodInitSpec31(this, _onAfterDrawSelection);
    _classPrivateMethodInitSpec31(this, _onAfterModifyTransformStart);
    _classPrivateMethodInitSpec31(this, _onBeforeDrawAreaBorders);
    _classPrivateMethodInitSpec31(this, _onAfterChange4);
    _classPrivateMethodInitSpec31(this, _onAfterRemoveRow3);
    _classPrivateMethodInitSpec31(this, _onAfterCreateRow3);
    _classPrivateMethodInitSpec31(this, _onAfterRemoveCol3);
    _classPrivateMethodInitSpec31(this, _onAfterCreateCol3);
    _classPrivateMethodInitSpec31(this, _onModifyAutofillRange);
    _classPrivateMethodInitSpec31(this, _onAfterViewportColumnCalculatorOverride);
    _classPrivateMethodInitSpec31(this, _onAfterViewportRowCalculatorOverride);
    _classPrivateMethodInitSpec31(this, _onAfterGetCellMeta4);
    _classPrivateMethodInitSpec31(this, _onBeforeSetRangeEnd);
    _classPrivateMethodInitSpec31(this, _onBeforeSetRangeStart);
    _classPrivateMethodInitSpec31(this, _onAfterRenderer3);
    _classPrivateMethodInitSpec31(this, _addMergeActionsToContextMenu);
    _classPrivateMethodInitSpec31(this, _onModifyGetCellCoords);
    _classPrivateMethodInitSpec31(this, _onModifyTransformEnd);
    _classPrivateMethodInitSpec31(this, _onModifyTransformStart);
    _classPrivateMethodInitSpec31(this, _onAfterIsMultipleSelection);
    _classPrivateMethodInitSpec31(this, _onAfterInit5);
    _defineProperty38(this, "mergedCellsCollection", null);
    _defineProperty38(this, "autofillCalculations", null);
    _defineProperty38(this, "selectionCalculations", null);
    _classPrivateFieldInitSpec22(this, _lastDesiredCoords, {
      writable: true,
      value: null
    });
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterInit", function() {
      ...
      return _classPrivateMethodGet31(_this, _onAfterInit5, _onAfterInit24).call(_this, ...args);
    });
    this.addHook("modifyTransformStart", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet31(_this, _onModifyTransformStart, _onModifyTransformStart2).call(_this, ...args);
    });
    this.addHook("afterModifyTransformStart", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _classPrivateMethodGet31(_this, _onAfterModifyTransformStart, _onAfterModifyTransformStart2).call(_this, ...args);
    });
    this.addHook("modifyTransformEnd", function() {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return _classPrivateMethodGet31(_this, _onModifyTransformEnd, _onModifyTransformEnd2).call(_this, ...args);
    });
    this.addHook("modifyGetCellCoords", function() {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return _classPrivateMethodGet31(_this, _onModifyGetCellCoords, _onModifyGetCellCoords2).call(_this, ...args);
    });
    this.addHook("beforeSetRangeStart", function() {
      for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
        args[_key6] = arguments[_key6];
      }
      return _classPrivateMethodGet31(_this, _onBeforeSetRangeStart, _onBeforeSetRangeStart2).call(_this, ...args);
    });
    ...
    this.addHook("beforeSetRangeEnd", function() {
      ...
      return _classPrivateMethodGet31(_this, _onBeforeSetRangeEnd, _onBeforeSetRangeEnd2).call(_this, ...args);
    });
    this.addHook("afterIsMultipleSelection", function() {
      for (var _len9 = arguments.length, args = new Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
        args[_key9] = arguments[_key9];
      }
      return _classPrivateMethodGet31(_this, _onAfterIsMultipleSelection, _onAfterIsMultipleSelection2).call(_this, ...args);
    });
    this.addHook("afterRenderer", function() {
      for (var _len10 = arguments.length, args = new Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {
        args[_key10] = arguments[_key10];
      }
      return _classPrivateMethodGet31(_this, _onAfterRenderer3, _onAfterRenderer22).call(_this, ...args);
    });
    this.addHook("afterContextMenuDefaultOptions", function() {
      for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {
        args[_key11] = arguments[_key11];
      }
      return _classPrivateMethodGet31(_this, _addMergeActionsToContextMenu, _addMergeActionsToContextMenu2).call(_this, ...args);
    });
    this.addHook("afterGetCellMeta", function() {
      for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        args[_key12] = arguments[_key12];
      }
      return _classPrivateMethodGet31(_this, _onAfterGetCellMeta4, _onAfterGetCellMeta23).call(_this, ...args);
    });
    this.addHook("afterViewportRowCalculatorOverride", function() {
      for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
        args[_key13] = arguments[_key13];
      }
      return _classPrivateMethodGet31(_this, _onAfterViewportRowCalculatorOverride, _onAfterViewportRowCalculatorOverride2).call(_this, ...args);
    });
    this.addHook("afterViewportColumnCalculatorOverride", function() {
      for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {
        args[_key14] = arguments[_key14];
      }
      return _classPrivateMethodGet31(_this, _onAfterViewportColumnCalculatorOverride, _onAfterViewportColumnCalculatorOverride2).call(_this, ...args);
    });
    this.addHook("modifyAutofillRange", function() {
      for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {
        args[_key15] = arguments[_key15];
      }
      return _classPrivateMethodGet31(_this, _onModifyAutofillRange, _onModifyAutofillRange2).call(_this, ...args);
    });
    this.addHook("afterCreateCol", function() {
      for (var _len16 = arguments.length, args = new Array(_len16), _key16 = 0; _key16 < _len16; _key16++) {
        args[_key16] = arguments[_key16];
      }
      return _classPrivateMethodGet31(_this, _onAfterCreateCol3, _onAfterCreateCol22).call(_this, ...args);
    });
    this.addHook("afterRemoveCol", function() {
      for (var _len17 = arguments.length, args = new Array(_len17), _key17 = 0; _key17 < _len17; _key17++) {
        args[_key17] = arguments[_key17];
      }
      return _classPrivateMethodGet31(_this, _onAfterRemoveCol3, _onAfterRemoveCol22).call(_this, ...args);
    });
    this.addHook("afterCreateRow", function() {
      for (var _len18 = arguments.length, args = new Array(_len18), _key18 = 0; _key18 < _len18; _key18++) {
        args[_key18] = arguments[_key18];
      }
      return _classPrivateMethodGet31(_this, _onAfterCreateRow3, _onAfterCreateRow22).call(_this, ...args);
    });
    this.addHook("afterRemoveRow", function() {
      for (var _len19 = arguments.length, args = new Array(_len19), _key19 = 0; _key19 < _len19; _key19++) {
        args[_key19] = arguments[_key19];
      }
      return _classPrivateMethodGet31(_this, _onAfterRemoveRow3, _onAfterRemoveRow22).call(_this, ...args);
    });
    this.addHook("afterChange", function() {
      for (var _len20 = arguments.length, args = new Array(_len20), _key20 = 0; _key20 < _len20; _key20++) {
        args[_key20] = arguments[_key20];
      }
      return _classPrivateMethodGet31(_this, _onAfterChange4, _onAfterChange23).call(_this, ...args);
    });
    this.addHook("beforeDrawBorders", function() {
      for (var _len21 = arguments.length, args = new Array(_len21), _key21 = 0; _key21 < _len21; _key21++) {
        args[_key21] = arguments[_key21];
      }
      return _classPrivateMethodGet31(_this, _onBeforeDrawAreaBorders, _onBeforeDrawAreaBorders2).call(_this, ...args);
    });
    this.addHook("afterDrawSelection", function() {
      for (var _len22 = arguments.length, args = new Array(_len22), _key22 = 0; _key22 < _len22; _key22++) {
        args[_key22] = arguments[_key22];
      }
      return _classPrivateMethodGet31(_this, _onAfterDrawSelection, _onAfterDrawSelection2).call(_this, ...args);
    });
    this.addHook("beforeRemoveCellClassNames", function() {
      for (var _len23 = arguments.length, args = new Array(_len23), _key23 = 0; _key23 < _len23; _key23++) {
        args[_key23] = arguments[_key23];
      }
      return _classPrivateMethodGet31(_this, _onBeforeRemoveCellClassNames, _onBeforeRemoveCellClassNames2).call(_this, ...args);
    });
   ...
   */
  updatePlugin() {
    const settings = this.hot.getSettings()[PLUGIN_KEY23];
    this.disablePlugin();
    this.enablePlugin();
  ...
  unregisterShortcuts() {
    const shortcutManager = this.hot.getShortcutManager();
    const gridContext = shortcutManager.getContext("grid");
    gridContext.removeShortcutsByGroup(SHORTCUTS_GROUP7);
  }
  /**
...
function _onAfterInit24() {
  this.generateFromSettings(this.hot.getSettings()[PLUGIN_KEY23]);
  this.hot.render();
}
...
function _onModifyTransformStart2(delta) {
  ...
  if (!_classPrivateFieldGet22(this, _lastDesiredCoords)) {
    _classPrivateFieldSet22(this, _lastDesiredCoords, this.hot._createCellCoords(null, null));
  }
  if (mergedParent) {
    ...
    if (!mergeRange.includes(_classPrivateFieldGet22(this, _lastDesiredCoords))) {
      _classPrivateFieldSet22(this, _lastDesiredCoords, this.hot._createCellCoords(null, null));
    }
    newDelta.row = _classPrivateFieldGet22(this, _lastDesiredCoords).row ? _classPrivateFieldGet22(this, _lastDesiredCoords).row - currentPosition.row : newDelta.row;
    newDelta.col = _classPrivateFieldGet22(this, _lastDesiredCoords).col ? _classPrivateFieldGet22(this, _lastDesiredCoords).col - currentPosition.col : newDelta.col;
    if (delta.row > 0) {
  ...
  if (nextPositionMergedCell) {
    ...
    _classPrivateFieldSet22(this, _lastDesiredCoords, nextPosition);
    newDelta = {
...
var PLUGIN_KEY24 = "multiColumnSorting";
var PLUGIN_PRIORITY24 = 170;
var CONFLICTED_PLUGIN_KEY = "columnSorting";
var SHORTCUTS_GROUP8 = PLUGIN_KEY24;
registerRootComparator(PLUGIN_KEY24, rootComparator2);
var MultiColumnSorting = class extends ColumnSorting {
  constructor() {
    super(...arguments);
    _defineProperty39(this, "pluginKey", PLUGIN_KEY24);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY24;
  }
...
var PLUGIN_KEY25 = "multipleSelectionHandles";
var PLUGIN_PRIORITY25 = 160;
var MultipleSelectionHandles = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _defineProperty40(this, "dragged", []);
    _defineProperty40(this, "lastSetCell", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY25;
  }
...
var SourceSettings = class {
  constructor() {
    _classPrivateFieldInitSpec23(this, _data, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec23(this, _dataLength, {
      writable: true,
      value: 0
    });
    _classPrivateFieldInitSpec23(this, _columnsLimit2, {
      writable: true,
      value: Infinity
    });
  }
  ...
  setColumnsLimit(columnsCount) {
    _classPrivateFieldSet23(this, _columnsLimit2, columnsCount);
  }
  /**
  ...
  setData() {
    ...
    _classPrivateFieldSet23(this, _data, normalizeSettings(nestedHeadersSettings, _classPrivateFieldGet23(this, _columnsLimit2)));
    _classPrivateFieldSet23(this, _dataLength, _classPrivateFieldGet23(this, _data).length);
  }
  /**
   ...
   */
  getData() {
    return _classPrivateFieldGet23(this, _data);
  }
  /**
   ...
   */
  map(callback) {
    arrayEach(_classPrivateFieldGet23(this, _data), (header) => {
  ...
  getHeaderSettings(headerLevel, columnIndex) {
    ...
    if (headerLevel >= _classPrivateFieldGet23(this, _dataLength) || headerLevel < 0) {
      return null;
    }
    const headersSettings = _classPrivateFieldGet23(this, _data)[headerLevel];
   ...
   */
  getLayersCount() {
    return _classPrivateFieldGet23(this, _dataLength);
  }
  /**
   ...
   */
  getColumnsCount() {
    return _classPrivateFieldGet23(this, _dataLength) > 0 ? _classPrivateFieldGet23(this, _data)[0].length : 0;
  }
  /**
   * Clears the data.
   */
  clear() {
    _classPrivateFieldSet23(this, _data, []);
    _classPrivateFieldSet23(this, _dataLength, 0);
  }
};
...
var TreeNode = class _TreeNode {
  constructor(data) {
    _defineProperty41(this, "data", {});
    _defineProperty41(this, "parent", null);
    _defineProperty41(this, "childs", []);
    this.data = data;
  }
  /**
...
var HeadersTree = class {
  constructor(sourceSettings) {
    _classPrivateFieldInitSpec24(this, _rootNodes, {
      writable: true,
      value: /* @__PURE__ */ new Map()
    });
    _classPrivateFieldInitSpec24(this, _rootsIndex, {
      writable: true,
      value: /* @__PURE__ */ new Map()
    });
    _classPrivateFieldInitSpec24(this, _sourceSettings, {
      writable: true,
      value: null
    });
    _classPrivateFieldSet24(this, _sourceSettings, sourceSettings);
  }
  /**
   ...
   */
  getRoots() {
    return Array.from(_classPrivateFieldGet24(this, _rootNodes).values());
  }
  /**
  ...
  getRootByColumn(columnIndex) {
    let node;
    if (_classPrivateFieldGet24(this, _rootsIndex).has(columnIndex)) {
      node = _classPrivateFieldGet24(this, _rootNodes).get(_classPrivateFieldGet24(this, _rootsIndex).get(columnIndex));
    }
    return node;
  }
  /**
  ...
  getNode(headerLevel, columnIndex) {
    ...
    const normColumnIndex = columnIndex - _classPrivateFieldGet24(this, _rootsIndex).get(columnIndex);
    let columnCursor = 0;
    let treeNode;
  ...
  rebuildTreeIndex() {
    let columnIndex = 0;
    _classPrivateFieldGet24(this, _rootsIndex).clear();
    arrayEach(_classPrivateFieldGet24(this, _rootNodes), (_ref) => {
      let [, {
        data: {
          colspan
        }
      ...
      for (let i = columnIndex; i < columnIndex + colspan; i++) {
        _classPrivateFieldGet24(this, _rootsIndex).set(i, columnIndex);
      }
      columnIndex += colspan;
    });
  }
  ...
  buildTree() {
    this.clear();
    const columnsCount = _classPrivateFieldGet24(this, _sourceSettings).getColumnsCount();
    let columnIndex = 0;
    while (columnIndex < columnsCount) {
      const columnSettings = _classPrivateFieldGet24(this, _sourceSettings).getHeaderSettings(0, columnIndex);
      const rootNode = new TreeNode();
      _classPrivateFieldGet24(this, _rootNodes).set(columnIndex, rootNode);
  ...
  buildLeaves(parentNode, columnIndex, headerLevel) {
    ...
    const columnsSettings = _classPrivateFieldGet24(this, _sourceSettings).getHeadersSettings(headerLevel, columnIndex, extractionLength);
    headerLevel += 1;
    arrayEach(columnsSettings, (columnSettings) => {
      ...
      if (headerLevel < _classPrivateFieldGet24(this, _sourceSettings).getLayersCount()) {
   ...
   */
  clear() {
    _classPrivateFieldGet24(this, _rootNodes).clear();
    _classPrivateFieldGet24(this, _rootsIndex).clear();
  }
};
...
var StateManager = class {
  constructor() {
    _classPrivateFieldInitSpec25(this, _sourceSettings2, {
      writable: true,
      value: new SourceSettings()
    });
    _classPrivateFieldInitSpec25(this, _headersTree, {
      writable: true,
      value: new HeadersTree(_classPrivateFieldGet25(this, _sourceSettings2))
    });
    _classPrivateFieldInitSpec25(this, _stateMatrix, {
      writable: true,
      value: [[]]
    });
  }
  ...
  setState(nestedHeadersSettings) {
    _classPrivateFieldGet25(this, _sourceSettings2).setData(nestedHeadersSettings);
    let hasError = false;
    try {
      _classPrivateFieldGet25(this, _headersTree).buildTree();
    } catch (ex) {
      _classPrivateFieldGet25(this, _headersTree).clear();
      _classPrivateFieldGet25(this, _sourceSettings2).clear();
      hasError = true;
    }
    _classPrivateFieldSet25(this, _stateMatrix, generateMatrix(_classPrivateFieldGet25(this, _headersTree).getRoots()));
    return hasError;
  }
  /**
   ...
   */
  setColumnsLimit(columnsCount) {
    _classPrivateFieldGet25(this, _sourceSettings2).setColumnsLimit(columnsCount);
  }
  /**
  ...
  mergeStateWith(settings) {
    ...
    _classPrivateFieldGet25(this, _sourceSettings2).mergeWith(transformedSettings);
    _classPrivateFieldGet25(this, _headersTree).buildTree();
    _classPrivateFieldSet25(this, _stateMatrix, generateMatrix(_classPrivateFieldGet25(this, _headersTree).getRoots()));
  }
  /**
   ...
   */
  mapState(callback) {
    _classPrivateFieldGet25(this, _sourceSettings2).map(callback);
    _classPrivateFieldGet25(this, _headersTree).buildTree();
    _classPrivateFieldSet25(this, _stateMatrix, generateMatrix(_classPrivateFieldGet25(this, _headersTree).getRoots()));
  }
  /**
   ...
   */
  mapNodes(callback) {
    return arrayReduce(_classPrivateFieldGet25(this, _headersTree).getRoots(), (acc, rootNode) => {
      rootNode.walkDown((node) => {
  ...
  triggerNodeModification(action, headerLevel, columnIndex) {
    ...
    const nodeToProcess = _classPrivateFieldGet25(this, _headersTree).getNode(headerLevel, columnIndex);
    let actionResult;
    if (nodeToProcess) {
   ...
   */
  getHeaderSettings(headerLevel, columnIndex) {
    var _classPrivateFieldGet29, _classPrivateFieldGet32;
    if (headerLevel < 0) {
      headerLevel = this.rowCoordsToLevel(headerLevel);
    }
    ...
    return (_classPrivateFieldGet29 = (_classPrivateFieldGet32 = _classPrivateFieldGet25(this, _stateMatrix)[headerLevel]) === null || _classPrivateFieldGet32 === void 0 ? void 0 : _classPrivateFieldGet32[columnIndex]) !== null && _classPrivateFieldGet29 !== void 0 ? _classPrivateFieldGet29 : null;
  }
  /**
  ...
  getHeaderTreeNode(headerLevel, columnIndex) {
    ...
    const node = _classPrivateFieldGet25(this, _headersTree).getNode(headerLevel, columnIndex);
    if (!node) {
      return null;
    }
    return node;
  ...
  findTopMostEntireHeaderLevel(columnIndexFrom) {
    ...
    for (let columnIndex = columnIndexFrom; columnIndex <= columnIndexTo; columnIndex++) {
      const rootNode = _classPrivateFieldGet25(this, _headersTree).getRootByColumn(columnIndex);
      if (!rootNode) {
        break;
      }
   ...
   */
  getLayersCount() {
    return _classPrivateFieldGet25(this, _sourceSettings2).getLayersCount();
  }
  /**
   * Gets a total number of columns count.
   *
   ...
   */
  getColumnsCount() {
    return _classPrivateFieldGet25(this, _sourceSettings2).getColumnsCount();
  }
  /**
   * Clears the column state manager to the initial state.
   */
  clear() {
    _classPrivateFieldSet25(this, _stateMatrix, []);
    _classPrivateFieldGet25(this, _sourceSettings2).clear();
    _classPrivateFieldGet25(this, _headersTree).clear();
  }
};
...
var GhostTable2 = class {
  constructor(hot, nestedHeaderSettingsGetter) {
    _defineProperty42(this, "hot", void 0);
    _defineProperty42(this, "nestedHeaderSettingsGetter", void 0);
    _defineProperty42(this, "layersCount", 0);
    _defineProperty42(this, "container", void 0);
    _defineProperty42(this, "widthsMap", void 0);
    this.hot = hot;
...
var PLUGIN_KEY26 = "nestedHeaders";
var PLUGIN_PRIORITY26 = 280;
...
var NestedHeaders = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec32(this, _onAfterLoadData9);
    _classPrivateMethodInitSpec32(this, _onInit3);
    _classPrivateMethodInitSpec32(this, _onModifyFocusedElement);
    _classPrivateMethodInitSpec32(this, _onModifyColumnHeaderValue);
    _classPrivateMethodInitSpec32(this, _onModifyColWidth4);
    _classPrivateMethodInitSpec32(this, _onAfterViewportColumnCalculatorOverride3);
    _classPrivateMethodInitSpec32(this, _onAfterGetColumnHeaderRenderers);
    _classPrivateMethodInitSpec32(this, _onBeforeSelectColumns);
    _classPrivateMethodInitSpec32(this, _onModifyTransformStart3);
    _classPrivateMethodInitSpec32(this, _onBeforeSelectionHighlightSet);
    _classPrivateMethodInitSpec32(this, _onBeforeOnCellMouseUp);
    _classPrivateMethodInitSpec32(this, _onBeforeOnCellMouseOver4);
    _classPrivateMethodInitSpec32(this, _onAfterOnCellMouseDown);
    _classPrivateMethodInitSpec32(this, _onBeforeOnCellMouseDown6);
    _classPrivateMethodInitSpec32(this, _onBeforeCopy);
    _classPrivateMethodInitSpec32(this, _onBeforeHighlightingColumnHeader);
    _classPrivateMethodInitSpec32(this, _onBeforeViewportScrollHorizontally);
    _classPrivateMethodInitSpec32(this, _updateFocusHighlightPosition);
    _classPrivateFieldInitSpec26(this, _stateManager, {
      writable: true,
      value: new StateManager()
    });
    _classPrivateFieldInitSpec26(this, _hidingIndexMapObserver, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec26(this, _focusInitialCoords, {
      writable: true,
      value: null
    });
    _classPrivateFieldInitSpec26(this, _isColumnsSelectionInProgress, {
      writable: true,
      value: false
    });
    _defineProperty43(this, "ghostTable", new ghostTable_default2(this.hot, (row, column) => this.getHeaderSettings(row, column)));
    _defineProperty43(this, "detectedOverlappedHeaders", false);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY26;
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY26];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    this.addHook("init", () => _classPrivateMethodGet32(this, _onInit3, _onInit22).call(this));
    this.addHook("afterLoadData", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet32(_this, _onAfterLoadData9, _onAfterLoadData28).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseDown", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet32(_this, _onBeforeOnCellMouseDown6, _onBeforeOnCellMouseDown25).call(_this, ...args);
    });
    this.addHook("afterOnCellMouseDown", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _classPrivateMethodGet32(_this, _onAfterOnCellMouseDown, _onAfterOnCellMouseDown2).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseOver", function() {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return _classPrivateMethodGet32(_this, _onBeforeOnCellMouseOver4, _onBeforeOnCellMouseOver23).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseUp", function() {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return _classPrivateMethodGet32(_this, _onBeforeOnCellMouseUp, _onBeforeOnCellMouseUp2).call(_this, ...args);
    });
    this.addHook("beforeSelectionHighlightSet", function() {
      for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
        args[_key6] = arguments[_key6];
      }
      return _classPrivateMethodGet32(_this, _onBeforeSelectionHighlightSet, _onBeforeSelectionHighlightSet2).call(_this, ...args);
    });
    this.addHook("modifyTransformStart", function() {
      for (var _len7 = arguments.length, args = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
        args[_key7] = arguments[_key7];
      }
      return _classPrivateMethodGet32(_this, _onModifyTransformStart3, _onModifyTransformStart22).call(_this, ...args);
    });
    this.addHook("afterSelection", () => _classPrivateMethodGet32(this, _updateFocusHighlightPosition, _updateFocusHighlightPosition2).call(this));
    this.addHook("beforeViewportScrollHorizontally", function() {
      for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
        args[_key8] = arguments[_key8];
      }
      return _classPrivateMethodGet32(_this, _onBeforeViewportScrollHorizontally, _onBeforeViewportScrollHorizontally2).call(_this, ...args);
    });
    this.addHook("afterGetColumnHeaderRenderers", (array) => _classPrivateMethodGet32(this, _onAfterGetColumnHeaderRenderers, _onAfterGetColumnHeaderRenderers2).call(this, array));
    this.addHook("modifyColWidth", function() {
      for (var _len9 = arguments.length, args = new Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
        args[_key9] = arguments[_key9];
      }
      return _classPrivateMethodGet32(_this, _onModifyColWidth4, _onModifyColWidth23).call(_this, ...args);
    });
    this.addHook("modifyColumnHeaderValue", function() {
      for (var _len10 = arguments.length, args = new Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {
        args[_key10] = arguments[_key10];
      }
      return _classPrivateMethodGet32(_this, _onModifyColumnHeaderValue, _onModifyColumnHeaderValue2).call(_this, ...args);
    });
    this.addHook("beforeHighlightingColumnHeader", function() {
      for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {
        args[_key11] = arguments[_key11];
      }
      return _classPrivateMethodGet32(_this, _onBeforeHighlightingColumnHeader, _onBeforeHighlightingColumnHeader2).call(_this, ...args);
    });
    this.addHook("beforeCopy", function() {
      for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        args[_key12] = arguments[_key12];
      }
      return _classPrivateMethodGet32(_this, _onBeforeCopy, _onBeforeCopy2).call(_this, ...args);
    });
    this.addHook("beforeSelectColumns", function() {
      for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
        args[_key13] = arguments[_key13];
      }
      return _classPrivateMethodGet32(_this, _onBeforeSelectColumns, _onBeforeSelectColumns2).call(_this, ...args);
    });
    this.addHook("afterViewportColumnCalculatorOverride", function() {
      for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {
        args[_key14] = arguments[_key14];
      }
      return _classPrivateMethodGet32(_this, _onAfterViewportColumnCalculatorOverride3, _onAfterViewportColumnCalculatorOverride22).call(_this, ...args);
    });
    this.addHook("modifyFocusedElement", function() {
      for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {
        args[_key15] = arguments[_key15];
      }
      return _classPrivateMethodGet32(_this, _onModifyFocusedElement, _onModifyFocusedElement2).call(_this, ...args);
    });
    this.hot.columnIndexMapper.addLocalHook("cacheUpdated", () => _classPrivateMethodGet32(this, _updateFocusHighlightPosition, _updateFocusHighlightPosition2).call(this));
    this.hot.rowIndexMapper.addLocalHook("cacheUpdated", () => _classPrivateMethodGet32(this, _updateFocusHighlightPosition, _updateFocusHighlightPosition2).call(this));
    super.enablePlugin();
    this.updatePlugin();
  }
  /**
  ...
  updatePlugin() {
    ...
    _classPrivateFieldGet26(this, _stateManager).setColumnsLimit(this.hot.countCols());
    if (Array.isArray(nestedHeaders)) {
      this.detectedOverlappedHeaders = _classPrivateFieldGet26(this, _stateManager).setState(nestedHeaders);
    }
    ...
    if (this.enabled) {
      this.hot.columnIndexMapper.hidingMapsCollection.getMergedValues().forEach((isColumnHidden, physicalColumnIndex) => {
        ...
        _classPrivateFieldGet26(this, _stateManager).triggerColumnModification(actionName, physicalColumnIndex);
      });
    }
    if (!_classPrivateFieldGet26(this, _hidingIndexMapObserver) && this.enabled) {
      _classPrivateFieldSet26(this, _hidingIndexMapObserver, this.hot.columnIndexMapper.createChangesObserver("hiding").subscribe((changes) => {
        changes.forEach((_ref) => {
          ...
          if (op === "replace") {
            ...
            _classPrivateFieldGet26(this, _stateManager).triggerColumnModification(actionName, columnIndex);
          }
        });
  ...
  disablePlugin() {
    this.clearColspans();
    _classPrivateFieldGet26(this, _stateManager).clear();
    _classPrivateFieldGet26(this, _hidingIndexMapObserver).unsubscribe();
    _classPrivateFieldSet26(this, _hidingIndexMapObserver, null);
   ...
   */
  getStateManager() {
    return _classPrivateFieldGet26(this, _stateManager);
  }
  /**
   * Gets a total number of headers levels.
   *
   ...
   */
  getLayersCount() {
    return _classPrivateFieldGet26(this, _stateManager).getLayersCount();
  }
  /**
   ...
   */
  getHeaderSettings(headerLevel, columnIndex) {
    return _classPrivateFieldGet26(this, _stateManager).getHeaderSettings(headerLevel, columnIndex);
  }
  /**
  ...
  headerRendererFactory(headerLevel) {
    ...
    return (renderedColumnIndex, TH) => {
      ...
      const {
        ...
        isHidden,
        isPlaceholder
      } = (_classPrivateFieldGet29 = _classPrivateFieldGet26(this, _stateManager).getHeaderSettings(headerLevel, visualColumnIndex)) !== null && _classPrivateFieldGet29 !== void 0 ? _classPrivateFieldGet29 : {
        label: ""
      };
  ...
  getColumnHeaderValue(visualColumnIndex, headerLevel) {
    ...
    const {
      isHidden,
      isPlaceholder
    } = (_classPrivateFieldGet32 = _classPrivateFieldGet26(this, _stateManager).getHeaderSettings(headerLevel, visualColumnIndex)) !== null && _classPrivateFieldGet32 !== void 0 ? _classPrivateFieldGet32 : {};
    if (isPlaceholder || isHidden) {
      return "";
    }
   ...
   */
  destroy() {
    _classPrivateFieldSet26(this, _stateManager, null);
    if (_classPrivateFieldGet26(this, _hidingIndexMapObserver) !== null) {
      _classPrivateFieldGet26(this, _hidingIndexMapObserver).unsubscribe();
      _classPrivateFieldSet26(this, _hidingIndexMapObserver, null);
    }
    super.destroy();
  ...
  _getHeaderTreeNodeDataByCoords(coords) {
    ...
    return _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(coords.row, coords.col);
  }
};
function _updateFocusHighlightPosition2() {
  ...
  if (isNestedHeadersRange) {
    const columnIndex = _classPrivateFieldGet26(this, _stateManager).findLeftMostColumnIndex(highlight.row, highlight.col);
...
function _onBeforeViewportScrollHorizontally2(visualColumn) {
  ...
  const mostLeftColumnIndex = _classPrivateFieldGet26(this, _stateManager).findLeftMostColumnIndex(highlight.row, highlight.col);
  const mostRightColumnIndex = _classPrivateFieldGet26(this, _stateManager).findRightMostColumnIndex(highlight.row, highlight.col);
...
function _onBeforeHighlightingColumnHeader2(visualColumn, headerLevel, highlightMeta) {
  const headerNodeData = _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(headerLevel, visualColumn);
  if (!headerNodeData) {
    return visualColumn;
  }
  const {
  ...
  const {
    isRoot,
    colspan
  } = _classPrivateFieldGet26(this, _stateManager).getHeaderSettings(headerLevel, visualColumn);
  ...
  for (let rangeIndex = 0; rangeIndex < copyableRanges.length; rangeIndex++) {
    ...
    for (let column = startCol; column <= endCol; column++) {
      for (let row = startRow; row <= endRow; row++) {
        ...
        const isRoot = (_classPrivateFieldGet42 = _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(row, column)) === null || _classPrivateFieldGet42 === void 0 ? void 0 : _classPrivateFieldGet42.isRoot;
        if (isRoot === false) {
...
function _onAfterOnCellMouseDown2(event, coords) {
  ...
  _classPrivateFieldSet26(this, _focusInitialCoords, coords.clone());
  _classPrivateFieldSet26(this, _isColumnsSelectionInProgress, true);
  const {
    selection
  } = this.hot;
...
function _onBeforeOnCellMouseUp2() {
  _classPrivateFieldSet26(this, _isColumnsSelectionInProgress, false);
}
function _onBeforeSelectionHighlightSet2() {
  const {
    navigableHeaders
  } = this.hot.getSettings();
  if (!this.hot.view.isMouseDown() || !_classPrivateFieldGet26(this, _isColumnsSelectionInProgress) || !navigableHeaders) {
    return;
  }
  const selectedRange = this.hot.getSelectedRangeLast();
  ...
  const {
    columnIndex,
    origColspan
  } = _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(_classPrivateFieldGet26(this, _focusInitialCoords).row, _classPrivateFieldGet26(this, _focusInitialCoords).col);
  selectedRange.setHighlight(_classPrivateFieldGet26(this, _focusInitialCoords));
  if (origColspan > selectedRange.getWidth() || columnIndex < columnStart || columnIndex + origColspan - 1 > columnEnd) {
    const headerLevel = _classPrivateFieldGet26(this, _stateManager).findTopMostEntireHeaderLevel(clamp(columnStart, columnIndex, columnIndex + origColspan - 1), clamp(columnEnd, columnIndex, columnIndex + origColspan - 1));
...
function _onModifyTransformStart22(delta) {
  ...
  const visualColumnIndexStart = _classPrivateFieldGet26(this, _stateManager).findLeftMostColumnIndex(nextCoords.row, nextCoords.col);
  const visualColumnIndexEnd = _classPrivateFieldGet26(this, _stateManager).findRightMostColumnIndex(nextCoords.row, nextCoords.col);
  if (delta.col < 0) {
...
function _onAfterGetColumnHeaderRenderers2(renderersArray) {
  ...
  for (let headerLayer = 0; headerLayer < _classPrivateFieldGet26(this, _stateManager).getLayersCount(); headerLayer++) {
    renderersArray.push(this.headerRendererFactory(headerLayer));
  }
}
function _onAfterViewportColumnCalculatorOverride22(calc) {
  const headerLayersCount = _classPrivateFieldGet26(this, _stateManager).getLayersCount();
  let newStartColumn = calc.startColumn;
  let nonRenderable = !!headerLayersCount;
  for (let headerLayer = 0; headerLayer < headerLayersCount; headerLayer++) {
    const startColumn = _classPrivateFieldGet26(this, _stateManager).findLeftMostColumnIndex(headerLayer, calc.startColumn);
  ...
  calc.startColumn = nonRenderable ? _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(0, newStartColumn).columnIndex : newStartColumn;
}
...
function _onModifyColumnHeaderValue2(value, visualColumnIndex, headerLevel) {
  ...
  const {
    label
  } = (_classPrivateFieldGet52 = _classPrivateFieldGet26(this, _stateManager).getHeaderTreeNodeData(headerLevel, visualColumnIndex)) !== null && _classPrivateFieldGet52 !== void 0 ? _classPrivateFieldGet52 : {
    label: ""
  };
  return label;
}
function _onModifyFocusedElement2(row, column) {
  if (row < 0) {
    return this.hot.getCell(row, _classPrivateFieldGet26(this, _stateManager).findLeftMostColumnIndex(row, column), true);
  }
}
function _onInit22() {
  this.updatePlugin();
...
var DataManager = class {
  constructor(nestedRowsPlugin, hotInstance) {
    _defineProperty44(this, "hot", void 0);
    _defineProperty44(this, "data", null);
    _defineProperty44(this, "plugin", void 0);
    _defineProperty44(this, "parentReference", /* @__PURE__ */ new WeakMap());
    _defineProperty44(this, "cache", {
      levels: [],
      levelCount: 0,
      rows: [],
...
var ContextMenuUI = class extends base_default4 {
  constructor() {
    super(...arguments);
    _defineProperty46(this, "dataManager", this.plugin.dataManager);
    _classPrivateFieldInitSpec27(this, _menuEntries, {
      writable: true,
      value: {
  ...
  modifyRowInsertingOptions(defaultOptions) {
    rangeEach(0, defaultOptions.items.length - 1, (i) => {
      const option = _classPrivateFieldGet27(this, _menuEntries)[defaultOptions.items[i].key];
...
var RowMoveController = class {
  constructor(plugin) {
    _defineProperty47(this, "plugin", void 0);
    _defineProperty47(this, "hot", void 0);
    _defineProperty47(this, "dataManager", void 0);
    _defineProperty47(this, "collapsingUI", void 0);
    this.plugin = plugin;
    this.hot = plugin.hot;
...
function _classPrivateMethodInitSpec33(obj, privateSet) {
  _checkPrivateRedeclaration41(obj, privateSet);
  privateSet.add(obj);
}
...
var PLUGIN_KEY27 = "nestedRows";
var PLUGIN_PRIORITY27 = 300;
var SHORTCUTS_GROUP9 = PLUGIN_KEY27;
...
var NestedRows = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec33(this, _onBeforeLoadData3);
    _classPrivateMethodInitSpec33(this, _onBeforeViewRender4);
    _classPrivateMethodInitSpec33(this, _onAfterInit6);
    _classPrivateMethodInitSpec33(this, _onAfterCreateRow4);
    _classPrivateMethodInitSpec33(this, _onAfterDetachChild3);
    _classPrivateMethodInitSpec33(this, _onBeforeDetachChild);
    _classPrivateMethodInitSpec33(this, _onAfterAddChild);
    _classPrivateMethodInitSpec33(this, _onBeforeAddChild);
    _classPrivateMethodInitSpec33(this, _onBeforeRemoveRow3);
    _classPrivateMethodInitSpec33(this, _onAfterRemoveRow4);
    _classPrivateMethodInitSpec33(this, _onModifyRowHeaderWidth);
    _classPrivateMethodInitSpec33(this, _onAfterGetRowHeader3);
    _classPrivateMethodInitSpec33(this, _onAfterContextMenuDefaultOptions6);
    _classPrivateMethodInitSpec33(this, _onFilterData);
    _classPrivateMethodInitSpec33(this, _onBeforeOnCellMouseDown7);
    _classPrivateMethodInitSpec33(this, _onBeforeRowMove);
    _defineProperty48(this, "dataManager", null);
    _defineProperty48(this, "headersUI", null);
    _defineProperty48(this, "collapsedRowsMap", null);
    _classPrivateFieldInitSpec28(this, _skipRender, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec28(this, _skipCoreAPIModifiers, {
      writable: true,
      value: false
    });
  }
   ...
   */
  isEnabled() {
    return !!this.hot.getSettings()[PLUGIN_KEY27];
  }
  /**
   * Enables the plugin functionality for this Handsontable instance.
   */
  enablePlugin() {
    ...
    this.addHook("afterInit", function() {
      ...
      return _classPrivateMethodGet33(_this, _onAfterInit6, _onAfterInit25).call(_this, ...args);
    });
    this.addHook("beforeViewRender", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _classPrivateMethodGet33(_this, _onBeforeViewRender4, _onBeforeViewRender23).call(_this, ...args);
    });
    ...
    this.addHook("filterData", function() {
      ...
      return _classPrivateMethodGet33(_this, _onFilterData, _onFilterData2).call(_this, ...args);
    });
    this.addHook("afterContextMenuDefaultOptions", function() {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return _classPrivateMethodGet33(_this, _onAfterContextMenuDefaultOptions6, _onAfterContextMenuDefaultOptions25).call(_this, ...args);
    });
    this.addHook("afterGetRowHeader", function() {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return _classPrivateMethodGet33(_this, _onAfterGetRowHeader3, _onAfterGetRowHeader22).call(_this, ...args);
    });
    this.addHook("beforeOnCellMouseDown", function() {
      for (var _len6 = arguments.length, args = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
        args[_key6] = arguments[_key6];
      }
      return _classPrivateMethodGet33(_this, _onBeforeOnCellMouseDown7, _onBeforeOnCellMouseDown26).call(_this, ...args);
    });
    this.addHook("beforeRemoveRow", function() {
      for (var _len7 = arguments.length, args = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
        args[_key7] = arguments[_key7];
      }
      return _classPrivateMethodGet33(_this, _onBeforeRemoveRow3, _onBeforeRemoveRow22).call(_this, ...args);
    });
    this.addHook("afterRemoveRow", function() {
      for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
        args[_key8] = arguments[_key8];
      }
      return _classPrivateMethodGet33(_this, _onAfterRemoveRow4, _onAfterRemoveRow23).call(_this, ...args);
    });
    this.addHook("beforeAddChild", function() {
      for (var _len9 = arguments.length, args = new Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
        args[_key9] = arguments[_key9];
      }
      return _classPrivateMethodGet33(_this, _onBeforeAddChild, _onBeforeAddChild2).call(_this, ...args);
    });
    this.addHook("afterAddChild", function() {
      for (var _len10 = arguments.length, args = new Array(_len10), _key10 = 0; _key10 < _len10; _key10++) {
        args[_key10] = arguments[_key10];
      }
      return _classPrivateMethodGet33(_this, _onAfterAddChild, _onAfterAddChild2).call(_this, ...args);
    });
    this.addHook("beforeDetachChild", function() {
      for (var _len11 = arguments.length, args = new Array(_len11), _key11 = 0; _key11 < _len11; _key11++) {
        args[_key11] = arguments[_key11];
      }
      return _classPrivateMethodGet33(_this, _onBeforeDetachChild, _onBeforeDetachChild2).call(_this, ...args);
    });
    this.addHook("afterDetachChild", function() {
      for (var _len12 = arguments.length, args = new Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        args[_key12] = arguments[_key12];
      }
      return _classPrivateMethodGet33(_this, _onAfterDetachChild3, _onAfterDetachChild22).call(_this, ...args);
    });
    this.addHook("modifyRowHeaderWidth", function() {
      for (var _len13 = arguments.length, args = new Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
        args[_key13] = arguments[_key13];
      }
      return _classPrivateMethodGet33(_this, _onModifyRowHeaderWidth, _onModifyRowHeaderWidth2).call(_this, ...args);
    });
    this.addHook("afterCreateRow", function() {
      for (var _len14 = arguments.length, args = new Array(_len14), _key14 = 0; _key14 < _len14; _key14++) {
        args[_key14] = arguments[_key14];
      }
      return _classPrivateMethodGet33(_this, _onAfterCreateRow4, _onAfterCreateRow23).call(_this, ...args);
    });
    this.addHook("beforeRowMove", function() {
      for (var _len15 = arguments.length, args = new Array(_len15), _key15 = 0; _key15 < _len15; _key15++) {
        args[_key15] = arguments[_key15];
      }
      return _classPrivateMethodGet33(_this, _onBeforeRowMove, _onBeforeRowMove2).call(_this, ...args);
    });
    this.addHook("beforeLoadData", (data) => _classPrivateMethodGet33(this, _onBeforeLoadData3, _onBeforeLoadData22).call(this, data));
    this.addHook("beforeUpdateData", (data) => _classPrivateMethodGet33(this, _onBeforeLoadData3, _onBeforeLoadData22).call(this, data));
    this.registerShortcuts();
    super.enablePlugin();
  }
  /**
  ...
  disableCoreAPIModifiers() {
    _classPrivateFieldSet27(this, _skipCoreAPIModifiers, true);
  }
  /**
  ...
  enableCoreAPIModifiers() {
    _classPrivateFieldSet27(this, _skipCoreAPIModifiers, false);
  }
  /**
   ...
   */
  onModifyRowData(row) {
    if (_classPrivateFieldGet28(this, _skipCoreAPIModifiers)) {
      return;
    }
  ...
  onBeforeDataSplice(index, amount, element) {
    if (_classPrivateFieldGet28(this, _skipCoreAPIModifiers) || this.dataManager.isRowHighestLevel(index)) {
      return true;
    }
...
function _onFilterData2(index, amount, physicalRows) {
  ...
  _classPrivateFieldSet27(this, _skipRender, true);
...
function _onAfterRemoveRow23(index, amount, logicRows, source) {
  ...
  this.hot._registerTimeout(() => {
    _classPrivateFieldSet27(this, _skipRender, false);
...
function _onBeforeViewRender23(force, skipRender) {
  if (_classPrivateFieldGet28(this, _skipRender)) {
...
function _onBeforeLoadData22(data) {
  if (!isArrayOfObjects(data)) {
    ...
    this.hot.getSettings()[PLUGIN_KEY27] = false;
    this.disablePlugin();
    return;
  }
...
var Storage = class {
  ...
  constructor(prefix) {
    ...
    _defineProperty49(this, "rootWindow", void 0);
    _defineProperty49(this, "prefix", void 0);
    _defineProperty49(this, "savedKeys", []);
...
var PLUGIN_KEY28 = "persistentState";
var PLUGIN_PRIORITY28 = 0;
var PersistentState = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _defineProperty50(this, "storage", void 0);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY28;
  }
...
function _classPrivateMethodInitSpec34(obj, privateSet) {
  _checkPrivateRedeclaration42(obj, privateSet);
  privateSet.add(obj);
}
...
var PLUGIN_KEY29 = "search";
var PLUGIN_PRIORITY29 = 190;
...
var Search = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec34(this, _onBeforeRenderer);
    _defineProperty51(this, "callback", DEFAULT_CALLBACK);
    _defineProperty51(this, "queryMethod", DEFAULT_QUERY_METHOD);
    _defineProperty51(this, "searchResultClass", DEFAULT_SEARCH_RESULT_CLASS);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY29;
  }
  ...
  enablePlugin() {
    ...
    const searchSettings = this.hot.getSettings()[PLUGIN_KEY29];
    this.updatePluginSettings(searchSettings);
    this.addHook("beforeRenderer", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _classPrivateMethodGet34(_this, _onBeforeRenderer, _onBeforeRenderer2).call(_this, ...args);
    });
    super.enablePlugin();
  }
  /**
  ...
  disablePlugin() {
    ...
    const beforeRendererCallback = function() {
      ...
      return _classPrivateMethodGet34(_this2, _onBeforeRenderer, _onBeforeRenderer2).call(_this2, ...args);
    };
...
var PLUGIN_KEY30 = "touchScroll";
var PLUGIN_PRIORITY30 = 200;
...
var TouchScroll = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec35(this, _onAfterMomentumScroll);
    _classPrivateMethodInitSpec35(this, _onBeforeTouchScroll);
    _classPrivateMethodInitSpec35(this, _onAfterViewRender);
    _defineProperty52(this, "scrollbars", []);
    _defineProperty52(this, "clones", []);
    _defineProperty52(this, "lockedCollection", false);
    _defineProperty52(this, "freezeOverlays", false);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY30;
  }
  ...
  enablePlugin() {
    ...
    this.addHook("afterViewRender", () => _classPrivateMethodGet35(this, _onAfterViewRender, _onAfterViewRender2).call(this));
    this.registerEvents();
    super.enablePlugin();
  }
  /**
   ...
   */
  registerEvents() {
    this.addHook("beforeTouchScroll", () => _classPrivateMethodGet35(this, _onBeforeTouchScroll, _onBeforeTouchScroll2).call(this));
    this.addHook("afterMomentumScroll", () => _classPrivateMethodGet35(this, _onAfterMomentumScroll, _onAfterMomentumScroll2).call(this));
  }
};
...
function _classPrivateMethodInitSpec36(obj, privateSet) {
  _checkPrivateRedeclaration44(obj, privateSet);
  privateSet.add(obj);
}
...
var PLUGIN_KEY31 = "trimRows";
var PLUGIN_PRIORITY31 = 330;
var _onMapInit6 = /* @__PURE__ */ new WeakSet();
var TrimRows = class extends BasePlugin {
  constructor() {
    super(...arguments);
    _classPrivateMethodInitSpec36(this, _onMapInit6);
    _defineProperty53(this, "trimmedRowsMap", null);
  }
  static get PLUGIN_KEY() {
    return PLUGIN_KEY31;
  }
  ...
  enablePlugin() {
    ...
    this.trimmedRowsMap.addLocalHook("init", () => _classPrivateMethodGet36(this, _onMapInit6, _onMapInit25).call(this));
    super.enablePlugin();
  }
  /**
   * Updates the plugin's state.
   ...
   */
  updatePlugin() {
    const trimmedRows = this.hot.getSettings()[PLUGIN_KEY31];
...
var SHORTCUTS_GROUP10 = "undoRedo";
var PLUGIN_KEY32 = "undoRedo";
...
UndoRedo.prototype.unregisterShortcuts = function() {
  const shortcutManager = this.instance.getShortcutManager();
  const gridContext = shortcutManager.getContext("grid");
  gridContext.removeShortcutsByGroup(SHORTCUTS_GROUP10);
};
...
UndoRedo.PLUGIN_KEY = PLUGIN_KEY32;
...
//# sourceMappingURL=chunk-BFARP6PZ.js.map
