...
var exportGlobalErrorCauseWrapper = function(ERROR_NAME, wrapper) {
  ...
  $3({ global: true, constructor: true, arity: 1, forced: FORCED2 }, O);
};
var exportWebAssemblyErrorCauseWrapper = function(ERROR_NAME, wrapper) {
  if (WebAssembly && WebAssembly[ERROR_NAME]) {
    var O = {};
    O[ERROR_NAME] = wrapErrorConstructorWithCause(WEB_ASSEMBLY + "." + ERROR_NAME, wrapper, FORCED2);
    $3({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED2 }, O);
  }
};
...
*/
//# sourceMappingURL=chunk-ST45JAFY.js.map
