...
var _hoisted_13 = ["id"];
var _hoisted_23 = ["id", "placeholder", "aria-expanded", "aria-controls", "aria-labelledby", "aria-label", "disabled", "readonly"];
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread(_objectSpread({}, _ctx.inputProps), _ctx.ptm("input"))), null, 16, _hoisted_23)) : createCommentVNode("", true), _ctx.showIcon ? (openBlock(), createBlock(_component_CalendarButton, {
    key: 1,
