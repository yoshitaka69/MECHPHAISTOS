(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueWhiteboard"] = factory(require("vue"));
	else
		root["VueWhiteboard"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/@vue/cli-service/node_modules/vue-loader-v16/dist/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/@vue/cli-service/node_modules/vue-loader-v16/dist??ref--0-1!./src/components/vue-whiteboard.vue?vue&type=template&id=33d25ce5
...
// CONCATENATED MODULE: ./src/components/vue-whiteboard.vue?vue&type=template&id=33d25ce5
...
var vue_whiteboardvue_type_script_lang_js_setLineAttributes = function setLineAttributes(props) {
...
var getCoordinates = function getCoordinates(event) {
  var _event$sourceEvent = event.sourceEvent,
      offsetX = _event$sourceEvent.offsetX,
      offsetY = _event$sourceEvent.offsetY;
  return [offsetX, offsetY];
};

var clearSvg = function clearSvg(container) {
  return container.selectAll('*').remove();
};

var drawLine = function drawLine(container, node) {
  return container.node().appendChild(node);
};

var undoAction = function undoAction(state) {
  if (!state.undoStack.length) return;
  state.redoStack.push(state.undoStack.pop());
  clearSvg(state.svg);
  state.undoStack.forEach(function (node) {
    return drawLine(state.svg, node);
  });
};

var redoAction = function redoAction(state) {
...
var nodeToSvg = function nodeToSvg(node) {
  node.setAttribute('xlink', 'http://www.w3.org/1999/xlink');
  var serializer = new XMLSerializer();
  var svgString = serializer.serializeToString(node).replace(/(\w+)?:?xlink=/g, 'xmlns:xlink=').replace(/NS\d+:href/g, 'xlink:href');
  var svgData = 'data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(svgString)));
  return svgData;
};

var saveSvg = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(state) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new Promise(function (resolve) {
              var container = state.container.cloneNode(true);
              var svg = src_select(container);
              clearSvg(svg);
              state.undoStack.forEach(function (node) {
                return drawLine(svg, node.cloneNode(true));
              });
              var svgData = nodeToSvg(container);
  ...
  return function saveSvg(_x) {
    return _ref3.apply(this, arguments);
  };
}();

/* harmony default export */ var vue_whiteboardvue_type_script_lang_js = ({
  name: 'VueWhiteboard',
  props: {
    color: {
      type: String,
    ...
    linejoin: {
      ...
      validator: function validator(val) {
        return ['miter', 'round', 'bevel', 'miter-clip', 'arcs'].includes(val);
      }
    },
    linecap: {
      type: String,
      default: 'round',
      validator: function validator(val) {
        return ['butt', 'square', 'round'].includes(val);
      }
    }
  },
  setup: function setup(props, _ref4) {
    var emit = _ref4.emit;
    var d3Line = src_line().curve(curve_basis);
    ...
    var init = function init() {
      state.svg = src_select(state.container).call(src_drag().container(state.container).subject(function (_ref5) {
        var x = _ref5.x,
            y = _ref5.y;
        return [[x, y], [x, y]];
      }).on('start', function (event) {
        state.activeLine = state.svg.append('path').datum(event.subject).attr('class', 'line').attr('style', vue_whiteboardvue_type_script_lang_js_setLineAttributes(props));
        ...
        event.on('drag', function (event) {
          var coordinates = [event.x, event.y];
        ...
        event.on('end', function (event) {
          state.activeLine.attr('d', d3Line);
          var node = state.activeLine.node();
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["onMounted"])(init);
...
// CONCATENATED MODULE: ./src/components/vue-whiteboard.vue?vue&type=script&lang=js
 
// CONCATENATED MODULE: ./src/components/vue-whiteboard.vue



vue_whiteboardvue_type_script_lang_js.render = render

/* harmony default export */ var vue_whiteboard = (vue_whiteboardvue_type_script_lang_js);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (vue_whiteboard);
...
//# sourceMappingURL=VueWhiteboard.umd.js.map