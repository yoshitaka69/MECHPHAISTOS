                  ...
                  <div class="flex gap-5 flex-column-reverse md:flex-row">
                      <div class="flex-auto p-fluid">
                          ...
                          <div class="flex justify-content-end">
                              <!-- Saveボタンを青色、文字を白色に設定 -->
                              <Button label="Save" icon="pi pi-save" class="mr-2 p-button-primary" style="background-color: blue; border-color: blue; color: white" />

                              <!-- Cancelボタンをオレンジ色、文字を白色に設定 -->
                              <Button label="Cancel" icon="pi pi-times" class="p-button-secondary" style="background-color: #ff6347; border-color: #ff6347; color: white" />
                          </div>
                      </div>
                  </div>
              </div>
