<template>
  <div>
      ...
      <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
          <div class="py-4 text-center md:text-left border-round bg-cover h-20rem lg:h-30rem flex flex-column justify-content-end mb-5" :style="{ backgroundImage: `url(${Repairing_Cost_Explanation})` }">
              <div class="grid">
...
import Repairing_Cost_Explanation from '@/assets/Repairing_Cost_Explanation.png';
