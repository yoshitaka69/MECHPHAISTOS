<template>
    <div>
        ...
        <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
            <div class="py-4 text-center md:text-left border-round bg-cover h-20rem lg:h-30rem flex flex-column justify-content-end mb-5" :style="{ backgroundImage: `url(${Safety_Explanation})` }">
                <div class="grid">
            ...
            <div class="grid">
                ...
                <div class="col-12 lg:col lg:px-5">
                    ...
                    <div class="line-height-3 text-xl text-900 mb-5">
                        ここではヒヤリハットについて説明します。私はかつて、メンテナンスとヒヤリハットを混同することについて深く考えたことがあります。しかし、これらの組み合わせは切り離せない関係にあり、お互いに多くの良い側面を持っています。そのため、MECHPHAISTOSではヒヤリハットをメンテナンス領域の一部と考えています。これらのヒヤリハットの大きな特徴は、世界的なレベルで安全指数を比較できる点であり、各企業の安全指数とも比較することができます。さらに、ヒヤリハットデータを収集することで、近づいている危険レベルを特定し、事前に予測し、それを回避することが可能になります。
                    </div>
  ...
  import Safety_Explanation from '@/assets/Safety_Explanation.png';
