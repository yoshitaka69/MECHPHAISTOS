          ...
          <div class="grid">
            <div class="col lg:col-offset-2 px-5">
              <div class="text-5xl font-bold text-black">
                Critical Equipment List in MECHPHAISTOS
              </div>
              <p class="line-height-3 text-black text-lg text-center md:text-left mt-3">
                Published May 16, 2024 by Yoshitaka Noto
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="grid">
          ...
          <div class="col-12 lg:col lg:px-5">
            ...
            <div class="line-height-3 text-xl text-900 mb-5">
              私は、プラント保全を包括的かつ効率的に行うために、どのような方法があるのかを模索しているときにこのリストを生み出しました。
              設備の重要性を評価するときに、メンテナンスエンジニアのキャリアや責任部署の所在、生産性や安全によって優位性が変わり、設備本来の重要性が損なわれ、結果として無駄な修繕費や望まない設備トラブルを誘引していること気がつきました。
            </div>
            <blockquote class="surface-50 line-height-3 text-xl text-800 mb-4 py-3 px-3 border-round mx-0">
              簡単にいうとCriticla Equipment Listはプラント内の設備の状態を定量的かつ公平に評価するためのリストです。
              このリストを使うことで、設備の寿命やメンテナンスのタイミングを適切に判断することができます。
              そして、将来的にはDXやAIやAR技術の基幹となるリストとなるでしょう。
            </blockquote>
            <div class="line-height-3 text-lg text-900 mb-4">
              Critical Equipment Listの使い方について説明していきます。
              Critical Equipment Listは以下のデータリストのよって構成されてます。
            </div>
