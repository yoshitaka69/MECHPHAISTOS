	...
	methods: {
	  ...
	  updateData: function () {
		...
		tableData.forEach(row => {
		  ...
		  actualPM02List[plantName].actualPM02.push(yearData);
		});
		...
		axios.post('http://127.0.0.1:8000/api/repairingCost/APM02ByCompany/save_actual_pm02/', postData)
		  .then(response => {
