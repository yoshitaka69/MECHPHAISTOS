...
const TableComponent = defineComponent({
    ...
    methods: {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    const tableData = actualCostData.flatMap((companyData) =>
                        companyData.actualPM05List.map((plantData) => {
                            const rowData = {
        ...
        saveData() {
            ...
            console.log('Post Data:', actualPM05List);

            axios
                .post('http://127.0.0.1:8000/api/repairingCost/actualPM05/', actualPM05List)
                .then((response) => {
        ...
        exportCSV() {
            ...
            if (link.download !== undefined) {
                ...
                link.setAttribute('download', 'PM05_actual_data.csv');
