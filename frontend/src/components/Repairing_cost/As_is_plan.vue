  ...
  jSpreadSheetOptins() {
    return {
      ...
      columns: [
        ...
        { type: "text", title: "Function" },
        { type: "calender", title: "Latest_PM02" },
        { type: "calender", title: "Latest_PM03" },
        { type: "calender", title: "Latest_PM04" },
        { type: "text", title: "Task" },
        { type: "numeric", title: "Cost" },
        { type: "text", title: "Material" },
        { type: "numeric", title: "Price" },
        { type: "text", title: "Period" },
        { type: "text", title: "Next_event" },
        { type: "text", title: "Alert" },
        { type: "checkbox", title: "Need?", width: "80px" },
