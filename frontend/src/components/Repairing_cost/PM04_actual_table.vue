...
const TableComponent = defineComponent({
    ...
    methods: {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    const tableData = actualCostData.flatMap((companyData) =>
                        companyData.actualPM04List.map((plantData) => {
                            const rowData = {
        ...
        saveData() {
            ...
            console.log('Post Data:', actualPM04List);

            axios
                .post('http://127.0.0.1:8000/api/repairingCost/actualPM04/', actualPM04List)
                .then((response) => {
        ...
        exportCSV() {
            ...
            if (link.download !== undefined) {
                ...
                link.setAttribute('download', 'PM04_actual_data.csv');
