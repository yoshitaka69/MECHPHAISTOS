<template>
  ...
  export default {
    ...
    data() {
      ...
      favoriteHistory: {}, // ここに新規追加: 各設定ごとにお気に入りの履歴インデックスを保持
    };
    },
    mounted() {
  ...
  .button-group .ml-3 {
    margin-left: 1rem; /* ボタン間のスペースを確保 */
  }
  
  .star-icon {
  cursor: pointer;
  color: black; /* 色を黒に変更 */
  font-size: 1.5em; /* サイズをもう一回り大きく */
}
  </style>