      ...
      <div class="content">
          ...
          <div class="confirmation-page">
              ...
              <div class="grid-five-columns">
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.valve1_input && !workerInspection.valve1_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.valve2_input && !workerInspection.valve2_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.valve3_input && !workerInspection.valve3_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.valve4_input && !workerInspection.valve4_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.valve5_input && !workerInspection.valve5_approval }">
              ...
              <div class="grid-five-columns">
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.breaker1_input && !workerInspection.breaker1_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.breaker2_input && !workerInspection.breaker2_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.breaker3_input && !workerInspection.breaker3_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.breaker4_input && !workerInspection.breaker4_approval }">
                  ...
                  <div class="form-group grid-item-small" :class="{ highlighted: safetyRequest.breaker5_input && !workerInspection.breaker5_approval }">
...
// フォームの送信を処理する関数
const submitForm = () => {
  // valveとbreakerの入力状態と承認状態をJSONフィールドに整理
  const postData = {
      companyCode: userStore.companyCode, // PiniaからcompanyCodeを取得
      constructionPeriod: safetyRequest.value.constructionPeriod, // フォームに入力された値をそのまま使用
      plant: safetyRequest.value.plant, // フォームに入力された値をそのまま使用
      equipment: safetyRequest.value.equipment, // フォームに入力された値をそのまま使用
      taskName: safetyRequest.value.taskName, // フォームに入力された値をそのまま使用
      personInCharge: safetyRequest.value.personInCharge, // フォームに入力された値をそのまま使用
      contractor: safetyRequest.value.contractor, // フォームに入力された値をそのまま使用
      gasDetection: safetyRequest.value.gasDetection, // スイッチの値を送信
      oxygenDeficiency: safetyRequest.value.oxygenDeficiency, // スイッチの値を送信
      onSiteSafety: workerInspection.value.onSiteSafety, // 作業者点検項目のスイッチの値
      approver: safetyRequest.value.approver, // フォームの承認者情報を送信

      // Valve入力と承認の情報をJSONフィールドにまとめる
      valveInputs: {
          valve1: safetyRequest.value.valve1_input,
          valve2: safetyRequest.value.valve2_input,
          valve3: safetyRequest.value.valve3_input,
          valve4: safetyRequest.value.valve4_input,
          valve5: safetyRequest.value.valve5_input
      },
      valveApprovals: {
          valve1: workerInspection.value.valve1_approval,
          valve2: workerInspection.value.valve2_approval,
          valve3: workerInspection.value.valve3_approval,
          valve4: workerInspection.value.valve4_approval,
          valve5: workerInspection.value.valve5_approval
      },

      // Breaker入力と承認の情報をJSONフィールドにまとめる
      breakerInputs: {
          breaker1: safetyRequest.value.breaker1_input,
          breaker2: safetyRequest.value.breaker2_input,
          breaker3: safetyRequest.value.breaker3_input,
          breaker4: safetyRequest.value.breaker4_input,
          breaker5: safetyRequest.value.breaker5_input
      },
      breakerApprovals: {
          breaker1: workerInspection.value.breaker1_approval,
          breaker2: workerInspection.value.breaker2_approval,
          breaker3: workerInspection.value.breaker3_approval,
          breaker4: workerInspection.value.breaker4_approval,
          breaker5: workerInspection.value.breaker5_approval
      }
  };
  ...
  axios
      .post('http://127.0.0.1:8000/api/workOrder/workPermission/', postData)
      .then((response) => {
