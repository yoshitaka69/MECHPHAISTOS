<template>
  <div id="app">
      ...
      <div id="TaskList">
          ...
          <br />
          <!-- データ更新ボタン（赤色） -->
          <Button @click="confirmUpdate" label="Update Data" class="controls button-margin red-button" />
          <!-- 合計コスト計算ボタン（青色） -->
      ...
      return {
          ...
          hotSettings: {
              ...
              cells: (row, col, prop) => {
                  ...
                  // 特定の年に関する列にはカスタムチェックボックスレンダラを設定
      ...
      getDataAxios() {
          ...
          return axios
              ...
              .then((response) => {
                  ...
                  const blankRows = Array.from({ length: 20 }, () => ({})); // 空行を追加
