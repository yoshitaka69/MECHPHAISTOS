        ...
        <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
            ...
            <div class="grid grid-nogutter">
                <div class="col-12 p-0 mt-5 flex flex-column lg:flex-row align-items-center mb-4">
                    <Button
                        class="p-button-rounded bg-gray-900 text-white px-5 lg:mr-4 sm w-full lg:w-auto border-none"
                        label="Filters"
                        :icon="openDropdown ? 'ml-3 pi pi-chevron-down' : 'ml-3 pi pi-chevron-up'"
                        iconPos="right"
                        v-styleclass="{
                    ...
                    <div class="grid flex-column lg:flex-row w-full h-full">
                        <div class="col-12 lg:col flex align-items-center flex-wrap" style="column-gap: 5px; row-gap: 5px">
                            <Chip
                                ...
                                :label="filter"
                                removable
                                class="mr-3 h-auto px-4 mt-3 lg:mt-0"
                                removeIcon="pi pi-times"
                                :style="{ 'border-radius': '50px' }"
                                @click="selectedFilters.splice(selectedFilters.indexOf(filter.toString()), 1) && selectedBrands.splice(selectedBrands.indexOf(filter), 1) && selectedSizes2.splice(selectedSizes2.indexOf(filter), 1)"
                            ></Chip>
                            <a
                                v-ripple
                                v-if="selectedFilters.length > 0 || selectedColors2 !== 0"
                                tabindex="0"
                                ...
                                <div class="flex w-full justify-content-between">
                                    <div class="field-checkbox">
                                        <Checkbox
                                            ...
                                            @change="selectedBrands.indexOf('Alfred') === -1 ? selectedBrands.push('Alfred') : selectedBrands.splice(selectedBrands.indexOf('Alfred'), 1)"
                                        ></Checkbox>
                                ...
                                <div class="flex w-full justify-content-between">
                                    <div class="field-checkbox">
                                        <Checkbox
                                            ...
                                            id="hyper2"
                                            v-model="selectedFilters"
                                            @change="selectedBrands.indexOf('Hyper') === -1 ? selectedBrands.push('Hyper') : selectedBrands.splice(selectedBrands.indexOf('Hyper'), 1)"
                                        ></Checkbox>
                                ...
                                <div class="flex w-full justify-content-between">
                                    <div class="field-checkbox">
                                        <Checkbox
                                            ...
                                            id="bastion2"
                                            v-model="selectedFilters"
                                            @change="selectedBrands.indexOf('Bastion') === -1 ? selectedBrands.push('Bastion') : selectedBrands.splice(selectedBrands.indexOf('Bastion'), 1)"
                                        ></Checkbox>
                        ...
                        <div class="flex-auto lg:flex-1 col mt-4 lg:mt-2 lg:mr-4 p-4 flex-column border-1 surface-border border-round">
                            ...
                            <div class="grid mb-3">
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-gray-900 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Black') === -1 ? selectedFilters.push('Black') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Black'), 1) && selectedColors2--"
                                    >
                                ...
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-orange-500 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Orange') === -1 ? selectedFilters.push('Orange') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Orange'), 1) && selectedColors2--"
                                    >
                                ...
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-indigo-500 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Indigo') === -1 ? selectedFilters.push('Indigo') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Indigo'), 1) && selectedColors2--"
                                    >
                                ...
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-gray-500 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Gray') === -1 ? selectedFilters.push('Gray') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Gray'), 1) && selectedColors2--"
                                    >
                                ...
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-cyan-500 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Cyan') === -1 ? selectedFilters.push('Cyan') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Cyan'), 1) && selectedColors2--"
                                    >
                                ...
                                <div class="col-4 flex flex-column align-items-center">
                                    <div
                                        class="w-3rem h-3rem border-circle bg-pink-500 cursor-pointer border-none flex justify-content-center align-items-center"
                                        @click="selectedFilters.indexOf('Pink') === -1 ? selectedFilters.push('Pink') & selectedColors2++ : selectedFilters.splice(selectedFilters.indexOf('Pink'), 1) && selectedColors2--"
                                    >
                            ...
                            <Galleria :value="sizes" :responsiveOptions="responsiveOptions" containerClass="h-full" :numVisible="2" :showThumbnails="false" :showIndicators="true">
                                <template #item="slotProps">
                                    <div class="flex flex-wrap justify-content-between w-full h-full mb-5 overflow-hidden" style="column-gap: 5px; row-gap: 5px">
                                        <div
                                            v-ripple
                                            class="w-5rem h-3rem text-900 flex justify-content-center align-items-center text-sm cursor-pointer border-round p-ripple"
                                            v-for="size of slotProps.item.page"
                                            :key="size"
                                            @click="
                                                selectedSizes2.indexOf(size.value) == -1
                                                    ? selectedSizes2.push(size.value) && selectedFilters.push(size.value)
                                                    : selectedSizes2.splice(selectedSizes2.indexOf(size.value.toString()), 1) && selectedFilters.splice(selectedFilters.indexOf(size.value.toString()), 1)
                                            "
                                            :class="{
                                                'surface-100': selectedFilters.indexOf(size.value) === -1,
                                                'bg-blue-200': selectedFilters.indexOf(size.value) !== -1
                                            }"
                                        >
                                            {{ size.value }}
                                        </div>
    ...
    <BlockViewer header="Dropdown" :code="block3">
        <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
            ...
            <div class="grid grid-nogutter align-items-center">
                ...
                <MultiSelect :options="prices" v-model="selectedPrice2" placeholder="Price" optionLabel="range" :filter="true" class="flex-auto lg:flex-1 mb-3 lg:mt-0 w-full lg:w-18rem mr-0 lg:mr-4 text-900"></MultiSelect>
...
export default {
    data() {
        return {
            ...
            selectedBrands2: [{ name: 'Alfred' }, { name: 'Hyper' }],
            selectedBrands3: [{ name: 'Alfred' }],
            selectedBrand_1: [],
