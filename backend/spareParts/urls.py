...
from .views import SparePartsViewSet, CompanyCodeSPViewSet, BomListViewSet, CompanyBomListViewSet, SparePartsManagementViewSet, CompanySparePartsManagementViewSet, upload_image
...
urlpatterns = [
    ...
    path('spareParts/upload_image/', upload_image, name='upload_image'),
]
