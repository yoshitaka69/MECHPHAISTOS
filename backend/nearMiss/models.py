...
class NearMiss(models.Model):
    ...
    nearMissListNo = models.CharField(verbose_name='NearMissListNo', max_length=200)
    userName = models.CharField(verbose_name='userName', max_length=200)
    department = models.CharField(verbose_name='department', max_length=200)
    dateOfOccurrence = models.DateTimeField(verbose_name='dateOfOccurrence', max_length=200,default=timezone.now)
    ...
    createdDay = models.DateTimeField(verbose_name='description', max_length=200,default=timezone.now)
    """記入した日付を記入してくれる"""
