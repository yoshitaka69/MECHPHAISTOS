...
class CompanyCodeCo2ViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('co2_companyCode')
...
class CompanyCodeStmViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('stm_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodeElecViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('elec_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodeCompAirViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('comAir_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodeWellWaterViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('wellWater_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodePureWaterViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('pureWater_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodeWwtViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('wwt_companyCode')
        return CompanyCode.objects.all()
...
class CompanyCodeExhaustGasViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        company_code = self.request.query_params.get('companyCode', None)
        if company_code is not None:
            return CompanyCode.objects.filter(companyCode=company_code).prefetch_related('exhaustGas_companyCode')
        return CompanyCode.objects.all()